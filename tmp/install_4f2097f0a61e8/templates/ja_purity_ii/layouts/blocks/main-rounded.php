...
<div class="inner clearfix">
	...
	<div class="ja-mass ja-mass-top clearfix">
		<jdoc:include type="modules" name="<?php echo $mass_top;?>" style="JArounded" />
	</div>
	<?php endif; ?>
	...
	<div id="ja-contentwrap" class="<?php echo $this->getColumnWidth('cls_m'); ?>">
		...
		<div id="ja-content" class="column" style="width:<?php echo $this->getColumnWidth('cw') ?>%">
			...
			<div id="ja-current-content" class="column" style="width:<?php echo $this->getColumnWidth('c') ?>%">
				...
				<div class="ja-content-top clearfix">
					<jdoc:include type="modules" name="<?php echo $content_top;?>" style="JArounded" />
				</div>
				<?php endif; ?>
				...
				<div class="ja-content-bottom clearfix">
					<jdoc:include type="modules" name="<?php echo $content_bottom;?>" style="JArounded" />
				</div>
				<?php endif; ?>
			</div>
		...
		<div class="ja-col column ja-inset2" style="width:<?php echo $this->getColumnWidth('i2') ?>%">
			<jdoc:include type="modules" name="<?php echo $inset2;?>" style="JArounded" />
		</div>
		<?php endif; ?>
	</div>
	...
	<div class="ja-mass ja-mass-bottom clearfix">
		<jdoc:include type="modules" name="<?php echo $mass_bottom;?>" style="JArounded" />
	</div>
	<?php endif; ?>
