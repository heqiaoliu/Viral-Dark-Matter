...
--
-- Dumping data for table `j49955_components`
--
...
--
-- Dumping data for table `j49955_core_acl_aro_groups`
--
...
--
-- Dumping data for table `j49955_groups`
--
...
--
-- Dumping data for table `j49955_jaem_services`
--
...
--
-- Dumping data for table `j49955_modules`
--
...
(16, 'Polls', '', 2, 'right', 0, '0000-00-00 00:00:00', 0, 'mod_poll', 0, 0, 1, 'id=14\nmoduleclass_sfx=\ncache=1\ncache_time=900\n\n', 0, 0, ''),
...
(21, 'Who''s Online', '', 4, 'right', 0, '0000-00-00 00:00:00', 1, 'mod_whosonline', 0, 0, 1, 'cache=0\nshowmode=0\nmoduleclass_sfx=_green\n\n', 0, 0, ''),
...
(28, 'Random Image', '', 5, 'right', 0, '0000-00-00 00:00:00', 1, 'mod_random_image', 0, 0, 1, '', 0, 0, ''),
(29, 'Top Menu', '', 0, 'footnav', 0, '0000-00-00 00:00:00', 1, 'mod_mainmenu', 0, 0, 0, 'menutype=topmenu\nmenu_style=list_flat\nstartLevel=0\nendLevel=0\nshowAllChildren=0\nwindow_open=\nshow_whitespace=0\ncache=1\ntag_id=\nclass_sfx=-nav\nmoduleclass_sfx=\nmaxdepth=10\nmenu_images=0\nmenu_images_align=0\nmenu_images_link=0\nexpand_menu=0\nactivate_parent=0\nfull_active_id=0\nindent_image=0\nindent_image1=-1\nindent_image2=-1\nindent_image3=-1\nindent_image4=-1\nindent_image5=-1\nindent_image6=-1\nspacer=\nend_spacer=\n\n', 1, 0, ''),
...
(40, 'Key Concepts', '', 3, 'left', 0, '0000-00-00 00:00:00', 1, 'mod_mainmenu', 0, 0, 1, 'menutype=keyconcepts\nmenu_style=list\nstartLevel=0\nendLevel=0\nshowAllChildren=0\nwindow_open=\nshow_whitespace=0\ncache=1\ntag_id=\nclass_sfx=\nmoduleclass_sfx=_menu\nmaxdepth=10\nmenu_images=0\nmenu_images_align=0\nmenu_images_link=0\nexpand_menu=0\nactivate_parent=0\nfull_active_id=0\nindent_image=0\nindent_image1=\nindent_image2=\nindent_image3=\nindent_image4=\nindent_image5=\nindent_image6=\nspacer=\nend_spacer=\n\n', 0, 0, ''),
...
(43, 'Joomla Tutorial', '<strong>How to Apply a Module Class Suffix in Joomla! 1.5?</strong><br />\r\n\r\n<ol>\r\n<li>Login to backend</li>\r\n<li>Go to the Module Manager</li>\r\n<li>Select the Module you want to edit</li>\r\n<li>Type the Module Class Suffix into the parameters to the right</li>\r\n<li>Save the Setting</li>\r\n</ol>', 0, 'right', 0, '0000-00-00 00:00:00', 1, 'mod_custom', 0, 0, 1, 'moduleclass_sfx=badge-new\n\n', 0, 0, ''),
(44, 'What is Component?', '<img src="images/stories/demo/sam-7.png" alt="Global" align="left" style="margin-right: 10px;" />\r\n\r\nA component is a kind of Joomla! <a href="http://docs.joomla.org/Extension" title="Extension" target="_blank">extension</a>. Ultrices justo lorem ante pede scelerisque sodales accumsan...', 0, 'user3', 0, '0000-00-00 00:00:00', 1, 'mod_custom', 0, 0, 1, 'moduleclass_sfx=\n\n', 0, 0, ''),
(47, 'What is Joomla?', '<img src="images/stories/demo/sam-6.png" alt="Global" align="left" style="margin-right: 10px;" />\r\n\r\n<a href="http://www.joomla.org" title="Joomla" target="_blank">Joomla</a> is an award-winning content management system (CMS), which enables you to build Web sites and powerful online applications <a href="http://www.joomla.org" title="Joomla" target="_blank">...</a>', 0, 'user1', 0, '0000-00-00 00:00:00', 1, 'mod_custom', 0, 0, 1, 'moduleclass_sfx=\n\n', 0, 0, ''),
(45, 'What is plugin?', '<img src="images/stories/demo/sam-9.png" alt="Global" align="left" style="margin-right: 10px;" />\r\n\r\n<a href="http://docs.joomla.org/Plugin" title="Plugin" target="_blank">A plugin</a> is a kind of Joomla! extension. Plugins provide routines which are associated with trigger events within Joomla.When a particular <a href="http://docs.joomla.org/Plugin" title="Plugin" target="_blank">...</a>', 0, 'user4', 0, '0000-00-00 00:00:00', 1, 'mod_custom', 0, 0, 1, 'moduleclass_sfx=\n\n', 0, 0, ''),
(46, 'What''s the template?', '<img src="images/stories/demo/sam-5.png" alt="Template" align="left" style="margin-right: 10px;" />\r\n\r\n<a href="http://docs.joomla.org/Tutorial:Introduction_to_Joomla!_templates" title="What''s the template?" target="_blank">A template</a> controls the overall look and layout of a site. It provides the framework that brings together common elements, modules and <a href="http://docs.joomla.org/Tutorial:Introduction_to_Joomla!_templates" title="What''s the template?" target="_blank">...</a>', 0, 'user5', 0, '0000-00-00 00:00:00', 1, 'mod_custom', 0, 0, 1, 'moduleclass_sfx=\n\n', 0, 0, ''),
(48, 'What''s Module?', '<img src="images/stories/demo/sam-8.png" alt="Global" align="left" style="margin-right: 10px;" />\r\n\r\n<a href="http://docs.joomla.org/What_is_module_chrome%3F" title="Module chrome" target="_blank">Module chrome</a> allows template designers to have a certain amount of control over the way the output from a Module is displayed in their <a href="http://docs.joomla.org/What_is_module_chrome%3F" title="Module chrome" target="_blank">...</a>', 0, 'user2', 0, '0000-00-00 00:00:00', 1, 'mod_custom', 0, 0, 1, 'moduleclass_sfx=\n\n', 0, 0, ''),
(53, 'Link', '<a href="http://community.joomla.org/translations.html" target="_blank" style="margin-bottom: 10px; border: none; text-decoration: none;" class="clearfix"><img src="images/stories/demo/joomla-translation.png" alt="Joomla Translation team" /></a>\r\n\r\n<a href="http://community.joomla.org/user-groups.html" target="_blank"><img src="images/stories/demo/joomla-group.png" alt="Joomla Translation team" /></a>', 0, 'right', 0, '0000-00-00 00:00:00', 0, 'mod_custom', 0, 0, 0, 'moduleclass_sfx=_noborder\n\n', 0, 0, ''),
(50, 'How to?', '<ul>\r\n<li><a href="#" title="Sample link">How to Remove ''Welcome to the Frontpage''?</a></li>\r\n<li><a href="#" title="Sample link">How to Install a Joomla! template?</a></li>\r\n<li><a href="#" title="Sample link">How to Apply a Module Class Suffix in Joomla! 1.5?</a></li>\r\n</ul>', 0, 'user10', 0, '0000-00-00 00:00:00', 1, 'mod_custom', 0, 0, 1, 'moduleclass_sfx=\n\n', 0, 0, ''),
(52, 'The community', '', 0, 'user9', 0, '0000-00-00 00:00:00', 1, 'mod_latestnews', 0, 0, 1, 'count=5\nordering=c_dsc\nuser_id=0\nshow_front=1\nsecid=\ncatid=30\nmoduleclass_sfx=\ncache=1\ncache_time=900\n\n', 0, 0, ''),
(54, 'Download', '<p>T3 framework is free. <a href="http://www.joomlart.com/forums/forumdisplay.php?f=170" title="Go to our Forum for more information">Visit our Forum</a> for more information</p>', 0, 'mega1', 0, '0000-00-00 00:00:00', 1, 'mod_custom', 0, 0, 1, 'moduleclass_sfx=\n\n', 0, 0, ''),
(55, 'Features Highlight', '<p>JA T3 template frameworks, you can:</p>\r\n<p><strong>- Support multi &amp; flexible layout</strong></p>\r\n<p><strong>- Iphone + Handheld support</strong></p>\r\n<p><strong>- Menu system is second to none</strong></p>\r\n<p><strong>- SEO &amp; Fast loading..</strong></p>\r\n<p><a href="#" title="download t3 framework">Download</a> - <a href="#" title="wiki">wiki</a></p>', 0, 'mega2', 0, '0000-00-00 00:00:00', 1, 'mod_custom', 0, 0, 1, 'moduleclass_sfx=\n\n', 0, 0, ''),
(56, 'Twitter', '<img src="images/stories/demo/twitter.png" alt="Twitter" />', 0, 'left', 0, '0000-00-00 00:00:00', 0, 'mod_custom', 0, 0, 1, 'moduleclass_sfx=_blank\n\n', 0, 0, ''),
(57, 'Vimeo', '<object height="170" width="300" style="background:#000" data="http://vimeo.com/moogaloop.swf?clip_id=7047863&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=0&amp;color=&amp;fullscreen=1" type="application/x-shockwave-flash"><param value="300" name="width"/><param value="170" name="height"/><param name="allowfullscreen" value="true" /><param name="allowscriptaccess" value="always" /><param name="wmode" value="transparent" /><param name="src" value="http://vimeo.com/moogaloop.swf?clip_id=7047863&amp;server=vimeo.com&amp;show_title=1&amp;show_byline=1&amp;show_portrait=0&amp;color=&amp;fullscreen=1" /></object>', 0, 'vimeo', 0, '0000-00-00 00:00:00', 1, 'mod_custom', 0, 0, 0, 'moduleclass_sfx=\n\n', 0, 0, '');
...
--
-- Dumping data for table `j49955_plugins`
--
...
(27, 'System - SEF', 'sef', 'system', 0, 4, 1, 0, 0, 0, '0000-00-00 00:00:00', ''),
(28, 'System - Debug', 'debug', 'system', 0, 5, 1, 0, 0, 0, '0000-00-00 00:00:00', 'queries=1\nmemory=1\nlangauge=1\n\n'),
...
(32, 'System - Remember Me', 'remember', 'system', 0, 9, 1, 1, 0, 0, '0000-00-00 00:00:00', ''),
(33, 'System - Backlink', 'backlink', 'system', 0, 10, 0, 1, 0, 0, '0000-00-00 00:00:00', ''),
(35, 'JA T3 Framework', 'jat3', 'system', 0, 11, 1, 0, 0, 0, '0000-00-00 00:00:00', 'mode=dev\n'),
(37, 'Button - JA Typography', 'jatypo', 'system', 0, 3, 1, 0, 0, 0, '0000-00-00 00:00:00', ''),
(38, 'System - JA Compress', 'plg_jacompress', 'system', 0, 2, 0, 0, 0, 62, '2010-06-07 08:33:44', 'general=minify\ngeneral-minify-debug=0\ngeneral-minify-browsercachetime=60\ngeneral-smartoptimizer-charSet=utf-8\ngeneral-smartoptimizer-debug=1\ngeneral-smartoptimizer-gzip=1\ngeneral-smartoptimizer-compressionLevel=9\ngeneral-smartoptimizer-minify=1\ngeneral-smartoptimizer-serverCache=1\ngeneral-smartoptimizer-serverCacheCheck=1\ngeneral-smartoptimizer-clientCache=1\ngeneral-smartoptimizer-clientCacheCheck=0\ncss-enable=1\ncss-merge=1\ncss-avoid=\njs-enable=1\njs-merge=1\njs-avoid=\n\n'),
(39, 'System - Mootools Upgrade', 'mtupgrade', 'system', 0, 1, 0, 0, 0, 0, '0000-00-00 00:00:00', ''),
(40, 'Editor Button - JA Typo Button', 'jatypobutton', 'editors-xtd', 0, 0, 1, 0, 0, 0, '0000-00-00 00:00:00', '');
...
--
-- Dumping data for table `j49955_templates_menu`
--
