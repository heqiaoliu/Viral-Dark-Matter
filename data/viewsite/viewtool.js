...
$(document).ready(function(){
  ...
  $("td.replicate").click(function(){    
    ...
    $("p#userGuide2").html("Click the replicate again, it will be grouped by experiment date which will graph with average and deviration when it is highlighted by blue.");
...
$(function() {  
	...
	// validate and process form here  
	    ...
	    if($(this).hasClass("beid")){
	      ...
	      /*this is for considering the condition vc_id
		if((this).title!="")
	...
	/*this is the part for asking data by vc_id
