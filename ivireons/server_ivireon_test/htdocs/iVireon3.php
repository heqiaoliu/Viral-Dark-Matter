<html>
<head>
<title>iVIREON - identification of VIRions by Ensembles of Neural networkS</title>
</head>

<TABLE style="MARGIN-LEFT: 128px" border=7 cellSpacing=0 cellPadding=0 width=512 align=left height=75>
<TBODY>
<!--<dl><dd><table>-->

<body>
<br><b><big>iVIREON - identification of VIRions by Ensembles of Neural networkS</b></big><br><br>
...
Just input the file-paths for your fasta file and Matlab into the following text boxes.<br>


<FORM action="ivireons/server_ivireon_test/cgi-bin/Bioperl/pctpi_get4.cgi" method="GET">

<!--<FORM action="vdm/ivireons/server_ivireon_test/cgi-bin/Bioperl/pctpi_get4.cgi" method="GET">-->
<!--Fasta File Path: <input type="file" name="fastafile">  <br>-->


<!--<label for="file">Filename:</label>-->
Fasta File Path: <input type="text" name="fastafile" /> <br>
MCR File Path: <input type="text" name="mcrpath" />  <br>
...
<img src="mamp_program.png" alt="nerding" width="350" height="300" /></img><br>
Next, find the MAMP directory on your machine; it may be in the "Applications" directory, and should look like this:<br>
<img src="mamp_dir.png" alt="nerding" width="450" height="300" /></img><br>
