function [totalmeansandsds] = NetsPredict(data_file, descriptions_file)
clc;
clear all;
totalcount = 1;
...
names=importdata('descriptions_file'); % output from the java program that's attached. MAKE NAMES!!!!!!!!
hypotheticalsUnity = data_file'; %leave these alone.
