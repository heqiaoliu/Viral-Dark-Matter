...
switch(units),
  ...
  otherwise,
    error('Simulink:sluigeom:InvalidUnitFormat', 'units must be ''pixels'' or ''character'' or ''points''');
...
% as shown in main function in assignment of outGeom.  Matrix columns are:
...
elseif ispc
    ...
    error('Simulink:sluigeom:InvalidComputerType', ['Invalid computer type ', computer, ' in sluigeom.m' ]);  
