function tableHeaderContextMenuClick_CompareSignals(this, h, MouseEvent, treetable) %#ok<INUSL>
    ...
    if MouseEvent.getButton() == MouseEvent.BUTTON3 ||...
       (ismac && MouseEvent.getButton() == MouseEvent.BUTTON1 && MouseEvent.isControlDown)
        ...
        set(this.tableColumnSelectContextMenuCompareSig,...
            'Position', [DialogClickX, DialogClickY]);
        
        % Show context menu
        set(this.tableColumnSelectContextMenuCompareSig, 'Visible', 'on');
    end % if    
