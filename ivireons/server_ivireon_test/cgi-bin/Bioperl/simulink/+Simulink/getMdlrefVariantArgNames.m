function retVal = getMdlrefVariantArgNames(mdlBlk, i)
%GETMDLREFVARIANTMODE  Return the argument names of the ith variant of a model 
%   block
...
try
    if Simulink.getMdlrefIsVariant(mdlBlk)
        ...
        retVal = variants(i).ParameterArgumentNames';
    else
        retVal = [];
    end
