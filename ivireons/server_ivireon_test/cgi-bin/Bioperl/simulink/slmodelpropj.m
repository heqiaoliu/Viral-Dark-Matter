...
%   $Revision: 1.6.4.3 $  $Date: 2009/09/09 21:40:16 $
...
function Props = localInitProps(H);
  ...
  Props = struct(...
      ...
      'PauseFcn', get_param(H,'PauseFcn'), ...
      'ContinueFcn', get_param(H,'ContinueFcn'), ...
...
callbackControls.PauseFcnText.setText(Props.PauseFcn);
callbackControls.ContinueFcnText.setText(Props.ContinueFcn);
...
set_param(s.currentRoot,'PauseFcn',char(callbackControls.PauseFcnText.getText));
set_param(s.currentRoot,'ContinueFcn',char(callbackControls.ContinueFcnText.getText));
...
%---Add PauseFcn strings and edit fields.
s.PauseFcnPanel = com.mathworks.mwt.MWPanel(com.mathworks.mwt.MWBorderLayout(5,5));
s.PauseFcnLabel = ...
	com.mathworks.mwt.MWLabel(sprintf('Simulation pause function: ')); 
s.PauseFcnLabel.setEnabled(enable);
s.PauseFcnPanel.add(s.PauseFcnLabel,com.mathworks.mwt.MWBorderLayout.NORTH);
s.PauseFcnText = com.mathworks.ide.widgets.SyntaxTextArea;
s.PauseFcnText.setFileType(s.PauseFcnText.M_FILE_TYPE);
s.PauseFcnText.setAutoIndentEnabled(1);
s.PauseFcnText.setSmartIndentEnabled(1); 
s.PauseFcnText.set('SpacesPerIndent', 2);
s.PauseFcnText.set('SpacesPerTab', 8);
s.PauseFcnText.setRows(2);
s.PauseFcnText.setVScrollStyle(1);
s.PauseFcnText.setHScrollStyle(1);
s.PauseFcnText.setEnabled(enable);
s.PauseFcnPanel.add(s.PauseFcnText,com.mathworks.mwt.MWBorderLayout.CENTER);
Main.add(s.PauseFcnPanel);

%---Add ContinueFcn strings and edit fields.
s.ContinueFcnPanel = com.mathworks.mwt.MWPanel(com.mathworks.mwt.MWBorderLayout(5,5));
s.ContinueFcnLabel = ...
	com.mathworks.mwt.MWLabel(sprintf('Simulation continue function: ')); 
s.ContinueFcnLabel.setEnabled(enable);
s.ContinueFcnPanel.add(s.ContinueFcnLabel,com.mathworks.mwt.MWBorderLayout.NORTH);
s.ContinueFcnText = com.mathworks.ide.widgets.SyntaxTextArea;
s.ContinueFcnText.setFileType(s.ContinueFcnText.M_FILE_TYPE);
s.ContinueFcnText.setAutoIndentEnabled(1);
s.ContinueFcnText.setSmartIndentEnabled(1); 
s.ContinueFcnText.set('SpacesPerIndent', 2);
s.ContinueFcnText.set('SpacesPerTab', 8);
s.ContinueFcnText.setRows(2);
s.ContinueFcnText.setVScrollStyle(1);
s.ContinueFcnText.setHScrollStyle(1);
s.ContinueFcnText.setEnabled(enable);
s.ContinueFcnPanel.add(s.ContinueFcnText,com.mathworks.mwt.MWBorderLayout.CENTER);
Main.add(s.ContinueFcnPanel);
