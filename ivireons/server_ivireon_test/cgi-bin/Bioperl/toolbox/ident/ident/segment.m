...
%   $Revision: 1.8.4.3 $ $Date: 2008/10/02 18:46:19 $
if nargin < 2
...
[Ncap,nz]=size(z);
if Ncap<nz
    ctrlMsgUtils.warning('Ident:dataprocess:transposedData')
end
...
if nu==0
    ...
    if nl>2
        ctrlMsgUtils.error('Ident:dataprocess:segmentcheck1');
    end
else
    ...
    if nl==2*nu+1
        ...
        if nl==2*nu+2
            ...
            ctrlMsgUtils.error('Ident:dataprocess:segmentcheck2')
        end
    end
end
