...
%   as a band instead: BODE(M,'sd',3,'fill'). The confidence region is
...
%   The unit of W is rad/s. For IDFRD models, only the range {Wmin, Wmax}
%   should be specified. 
%
%   SEVERAL MODELS:
...
%   OutputName, and all models need not have the same number of channels.
...
%
%   NO PLOT, CALCULATION of MAGNITUDE and PHASE values:
...
%   then MAG and PHASE are NY-by-NU-by-NW arrays such that MAG(ky,ku,k),
%   PHASE(ky,ku,k) give the magnitude and phase responses (respectively)
%   from input ku to output ky at the frequency W(k). The phase values are
%   returned in degrees. 
...
%   
%   See also FFPLOT, and IDMODEL/NYQUIST, IDFRD, SPA.

%   Copyright 1986-2008 The MathWorks, Inc.
%   $Revision: 1.13.4.6 $ $Date: 2008/12/29 02:07:28 $
