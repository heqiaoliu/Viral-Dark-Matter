...
%   $Revision: 1.3.4.4 $  $Date: 2008/10/02 18:48:19 $

if ~iscstbinstalled
    ctrlMsgUtils.error('Ident:general:cstbRequired','parallel')
end
...
if ni==2,
   ...
   return
elseif ni~=6,
   ctrlMsgUtils.error('Ident:transformation:nargChk','parallel','idmodel/parallel')
end
