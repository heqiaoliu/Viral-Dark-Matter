...
%   ZPPLOT, etc), require some quite extensive calculations to transform
%   this information. These are done whenever needed, and attempts are
%   made to store the results of the calculations. 
%
...
%   $Revision: 1.5.4.2 $ $Date: 2008/04/28 03:19:54 $
...
if flag
    m = mn; %assignin('caller',inputname(1),mn);
end
