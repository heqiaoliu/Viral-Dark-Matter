...
%      Kexp.
%
%   See also IDMODEL/SIM, IDMODEL/PREDICT, RESID, IDNLMODEL/COMPARE.

%   L. Ljung 10-1-89,10-10-93
%   Copyright 1986-2009 The MathWorks, Inc.
%   $Revision: 1.31.4.11 $  $Date: 2009/05/23 08:02:29 $
...
for ks=1:nargin
    if isa(varargin{ks},'idmodel')
        try
            assignin('caller',inpn{ks},eval(inpn{ks}))
        end
    end
end
