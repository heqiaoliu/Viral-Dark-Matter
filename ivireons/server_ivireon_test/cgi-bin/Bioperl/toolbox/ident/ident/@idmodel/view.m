...
%   This routine requires Control System Toolbox, and invokes LTIVIEW.
%
%   VIEW(Mod)
%
...
%   functionality of LTIVIEW use the Control System Toolbox command "ltiview".
%   The models will not be required to be converted to lti objects since they
%   can be directly imported.

%   Copyright 1986-2009 The MathWorks, Inc.
%   $Revision: 1.8.2.6 $  $Date: 2009/03/09 19:13:42 $

if ~iscstbinstalled
    ctrlMsgUtils.error('Ident:idmodel:viewCstbrequired')
end
ValidStrings = {'step';
    'impulse';
    'bode';
...
test = varargin{end};
if ischar(test)
    if any(strcmpi(test,ValidStrings))
        plottype = test;
