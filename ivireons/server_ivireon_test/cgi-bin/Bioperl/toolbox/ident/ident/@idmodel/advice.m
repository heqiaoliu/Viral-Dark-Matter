...
%   $Revision: 1.11.4.4 $  $Date: 2008/12/29 02:07:27 $
...
adv = {' '};
if strcmpi(es.Status,'Not estimated')
    adv = [adv,{...
        'The model is not estimated, so nothing can be said about its accuracy.'...
        'Its ability to reproduce data can be assessed by'...
        ' '...
        [' COMPARE(DATA,',mname,')']...
        ' '}];
    est = 0;
...
%%%LL IF CSTB EXISTS %% COV?? % if required, use function "iscstbinstalled"
try
