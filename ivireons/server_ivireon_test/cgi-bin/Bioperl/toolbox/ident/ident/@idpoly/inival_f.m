...
%	$Revision: 1.8.4.3 $  $Date: 2009/03/09 19:13:47 $

% This version is for OE structures only
...
was = warning('off'); [lw,lwid] = lastwarn; % To avoid warnings about no white noise for Ts = 0;
