...
%   $Revision: 1.7.4.3 $  $Date: 2008/10/02 18:49:36 $
...
switch Struct(1).type
    ...
    case '()'
        ctrlMsgUtils.error('Ident:transformation:subsasgn1')
    otherwise
        ctrlMsgUtils.error('Ident:general:unknownSubsasgn',Struct(1).type,'IDSS')
end
