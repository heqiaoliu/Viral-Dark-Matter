...
%IV Compute instrumental variable based estimates for single output ARX-models.
%
%   MODEL = IV(Z,NN,NF,MF)
%
...
%
%   See also ARX, IV4, ARMAX, IDDATA, IDPROPS.

%   L. Ljung 10-1-86
%   Copyright 1986-2009 The MathWorks, Inc.
%   $Revision: 1.11.4.4 $  $Date: 2009/10/16 04:54:47 $
...
if p==1
    ...
    [ze,Ne,~,nu,Ts,Name,Ncaps,errflag] = idprep(data,0,inputname(1));
