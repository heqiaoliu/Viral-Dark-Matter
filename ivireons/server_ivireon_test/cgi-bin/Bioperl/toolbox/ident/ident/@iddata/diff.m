...
%   $Revision: 1.1.4.4 $ $Date: 2008/10/02 18:46:43 $

if nargin < 2
    n = 1;
end
if strcmp(z.Domain,'Frequency')
    ctrlMsgUtils.error('Ident:dataprocess:diffcheck1')
end
zd = z;
y = z.OutputData;
u = z.InputData;
...
zd = pvset(zd,'OutputData',yd,'InputData',ud);

if ~isempty(int)
    zd = pvset(zd,'InterSample',int);
end
