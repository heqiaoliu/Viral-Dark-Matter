...
%PNAMES  All SATURATION public properties and their assignable values
%
...
% $Revision: 1.1.8.3 $ $Date: 2008/10/02 18:55:28 $
...
if no>1
    if readonlyflag
        ...
        AsgnVals = {'A vector [a, b] with two real values a<b defining the linear interval'};
    end
end
