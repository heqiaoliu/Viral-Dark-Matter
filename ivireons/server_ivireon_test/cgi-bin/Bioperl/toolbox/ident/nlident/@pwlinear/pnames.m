...
%PNAMES  All PWLINEAR public properties and their assignable values
%
...
% $Revision: 1.1.8.3 $ $Date: 2008/10/02 18:55:09 $
...
if no>1
    if readonlyflag
        ...
        AsgnVals = {'Number of break points of the piecewise linear estimator, a positive integer', ...
            'Break points, a real matrix with two rows'};
    end
end
