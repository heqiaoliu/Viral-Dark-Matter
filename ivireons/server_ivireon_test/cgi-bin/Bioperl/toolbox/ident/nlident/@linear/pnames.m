...
%PNAMES  All LINEAR public properties and their assignable values
%
...
% $Revision: 1.1.8.3 $ $Date: 2008/10/02 18:54:42 $
...
if no>1
    if readonlyflag
        ...
        AsgnVals = {['Structure containing ', upper(class(nlobj)), ' estimator parameters']};
    end
end
