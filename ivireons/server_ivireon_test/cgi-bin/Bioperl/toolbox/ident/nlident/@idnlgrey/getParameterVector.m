function parvec = getParameterVector(nlsys)
%GETPARAMETERVECTOR  Returns the parameters of nlsys as a Np-by-1 vector.
%
%   PARVEC = GETPARAMETERVECTOR(NLSYS);
%
...
%   $Revision: 1.1.8.3 $ $Date: 2008/06/13 15:23:28 $
