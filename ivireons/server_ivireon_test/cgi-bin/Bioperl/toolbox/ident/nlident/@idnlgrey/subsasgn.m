...
%SUBSASGN  Subscripted assignment method for IDNLGREY objects.
%
...
%   $Revision: 1.1.10.6 $ $Date: 2008/10/02 18:54:04 $
...
switch Struct(1).type
    ...
    otherwise
        ctrlMsgUtils.error('Ident:general:unknownSubsasgn',Struct(1).type,'IDNLGREY')
end
