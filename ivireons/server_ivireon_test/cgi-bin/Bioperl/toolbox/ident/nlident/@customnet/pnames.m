...
%PNAMES  All CUSTOMNET public properties and their assignable values
%
...
% $Revision: 1.1.8.3 $ $Date: 2008/10/02 18:52:38 $
...
if no>1
    if readonlyflag
        ...
        AsgnVals = {'Function handle or string referring to the unit function of the estimator', ...
            'Number of units of the estimator, a positive integer', ...
