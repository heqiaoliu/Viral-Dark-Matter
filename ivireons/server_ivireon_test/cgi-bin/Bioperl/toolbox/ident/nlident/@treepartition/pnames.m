...
%PNAMES  All TREEPARTITION public properties and their assignable values
%
...
% $Revision: 1.1.8.4 $ $Date: 2008/10/02 18:55:43 $
...
if no>1
    if readonlyflag
        ...
        AsgnVals = {'Number of units (nodes) in the tree, ''Auto'' (default) or a positive integer', ...
