function iddfthru(blk,Td,u0,bufsize)
%IDDFTHRU  Helper function for Transport Delay with Feedthrough block
...
%   $Revision: 1.1.4.2 $  $Date: 2008/10/02 18:51:27 $
