...
%  $Revision: 1.1.4.4 $ $Date: 2008/10/31 06:14:16 $
...
% Merge these ranges
focus = LocalMrgfocus(FRanges,SoftRangeFlags);
...
%--------------------------------------------------------------------------
function focus = LocalMrgfocus(FRanges,SoftFlags)
%LocalMrgfocus  Merges frequency ranges into single focus.
