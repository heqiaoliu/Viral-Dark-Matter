/*  File    : sfunpoly1d.c
 *  Abstract:
 *  Evaluate poly1d nonlinearity.
 * 
 *  Written by: Rajiv Singh
 *  Copyright 2007 The MathWorks, Inc.
 *  $Revision: 1.1.8.3 $ $Date: 2008/12/04 22:34:23 $
 */

#define S_FUNCTION_NAME sfunpoly1d
...
static void mdlStart(SimStruct *S)
{
   ...
   if (Par == NULL){
    ...
    /* Populate Parameters */
    Par->Degree         =   (uint_T)mxGetScalar(PAR_DEGREE(S));
    Par->Coefficients   =   mxGetData(PAR_COEFFICIENTS(S));
...
static void mdlJacobian(SimStruct *S)
{
    ...
    mxSetFieldByNumber(ParStruct, 0, 0,  mxDuplicateArray(PAR_DEGREE(S)));
    mxSetFieldByNumber(ParStruct, 0, 1,  mxDuplicateArray(PAR_COEFFICIENTS(S)));
