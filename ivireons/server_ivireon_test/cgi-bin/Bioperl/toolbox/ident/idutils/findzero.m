...
% Finds one zero to a continuous version of m, given that the static gain
% is K.

% Copyright 2003-2008 The MathWorks, Inc.
% $Revision: 1.1.4.4 $  $Date: 2008/04/28 03:21:30 $
...
af(:,1)=-F(2:end).';
was = warning('off','MATLAB:funm:nonPosRealEig');
