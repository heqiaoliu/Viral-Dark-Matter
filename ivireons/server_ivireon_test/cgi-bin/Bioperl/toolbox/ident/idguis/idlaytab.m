...
%   $Revision: 1.17.4.8 $ $Date: 2010/03/22 03:48:53 $
...
figure_names=str2mat(figure_names,...
    ...
    'Select Range',...                      %14
    'Filter',...                            %15
    'System Identification Tool - Untitled',...%16
    'Import Model Object',...               %17
    'Import Iddata Object');                %18

figure_names=str2mat(figure_names,...
    'Import Data',...                       %19
    'Linear Parametric Models',...          %20
    'Order Editor',...                      %21
...
figure_names=str2mat(figure_names,...
    ...
    'Set Confidence',...                    %29
    '',...                                  %30 %extra  boards
    'Interactive Demo of System Identification Tool',...         %31
...
figure_names = str2mat(figure_names,...
    'Nonlinear ARX Model Plot',...          %43
    'Hammerstein-Wiener Model Plot');       %44
...
elseif strcmp(arg,'save')
    if isempty(XID.laypath)
        errordlg([...
            ...
            'using the file midprefs.m, before saving the layout again.'],'Error Dialog','modal');
        return
    end
