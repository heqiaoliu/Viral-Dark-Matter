...
%IDUIAXIS Sets up the axes limits dialog (idaxlimdlg) for ident plots.

%   L. Ljung 4-4-94
%   Copyright 1986-2006 The MathWorks, Inc.
%   $Revision: 1.5.4.3 $  $Date: 2006/09/30 00:19:39 $
...
if no_blanks>0,xstr=[xstr,char(32*ones(1,no_blanks))];end
...
fig=idaxlimdlg(dlgname,[1 1],Prompt,Axhand,xyz);
