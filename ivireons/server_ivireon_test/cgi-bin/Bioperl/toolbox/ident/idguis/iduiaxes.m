function iduiaxes(arg,ifopt,hm,f)
...
%
% f = figure handle to which the axes options need to be applied 

%   L. Ljung 4-4-94
%   Copyright 1986-2010 The MathWorks, Inc.
%   $Revision: 1.8.4.2.8.1 $  $Date: 2010/07/01 20:43:07 $
...
if strcmp(arg,'auto')
    for kk=kax,
        ...
        set(kk,'xlimmode','auto', 'ylimmode', 'auto')
    end
...
if strcmp(arg,'sep_on')
    ...
    for kk=kax,
        ...
        for kline=3:2:rxusd
            if xusd(kline,1)>0
                if strcmp(get(xusd(kline,1),'visible'),'on')
                    if ISstem || number==3
                        coln=1;
                    else
                        coln=1:cxusd;
