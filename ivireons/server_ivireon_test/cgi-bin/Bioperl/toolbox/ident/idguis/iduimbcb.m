function iduimbcb(flag,window,figH)
...
%   $Revision: 1.8.4.6 $ $Date: 2008/10/31 06:12:13 $
...
if strcmp(flag,'setzoom')
    if window==3
        set(XID.plotw(3,1),'ResizeFcn','iduimbcb(''resize'');');
