...
%   $Revision: 1.8.4.4 $ $Date: 2006/11/17 13:29:52 $
...
pos = iduilay1(figW,3,1,lev2);
uicontrol(figure_name,'pos',...
    [etf lev2+mEdgeToFrame figW-2*etf 5*buth+2*ftb],...
    'style','frame');
h(1)=uicontrol(figure_name,'pos',...
    [etf+ftb lev2+etf+mStdButtonHeight/2 ...
    figW-2*(etf+ftb) 4.5*buth],...
...
h(4)=uicontrol(figure_name,'pos',pos(2,:),...
    ...
    'string','Double-click on model/data  for info!');
