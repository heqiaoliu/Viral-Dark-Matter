...
%MIDPREFS Choose directory for IDPREFS.MAT, the GUI startup information file.
%
%   MIDPREFS  or MIDPREFS(PATH)
%
%   System Identification Tool, the GUI for the toolbox, uses a file
%   IDPREFS.MAT to store start-up information, like preferred window sizes
%   and locations and most recently used session files. The location of
%   this file is set by MIDPREFS.
%
%   MIDPREFS
%    Specify the directory for IDPREFS.MAT interactively. 
%   
%   MIDPREFS(PATH)
%    Specify the path to the directory. The chosen directory must be on
%    MATLAB path.
%    Example (PC): midprefs('C:\matlab\toolbox\local\')

%   L. Ljung 1-1-95
%   Copyright 1986-2009 The MathWorks, Inc.
%   $Revision: 1.12.4.4 $  $Date: 2009/03/09 19:14:15 $
