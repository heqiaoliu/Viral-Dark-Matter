...
case 'Increment'
   ud = get(gcbf,'Userdata');
   tag = get(gcbo,'Tag');
   N = str2double(get(ud.Handle.Neditbox,'String'));
   switch tag
   case 'Nup'
      N = N + 1;
   case 'Ndown'
...
%   number of terms in the Taylor partial sum N, the center
...
ud.Handle.Leditbox = ...
   ...
   'Callback','taylortool(''plot'');', ...
	'HorizontalAlignment','left', ...
	'Position',[300 57 70 24]*PointsPerPixel, ...
...
ud.Handle.Reditbox = ...
   ...
   'Callback','taylortool(''plot'');', ...
	'HorizontalAlignment','left', ...
	'Position',[422 57 70 24]*PointsPerPixel, ...
...
uicontrol('Parent',h0, ...
	'Interruptible','off', ...
	'Units','points', ...
   'Position',[372 59 48 20]*PointsPerPixel, ...
   'BackGroundColor',[13/15 13/15 13/15], ...
	'String','< x <', ...
   'Style','text', ...
   'fontsize',12, ...
...
uicontrol('Parent',h0, ...
	'Interruptible','off', ...
	'Units','points', ...
	'Position',[102 49 18 17]*PointsPerPixel, ...
   'Callback','taylortool(''Increment'');', ...
   'String','+','Fontname','Courier','FontWeight','bold', ...  
	'Tag','Nup');
uicontrol('Parent',h0, ...
	'Interruptible','off', ...
	'Units','points', ...
	'Position',[102 31 18 17]*PointsPerPixel, ...
   'Callback','taylortool(''Increment'');', ...
   'String','-','Fontname','Courier','FontWeight','bold', ...
   'Tag','Ndown');
...
t = taylor(f,x,N,a);
% The functions f and t will be plotted over the interval
% [xo,x1];
ezplot(f,D,fig);
a = axis;
a(3:4) = 2*a(3:4);
