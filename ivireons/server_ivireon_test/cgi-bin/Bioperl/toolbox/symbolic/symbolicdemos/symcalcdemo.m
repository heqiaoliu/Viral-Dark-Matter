%% Calculus
% This demo shows how to use the Symbolic Math Toolbox(TM) product with a 
% simple example from calculus.
%
% Copyright 1984-2008 The MathWorks, Inc.
% $Revision: 1.1.6.1 $ $Date: 2009/03/09 20:48:18 $
...
% confirms that the difference between them really is a constant.
