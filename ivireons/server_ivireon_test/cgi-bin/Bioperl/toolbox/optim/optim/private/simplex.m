...
%   $Revision: 1.1.6.3 $  $Date: 2010/03/08 21:41:27 $
...
presolveTermMsg = xlate('Optimization terminated during preprocessing phase.');
presolveOptMsg = xlate('Optimization terminated during preprocessing phase.');
presolveInfsMsg = xlate('Exiting: The constraints are overly stringent; no feasible point exists.');
unboundedMsg = xlate('Exiting: The problem is unbounded; the constraints are not restrictive enough.');
excdMaxiterPhase1Msg = sprintf(['Exiting: Maximum number of iterations exceeded in Phase 1;' ...
                          '\n' '         increase options.MaxIter.']);
phaseoneInfsMsg = xlate('Exiting: The constraints are overly stringent; no feasible starting point found.');
excdMaxiterPhase2Msg = xlate('Exiting: Maximum number of iterations exceeded; increase options.MaxIter.');
optMsg = xlate('Optimization terminated.');
