...
%   $Revision: 1.1.6.4 $  $Date: 2009/08/29 08:28:55 $
...
if showDialog
    ...
    dlgTitle = sprintf('Import Optimization Options');
    promptStr = sprintf('Select an options structure to import:');
    importStr = sprintf('Import');
