...
%   $Revision: 1.1.6.7 $  $Date: 2010/02/08 22:38:40 $
...
filespec = '*.m';
[optimMfileName,pn] = uiputfile(filespec,'Generate MATLAB File','untitled.m');
...
if fid==-1
    ...
    errordlg(msg,'Error Saving MATLAB File','modal');
    return
end
% Close the file
fprintf(fid,'%s\n',code);
