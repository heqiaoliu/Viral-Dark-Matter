...
%   Copyright 1990-2010 The University of Maryland Baltimore County and The MathWorks, Inc.
%   $Revision: 1.1.6.6 $ $Date: 2010/02/17 18:55:46 $
   ...
   if computeLambda
      ...
      if length(sgrows) ~= length(sgcols)
            error('optim:simplexpresolve:SizeMismatch', ...
                'Unexpected error occurred when removing singletons in equality constraints.');
      end
