...
% This demonstration uses the large-scale functionality in the Optimization Toolbox(TM)
% to solve a two-dimensional Molecule Conformation Problem.  This type
% of problem also arises in other applications including satellite ranging and
% surveying.

% Copyright 1990-2007 The MathWorks, Inc.
% $Revision: 1.1.6.4 $ $Date: 2007/12/10 21:51:05 $
...
options = optimset('largescale','on', 'gradobj','on', 'hessian','on', ...
   'display','none','outputfcn',@moleculeoutputfcn);
