...
%
%       FID=WGEOM(DL,MN) writes a Geometry MATLAB-file with the name
%       [MN,'.m']. The Geometry MATLAB-file is equivalent to the
...
%       $Revision: 1.8.4.3 $  $Date: 2010/04/11 20:33:48 $
