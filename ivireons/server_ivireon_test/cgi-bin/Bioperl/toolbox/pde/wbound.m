...
%
%       FID=WBOUND(BL,MN) writes a Boundary MATLAB-file with the name
%       [MN,'.m']. The Boundary MATLAB-file is equivalent to the
...
%       $Revision: 1.8.4.2 $  $Date: 2010/04/11 20:33:47 $
