...
%PDEMDLCV Convert PDE Toolbox Model MATLAB-files for use in MATLAB 5.
%   PDEMDLCV INFILE OUTFILE converts the PDE Toolbox version 1.0
%   Model MATLAB-file to a Model MATLAB-file that can be used with the
%   MATLAB 5 compliant version of the PDE Toolbox. The new Model
%   MATLAB-file is saved in OUTFILE.

%   Magnus Ringh 10-04-96.
%   Copyright 1994-2010 The MathWorks, Inc.
%   $Revision: 1.7.4.2 $  $Date: 2010/04/11 20:33:39 $
