...
%       $Revision: 1.8.4.3 $  $Date: 2008/10/31 06:25:42 $
...
if ~flag && sn,
    p = []; e = []; tt = [];
    try 
        [p,e,tt]=initmesh(dl,'hmax',Inf,'init','on');
    catch ME
