...
%       $Revision: 1.10.4.4 $  $Date: 2010/04/11 20:33:33 $
...
if strcmp(action,'initialize'),
  ...
  % Make sure everything is a row so hndls stays a row
  hndls = [scalarflag double(linehndl) double(eq_hndl) type_hndl(:)' edit_hndl(:)' ...
          entry_hndl(:)' double(descr_hndl(:))'];
