...
%       $Revision: 1.12.4.4 $  $Date: 2010/04/11 20:33:31 $
...
options=odeset(options,'Stats','on','OutputFcn','pdeoutfun'); %#function pdeoutfun

[t,uu]=ode15s('pdehypf',ttlist,uu0,options); %#function pdehypf
