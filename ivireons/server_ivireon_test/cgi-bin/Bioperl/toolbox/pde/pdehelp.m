...
%   $Revision: 1.7.4.1 $  $Date: 2010/04/24 18:13:43 $
...
'   MATLAB-file. The session can be restarted at any time by entering \n',...
'   the name of the MATLAB-file at the MATLAB prompt.\n',...
'\n',...
