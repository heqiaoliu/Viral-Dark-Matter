...
%   This MATLAB program is designed to be used in a Simulink S-function block.
...
%
%   Set this MATLAB program up in an S-function block with a MUX with two
	...
	if h_fig <= 0
	   ...
	   if new_figure
		...
		ax = [ 0 10 0 10];
	      ...
	      h_plot1 =  plot([ax(1),ax(1)],[ax(3) ax(3)]);
	      set(h_axis,'NextPlot','add');
	      h_plot1 =  plot([ax(2),ax(2)],[ax(4) ax(4)],'r-');
