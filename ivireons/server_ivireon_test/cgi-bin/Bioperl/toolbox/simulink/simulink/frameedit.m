...
%   $Revision: 1.26.2.5 $  $Date: 2008/12/01 07:51:15 $
...
helpStr = ...
      'helpview([docroot ''/mapfiles/simulink.map''],''frame_edit'')';
u = uimenu('Parent',helpMenu,...
...
if ischar(dataRef)
   ...
   try
      ...
      DAStudio.warning('Simulink:utility:cannotOpenCDataMatFile',dataRef);
      dataRef=[];
   end
end
