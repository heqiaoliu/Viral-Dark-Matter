...
%
%     Variants                         Constrains the search from looking into
%                                      Variant Subsystems
%                    {'ActiveVariants'}       : Looks only into the active variants
%                    'AllVariants'            : Looks into all variants
%                    'ActivePlusCodeVariants' : Looks into all variants if variant
%                                               subsystem is configured for code
%                                               else looks only into active variant
%
