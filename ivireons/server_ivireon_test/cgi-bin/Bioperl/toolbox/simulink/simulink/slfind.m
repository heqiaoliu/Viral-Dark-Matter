...
%= FUNCTION == i_FindOpenDDGDialog ================================
%   - takes the port handle and tries to find an open port 
%     properties dialog. Finds the DDG dialog.
%==================================================================
function dlgH = i_FindOpenDDGDialog(PortHandle)
  ...
  %            toolbox/simulink/simulink/sigpropddg.m (DialogTag in 
  %            the schema)
