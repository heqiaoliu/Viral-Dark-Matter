% Script to create numerical data for F-14 digital autopilot demo
%
...
% Constants for anti-aliasing Butterworth filter
% designed using Signal Processing Toolbox:
%
% [fnum,fden] = butter(3,50*2*pi,'low','s');

fnum = [ 0, 0, 0, 8.371694703680943e+05 ];
fden = [ 1, 1.884955592153875e+02, 1.776528792196083e+04, 8.371694703680943e+05 ];
...
% Save variables in a MAT-file data cache

save f14_digital_data.mat

%[EOF] f14dat_digital.m
