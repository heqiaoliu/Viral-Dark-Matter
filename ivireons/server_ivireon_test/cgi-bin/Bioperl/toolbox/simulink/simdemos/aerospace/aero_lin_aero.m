...
%
% See Also :  'aero_guidance_airframe' and 'aero_guidance'

% Copyright 1990-2008 The MathWorks, Inc.
% $Revision: 1.16.4.6 $ $Date: 2008/12/01 07:48:31 $
...
io(2) = linio(sprintf(['aero_guidance_airframe/Aerodynamics &\n', ...
                    'Equations of Motion']),3,'out');
io(3) = linio('aero_guidance_airframe/Selector',1,'out');
...
clc
disp('Step 7 : Plot Bode magnitude response for each condition.')
disp(' ');
...
echo off
state_names = cell(1,length(names));
