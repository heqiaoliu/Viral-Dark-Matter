...
%   MATLAB file generated on : 30-Jun-2010 04:12:45
...
% Dependency info for S-function 'sldemo_sfun_counterbus'
info(1).SFunctionName = 'sldemo_sfun_counterbus';
info(1).IncPaths = {'sldemo_lct_src'};
info(1).SrcPaths = {'sldemo_lct_src'};
info(1).SourceFiles = {'counterbus.c'};
info(1).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_adder_cpp'
info(2).SFunctionName = 'sldemo_sfun_adder_cpp';
info(2).IncPaths = {'sldemo_lct_src'};
info(2).SrcPaths = {'sldemo_lct_src'};
info(2).SourceFiles = {'adder_cpp.cpp'};
info(2).Language = 'C++';
% Dependency info for S-function 'sldemo_sfun_gain_fixpt'
info(3).SFunctionName = 'sldemo_sfun_gain_fixpt';
info(3).IncPaths = {'sldemo_lct_src'};
info(3).SrcPaths = {'sldemo_lct_src'};
info(3).SourceFiles = {'timesS16.c'};
info(3).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_times_s16'
info(4).SFunctionName = 'sldemo_sfun_times_s16';
info(4).IncPaths = {'sldemo_lct_src'};
info(4).SrcPaths = {'sldemo_lct_src'};
info(4).SourceFiles = {'timesS16.c'};
info(4).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_gain_scalar'
info(5).SFunctionName = 'sldemo_sfun_gain_scalar';
info(5).IncPaths = {'sldemo_lct_src'};
info(5).SrcPaths = {'sldemo_lct_src'};
info(5).SourceFiles = {'gainScalar.c'};
info(5).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_fault'
info(6).SFunctionName = 'sldemo_sfun_fault';
info(6).IncPaths = {'sldemo_lct_src'};
info(6).SrcPaths = {'sldemo_lct_src'};
info(6).SourceFiles = {'fault.c'};
info(6).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_work'
info(7).SFunctionName = 'sldemo_sfun_work';
info(7).IncPaths = {'sldemo_lct_src'};
info(7).SrcPaths = {'sldemo_lct_src'};
info(7).SourceFiles = {'memory_bus.c'};
info(7).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_ndarray_add'
info(8).SFunctionName = 'sldemo_sfun_ndarray_add';
info(8).IncPaths = {'sldemo_lct_src'};
info(8).SrcPaths = {'sldemo_lct_src'};
info(8).SourceFiles = {'ndarray_ops.c'};
info(8).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_cplx_gain'
info(9).SFunctionName = 'sldemo_sfun_cplx_gain';
info(9).IncPaths = {'sldemo_lct_src'};
info(9).SrcPaths = {'sldemo_lct_src'};
info(9).SourceFiles = {'cplxgain.c'};
info(9).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_filterV1'
info(10).SFunctionName = 'sldemo_sfun_filterV1';
info(10).IncPaths = {'sldemo_lct_src'};
info(10).SrcPaths = {'sldemo_lct_src'};
info(10).SourceFiles = {'filterV1.c'};
info(10).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_filterV2'
info(11).SFunctionName = 'sldemo_sfun_filterV2';
info(11).IncPaths = {'sldemo_lct_src'};
info(11).SrcPaths = {'sldemo_lct_src'};
info(11).SourceFiles = {'filterV2.c'};
info(11).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_mat_add'
info(12).SFunctionName = 'sldemo_sfun_mat_add';
info(12).IncPaths = {'sldemo_lct_src'};
info(12).SrcPaths = {'sldemo_lct_src'};
info(12).SourceFiles = {'mat_ops.c'};
info(12).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_mat_mult'
info(13).SFunctionName = 'sldemo_sfun_mat_mult';
info(13).IncPaths = {'sldemo_lct_src'};
info(13).SrcPaths = {'sldemo_lct_src'};
info(13).SourceFiles = {'mat_ops.c'};
info(13).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_dlut3D'
info(14).SFunctionName = 'sldemo_sfun_dlut3D';
info(14).IncPaths = {'sldemo_lct_src'};
info(14).SrcPaths = {'sldemo_lct_src'};
info(14).SourceFiles = {'directLookupTableND.c'};
info(14).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_dlut4D'
info(15).SFunctionName = 'sldemo_sfun_dlut4D';
info(15).IncPaths = {'sldemo_lct_src'};
info(15).SrcPaths = {'sldemo_lct_src'};
info(15).SourceFiles = {'directLookupTableND.c'};
info(15).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_st_inherited'
info(16).SFunctionName = 'sldemo_sfun_st_inherited';
info(16).IncPaths = {'sldemo_lct_src'};
info(16).SrcPaths = {'sldemo_lct_src'};
info(16).SourceFiles = {'gainScalar.c'};
info(16).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_st_fixed'
info(17).SFunctionName = 'sldemo_sfun_st_fixed';
info(17).IncPaths = {'sldemo_lct_src'};
info(17).SrcPaths = {'sldemo_lct_src'};
info(17).SourceFiles = {'gainScalar.c'};
info(17).Language = 'C';
% Dependency info for S-function 'sldemo_sfun_st_parameterized'
info(18).SFunctionName = 'sldemo_sfun_st_parameterized';
