/*
 *   sldemo_sfun_gain_fixpt.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 ...
 *   C source code generated on : 30-Jun-2010 04:11:34
 ...
 */
#define S_FUNCTION_NAME                sldemo_sfun_gain_fixpt
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S)) {
    ...
    if (isSimulationTarget) {
       ...
       */
      ssRegMdlInfo(S, (char*)"sldemo_sfun_gain_fixpt_wrapper_output",
