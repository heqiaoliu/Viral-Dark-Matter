function [sys,x0,str,ts,simStateCompliance] = sfun_varargm(t,x,u,flag,varargin)
...
%   $Revision: 1.1.6.1 $
  ...
  switch flag,
    ...
    case 0,      % Initialization
      [sys,x0,str,ts,simStateCompliance]=mdlInitializeSizes(varargin{:});
...
%
function [sys,x0,str,ts,simStateCompliance]=mdlInitializeSizes(varargin)
  ...
  if nParams <= 0
    DAStudio.error('Simulink:blocks:mustSupplyOneParameter');
  end
