...
%   a line beginning with degree C is a scale line
...
while ~feof(f)
  ...
  if ~( strcmp(lineType, 'blank') || strcmp(lineType, 'comment') ),
    ...
    if strcmp(state,'lost'),
      warning('simdemos:readstdtcdata:algerror','Thermocouple file reader state inconsistent');
    end
    ...
    switch lineType
        ...
        case 'tabScale'
            currentScale = str2num(line(5:end)); %#ok<ST2NM>
        ...
        case 'cVUnits'
        case 'cRange'
            numbers = str2num(line(7:end)); %#ok<ST2NM>
            if length(numbers) ~= 3,
        ...
        case 'iRange',
            if strcmp(substate,'iVolts'),
                ...
                numbers = str2num(line(10:end)); %#ok<ST2NM>
