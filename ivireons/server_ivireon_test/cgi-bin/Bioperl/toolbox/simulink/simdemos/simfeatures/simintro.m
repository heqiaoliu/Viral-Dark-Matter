...
% Demo initialization ====================
if ~exist('SlideShowGUIFlag'), figNumber=0; end; %#ok<EXIST>
...
if ssinit(figNumber),
  ...
  if figNumber, return; end %#ok<UNRCH>
end
...
prmValStruct.StopTime = '39';
prmValStruct.Solver = 'FixedStepDiscrete';
prmValStruct.FixedStep = '0.01';

simout=sim(sys,prmValStruct);
t = simout.get('tout');
x = simout.get('xout');
y = simout.get('yout');
