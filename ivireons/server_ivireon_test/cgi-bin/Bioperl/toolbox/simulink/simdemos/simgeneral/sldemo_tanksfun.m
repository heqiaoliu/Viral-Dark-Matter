function [sys,x0,str,ts,simStateCompliance] = sldemo_tanksfun(t,x,u,flag,inflow,outflow, ...
                                           lolim,hilim,area)
%SLDEMO_TANKSFUN demo animation S-function for model sldemo_tank
%
%   SLDEMO_TANKSFUN updates the graphical representation of the tank for
%   the Simulink demo sldemo_tank.
%
...
switch flag,
  ...
  %%%%%%%%%%%%%%%%%%%%
    otherwise
    SLdemo_tank_UnhandledFlag = 'Unhandled flag %d';
    error('Simulink:sldemo_tanksfun:UnhandledFlag',...
           SLdemo_tank_UnhandledFlag, flag);
