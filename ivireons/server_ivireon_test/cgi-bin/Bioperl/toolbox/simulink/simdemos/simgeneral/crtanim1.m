function [sys,x0,str,ts,simStateCompliance]=crtanim1(t,x,u,flag,ts)%#ok
...
elseif flag==0,
    ...
    [onecart, onecartAxes] = animinit('onecart Animation');
    axis(onecartAxes,[-10 20 -7 7]);
    hold(onecartAxes, 'on');
    ...
    plot(onecartAxes,[-10 20],[-1.4 -1.4],'yellow', ...
        [-10:19;-9:20],[-2 -1.4],'yellow','LineWidth',2);
    hndl=plot(onecartAxes,x,y,'y','LineWidth',3);
    set(onecartAxes,'UserData',hndl);
