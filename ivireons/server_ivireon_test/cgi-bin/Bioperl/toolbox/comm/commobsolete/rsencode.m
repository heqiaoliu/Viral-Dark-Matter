...
%   $Revision: 1.11.4.1 $   $Date: 2007/03/27 19:07:49 $ 
...
warnobsolete(mfilename, 'Please use RSENC instead.');

swgfplus = warning('off', 'comm:obsolete:gfplus');
...
% Saves last warning, since gfplus leaves a warning in workspace
