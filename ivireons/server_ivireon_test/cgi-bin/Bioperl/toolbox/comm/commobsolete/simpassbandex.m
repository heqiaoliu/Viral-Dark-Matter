...
%SIMPASSBANDEX Passband QPSK simulation example
%
...
%   $Revision: 1.1.6.3 $ $Date: 2007/03/27 19:07:57 $

warnobsolete(mfilename);

swdmod = warning('off', 'comm:obsolete:dmod');
swddemod = warning('off', 'comm:obsolete:ddemod');
