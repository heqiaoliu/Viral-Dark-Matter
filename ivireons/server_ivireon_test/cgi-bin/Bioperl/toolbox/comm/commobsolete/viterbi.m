...
warnobsolete(mfilename, 'Please use VITDEC instead.');

swoct2gen = warning('off', 'comm:obsolete:oct2gen');
swsim2tran = warning('off', 'comm:obsolete:sim2tran');
swgen2abcd = warning('off', 'comm:obsolete:gen2abcd');
swvitshort = warning('off', 'comm:obsolete:vitshort');
...
if (exist('vitcore') == 3) 
  ...
  % at the very beginning, the current state number is 1, only the complete zeros.
  cur_sta_num = 1;
