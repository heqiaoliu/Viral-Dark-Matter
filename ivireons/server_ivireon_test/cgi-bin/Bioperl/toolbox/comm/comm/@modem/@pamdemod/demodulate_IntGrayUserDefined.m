...
%DEMODULATE_INTGRAYUSERDEFINED Demodulate baseband input signal X using PAM
...
%   $Revision: 1.1.6.1 $  $Date: 2007/05/06 15:48:00 $

% Get SymbolMapping and make sure that it has the same orientation as the
