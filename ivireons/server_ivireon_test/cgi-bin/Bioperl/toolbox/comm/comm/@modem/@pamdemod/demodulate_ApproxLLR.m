...
%DEMODULATE_APPROXLLR Demodulate baseband input signal X using PAM demodulator 
...
% Since PAM is a special case of QAM, this function uses QAM demodulation
% tools.
 
% @modem/@pamdemod

%   Copyright 2007-2008 The MathWorks, Inc.
%   $Revision: 1.1.6.2 $  $Date: 2008/05/31 23:15:21 $
