...
%DEMODULATE_INTGRAYUSERDEFINED Demodulate baseband input signal X using
% OQPSK demodulator object H. Return demodulated symbols/integers in Y.
% Gray or user-defined symbol mapping is used.

% @modem/@oqpskdemod

%   Copyright 2007 The MathWorks, Inc.
%   $Revision: 1.1.6.1 $  $Date: 2007/05/14 15:03:18 $
