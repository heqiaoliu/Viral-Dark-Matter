...
%DEMODULATE_APPROXLLR Demodulate baseband input signal X using General QAM
%   demodulator object H. Return soft demodulated signal Y representing
%   approximate LLR. It uses general (non-optimized) algorithm for
%   computing approximate LLR. 
 
% @modem/@genqamdemod

%   Copyright 2007-2008 The MathWorks, Inc.
%   $Revision: 1.1.6.2 $  $Date: 2008/05/31 23:15:18 $
