...
%    $Revision: 1.2.4.1 $  $Date: 2007/09/14 15:59:13 $ 
...
for k=2:length(varargin)
   ...
   if z.m~=varargin{k}.m
     error('comm:gf_vertcat:MismatchOrders','Orders must match.')
   elseif z.prim_poly~=varargin{k}.prim_poly
     error('comm:gf_vercat:MismatchPrim_Poly','Primitive polynomials must match.')
   end
end
