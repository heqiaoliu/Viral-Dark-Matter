...
%    $Revision: 1.3.4.1 $  $Date: 2007/09/14 15:58:54 $ 
...
if x.m~=y.m
  error('comm:gf_ldivide:MismatchOrders','Orders must match.')
elseif x.prim_poly~=y.prim_poly
  error('comm:gf_ldivide:MismatchPrim_Poly','Primitive polynomials must match.')
end
