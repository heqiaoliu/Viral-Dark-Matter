...
%    $Revision: 1.3.4.1 $  $Date: 2007/09/14 15:59:07 $ 
...
if x.m~=y.m
  error('comm:gf_rdivide:MismatchOrders','Orders must match.')
elseif x.prim_poly~=y.prim_poly
  error('comm:gf_rdivide:MismatchPrim_Poly','Primitive polynomials must match.')
end
