...
%   $Revision: 1.1.6.2 $  $Date: 2007/09/14 15:59:24 $

if (nargin < 2)
    error('comm:private:is:InvalidNumOfArgs','IS requires at least 2 arguments.')
end
switch lower(varargin{1})
    ...
    otherwise
        error('comm:private:is:UnsupportedTest','Unsupported test.')
end
