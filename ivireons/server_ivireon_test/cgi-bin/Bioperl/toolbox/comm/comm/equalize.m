...
%
%   [Y, YD, E] = EQUALIZE(...) returns the result of an error calculation.
%   For adaptive algorithms other than CMA, E is the vector of errors
%   between Y and the reference signal, where the reference signal consists
%   of the training sequence or detected symbols.
%
%   See also LMS, SIGNLMS, NORMLMS, VARLMS, RLS, CMA, LINEAREQ, DFE.

%   Copyright 1996-2007 The MathWorks, Inc.
%   $Revision: 1.1.6.7 $  $Date: 2007/09/14 15:57:19 $
...
id = 'comm:equalize:ImproperUseOfEqualize';
