function [sig, quanterr] = dpcmdeco(indx, codebook, predictor)
...
%   parameters.
%
%   [SIG, QUANTERR] = DPCMDECO(INDX, CODEBOOK, PREDICTOR) outputs the
%   quantized predictive error in QUANTERR.
%
%   The input parameters CODEBOOK and PREDICTOR can be estimated by
%   DPCMOPT.
%
%   See also QUANTIZ, DPCMOPT, DPCMENCO.

%   Copyright 1996-2007 The MathWorks, Inc.
%   $Revision: 1.15.4.2 $ $Date: 2007/08/03 21:17:27 $

if nargin < 3
    error('comm:dpcmdeco:NotEnoughInputs','Not enough input variables for DPCMDECO.');
end;
