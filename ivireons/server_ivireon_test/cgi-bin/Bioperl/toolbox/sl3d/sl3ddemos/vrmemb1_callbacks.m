...
%   $Revision: 1.1.6.1 $ $Date: 2008/10/31 07:12:44 $ $Author: batserve $
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function PostLoad   %#ok<DEFNU> called by switchboard
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function ZoomSlider(sys)   %#ok<DEFNU> called by switchboard
