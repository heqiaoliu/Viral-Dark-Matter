/*
 *   rtwdemo_sfun_st_parameterized.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = gainScalar(single u1, single p1)
 *
 *   Simulink version           : 7.6 (R2010b) 28-Jun-2010
 *   C source code generated on : 30-Jun-2010 02:25:47
 ...
 */
#define S_FUNCTION_NAME                rtwdemo_sfun_st_parameterized
...
static void mdlCheckParameters(SimStruct *S)
{
  ...
  if EDIT_OK(S, 1) {
    ...
    int32_T stArraySize = mxGetM(SAMPLE_TIME) * mxGetN(SAMPLE_TIME);
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S)) {
     ...
     */
    ssRegMdlInfo(S, (char*)"gainScalar", MDL_INFO_ID_RESERVED, 0, 0, (void*)
                 ssGetPath(S));
  }
