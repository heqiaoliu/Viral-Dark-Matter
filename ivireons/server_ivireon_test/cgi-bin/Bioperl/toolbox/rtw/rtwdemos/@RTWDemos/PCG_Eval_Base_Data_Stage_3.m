%--------------------------------------------------------
% File PCG_Eval_Base_Data_Stage_3 Automatically generated 07-Dec-2006
%--------------------------------------------------------
...
% Next Entry: I_Gain_2
%----------------------
I_Gain_2 = Simulink.Parameter;
I_Gain_2.RTWInfo.StorageClass =  'Custom';
I_Gain_2.RTWInfo.Alias = char([]);
I_Gain_2.RTWInfo.CustomStorageClass =  'Const';
I_Gain_2.Description = char([]);
I_Gain_2.DataType =  'auto';
I_Gain_2.Min = double(-Inf);
I_Gain_2.Max = double(Inf);
I_Gain_2.DocUnits = char([]);
I_Gain_2.Value = double(-0.03);
%----------------------
...
% Next Entry: P_Gain_2
%----------------------
P_Gain_2 = Simulink.Parameter;
P_Gain_2.RTWInfo.StorageClass =  'Custom';
P_Gain_2.RTWInfo.Alias = char([]);
P_Gain_2.RTWInfo.CustomStorageClass =  'Const';
P_Gain_2.Description = char([]);
P_Gain_2.DataType =  'auto';
P_Gain_2.Min = double(-Inf);
P_Gain_2.Max = double(Inf);
P_Gain_2.DocUnits = char([]);
P_Gain_2.Value = double(0.74);
%----------------------
