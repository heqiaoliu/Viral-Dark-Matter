%--------------------------------------------------------
% File PCG_Eval_Base_Data_Stage_5 Automatically generated 08-Nov-2006
%--------------------------------------------------------
...
I_Gain.RTWInfo.CustomStorageClass =  'Default';  %'Const';  % Changed to Default (Custom) for Model Block SIL
...
I_InErrMap.RTWInfo.CustomStorageClass =  'Default';  %'Const';  % Changed to Default (Custom) for Model Block SIL
...
I_OutMap.RTWInfo.CustomStorageClass =  'Default';  %'Const';  % Changed to Default (Custom) for Model Block SIL
...
P_Gain.RTWInfo.CustomStorageClass =  'Default';  %'Const';  % Changed to Default (Custom) for Model Block SIL
...
P_InErrMap.RTWInfo.CustomStorageClass =  'Default';  %'Const';  % Changed to Default (Custom) for Model Block SIL
...
P_OutMap.RTWInfo.CustomStorageClass =  'Default';  %'Const';  % Changed to Default (Custom) for Model Block SIL
...
fbk_1.RTWInfo.StorageClass =  'ImportedExtern';
fbk_1.RTWInfo.Alias = char([]);
fbk_1.RTWInfo.CustomStorageClass =  'Default';
fbk_1.Description = char([]);
fbk_1.DataType =  'double';
fbk_1.Min = double(-Inf);
fbk_1.Max = double(Inf);
fbk_1.DocUnits = char([]);
fbk_1.Dimensions = double(-1);
fbk_1.Complexity =  'auto';
fbk_1.SampleTime = double(-1);
fbk_1.SamplingMode =  'auto';
fbk_1.InitialValue = char([]);
%----------------------
% Next Entry: fbk_2
%----------------------
...
pos_cmd_one.Description = char([]);
pos_cmd_one.DataType =  'double';
pos_cmd_one.Min = double(-Inf);
pos_cmd_one.Max = double(Inf);
pos_cmd_one.DocUnits = char([]);
pos_cmd_one.Dimensions = double(-1);
pos_cmd_one.Complexity =  'auto';
pos_cmd_one.SampleTime = double(-1);
pos_cmd_one.SamplingMode =  'auto';
pos_cmd_one.InitialValue = char([]);
%----------------------
% Next Entry: pos_cmd_two
%----------------------
pos_cmd_two = Simulink.Signal;
pos_cmd_two.RTWInfo.StorageClass =  'ExportedGlobal';
pos_cmd_two.RTWInfo.Alias = char([]);
pos_cmd_two.RTWInfo.CustomStorageClass =  'Default';
pos_cmd_two.Description = char([]);
pos_cmd_two.DataType =  'double';
pos_cmd_two.Min = double(-Inf);
pos_cmd_two.Max = double(Inf);
pos_cmd_two.DocUnits = char([]);
pos_cmd_two.Dimensions = double(-1);
pos_cmd_two.Complexity =  'auto';
pos_cmd_two.SampleTime = double(-1);
pos_cmd_two.SamplingMode =  'auto';
pos_cmd_two.InitialValue = char([]);
%----------------------
% Next Entry: pos_rqst
%----------------------
...
% ThrottleCommands.HeaderFile =  'ThrottleBus.h';  % Commented out for Model SIL mode
...
% ThrottleParams.HeaderFile =  'ThrottleBus.h';  % Commented out for Model SIL mode
eleTmp(1) = Simulink.BusElement;
