/*
 *   rtwdemo_sfun_times_s16.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 ...
 *   C source code generated on : 30-Jun-2010 02:24:58
 ...
 */
#define S_FUNCTION_NAME                rtwdemo_sfun_times_s16
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S)) {
    ...
    if (isSimulationTarget) {
       ...
       */
      ssRegMdlInfo(S, (char*)"rtwdemo_sfun_times_s16_wrapper_output",
