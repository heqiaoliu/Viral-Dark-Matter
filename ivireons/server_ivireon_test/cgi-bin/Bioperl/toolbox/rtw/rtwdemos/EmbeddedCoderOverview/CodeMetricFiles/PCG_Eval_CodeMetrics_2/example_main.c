...
#include "PCG_Eval_CodeMetrics_2.h"               /* Model's header file */
#include "rtwtypes.h"                  /* MathWorks types */
#include "PCG_Eval_CodeMetrics_2_private.h"       /* Local data for PCG Eval */
#include "defineImportedData.h"        /* The inputs to the system */

static BlockIO_PCG_Eval_CodeMetrics_2 PCG_Eval_CodeMetrics_2_B;/* Observable signals */
static D_Work_PCG_Eval_CodeMetrics_2 PCG_Eval_CodeMetrics_2_DWork;/* Observable states */
...
int_T main(void)
{
      ...
      Functions would be called based on a scheduling algorithm */
  {
    ...
    PI_Cntrl_Reusable((*pos_rqst),fbk_1,&PCG_Eval_CodeMetrics_2_B.PI_ctrl_1,
                       &PCG_Eval_CodeMetrics_2_DWork.PI_ctrl_1,
                       I_Gain, P_Gain);
    PI_Cntrl_Reusable((*pos_rqst),fbk_2,&PCG_Eval_CodeMetrics_2_B.PI_ctrl_2,
                       &PCG_Eval_CodeMetrics_2_DWork.PI_ctrl_2,
                       I_Gain_2, P_Gain_2);
    pos_cmd_one = PCG_Eval_CodeMetrics_2_B.PI_ctrl_1.Saturation1;
    pos_cmd_two = PCG_Eval_CodeMetrics_2_B.PI_ctrl_2.Saturation1;
