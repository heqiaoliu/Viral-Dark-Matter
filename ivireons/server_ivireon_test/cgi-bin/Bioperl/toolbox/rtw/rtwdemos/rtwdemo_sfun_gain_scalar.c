/*
 *   rtwdemo_sfun_gain_scalar.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 ...
 *   C source code generated on : 30-Jun-2010 02:25:04
 ...
 */
#define S_FUNCTION_NAME                rtwdemo_sfun_gain_scalar
