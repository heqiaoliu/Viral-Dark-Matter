/*
 *   rtwdemo_sfun_filterV2.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = filterV2(single u1[1], single u2, single p1)
 *
 *   Simulink version           : 7.6 (R2010b) 28-Jun-2010
 *   C source code generated on : 30-Jun-2010 02:25:13
 ...
 */
#define S_FUNCTION_NAME                rtwdemo_sfun_filterV2
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S)) {
     ...
     */
    ssRegMdlInfo(S, (char*)"filterV2", MDL_INFO_ID_RESERVED, 0, 0, (void*)
                 ssGetPath(S));
  }
