/*
 *   rtwdemo_sfun_gain_fixpt.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        myFixpt y1 = timesS16(myFixpt u1, myFixpt p1, uint8 p2)
 *
 *   Simulink version           : 7.6 (R2010b) 28-Jun-2010
 *   C source code generated on : 30-Jun-2010 02:24:53
 ...
 */
#define S_FUNCTION_NAME                rtwdemo_sfun_gain_fixpt
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S)) {
    ...
    if (isSimulationTarget) {
       ...
       */
      ssRegMdlInfo(S, (char*)"rtwdemo_sfun_gain_fixpt_wrapper_output",
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   */
  myFixpt *p1 = (myFixpt *) ssGetRunTimeParamInfo(S, 0)->data;
