...
%   $Revision: 1.1.6.5 $  $Date: 2007/11/17 22:01:55 $
...
%%
% The legacy source code is found in the
% files <matlab:sldemo_lct_util('edit','sldemo_lct_src/timesFixpt.h') timesFixpt.h>, and
...
% <matlab:rtwdemo_lct_util('edit','rtwdemo_sfun_times_s16.c') rtwdemo_sfun_times_s16.c>.
...
% <matlab:rtwdemo_lct_util('edit','rtwdemo_sfun_times_s16.tlc') rtwdemo_sfun_times_s16.tlc>.
...
% The model <matlab:rtwdemo_lct_fixpt_signals rtwdemo_lct_fixpt_signals> 
% shows integration with the legacy
% code.  The subsystem TestFixpt serves as a harness for the call to the
% legacy C function via the generated S-function, and the scope compares the 
% output of the function with the output of the built-in Simulink(R) product 
% block; the results are identical.
