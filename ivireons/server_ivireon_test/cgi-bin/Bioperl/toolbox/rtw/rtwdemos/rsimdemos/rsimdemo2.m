...
%   $Revision: 1.16.4.4 $
  ...
  % Load the model "rtwdemo_rsimtf" if it isn't already loaded
  ...
  for i = 1:5
    ...
    runstr = strcat('!',pwd,filesep,'rtwdemo_rsimtf -f rsim_tfdata.mat=sweep',num2str(i),'.mat');
