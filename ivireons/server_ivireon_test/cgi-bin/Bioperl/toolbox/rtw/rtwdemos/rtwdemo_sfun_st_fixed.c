/*
 *   rtwdemo_sfun_st_fixed.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 ...
 */
#define S_FUNCTION_NAME                rtwdemo_sfun_st_fixed
...
{
  ssSetSampleTime(S, 0, (real_T)2);
  ssSetOffsetTime(S, 0, (real_T)1);
