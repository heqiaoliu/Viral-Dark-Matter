/*
 *   rtwdemo_sfun_filterV1.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = filterV1(single u1, single u2, single p1)
 *
 ...
 */
#define S_FUNCTION_NAME                rtwdemo_sfun_filterV1
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S)) {
     ...
     */
    ssRegMdlInfo(S, (char*)"filterV1", MDL_INFO_ID_RESERVED, 0, 0, (void*)
                 ssGetPath(S));
  }
