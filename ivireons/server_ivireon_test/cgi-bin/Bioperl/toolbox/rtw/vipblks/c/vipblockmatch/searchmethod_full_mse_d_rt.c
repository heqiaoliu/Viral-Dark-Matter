 ...
 *  $Revision: 1.1.10.3 $  $Date: 2008/08/01 12:24:59 $
 */
#include "vipblockmatch_rt.h"  

EXPORT_FCN void MWVIP_SearchMethod_Full_MSE_D(const real_T *blkCS, const real_T *blkPB, /* CS = current image (smaller block), PB = previous image (bigger block) */
