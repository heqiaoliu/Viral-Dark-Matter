 ...
 *  $Revision: 1.1.10.3 $  $Date: 2008/08/01 12:24:58 $
 */
#include "vipblockmatch_rt.h"  

EXPORT_FCN void MWVIP_SearchMethod_Full_MAD_R(const real32_T *blkCS, const real32_T *blkPB, /* CS = current image (smaller block), PB = previous image (bigger block) */
