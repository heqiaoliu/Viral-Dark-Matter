 ...
 *  $Revision: 1.1.12.1 $  $Date: 2004/07/14 06:43:17 $
 */
#include "viphough_rt.h"  

EXPORT_FCN void MWVIP_Hough_R(
    const boolean_T  *uBW,
    real32_T           *yH,
...
)
{
    ...
    real32_T slope = (rhoLen - 1)/(-2*firstRho) ; /* (endRho - firstRho), endRho=rho[rhoLen-1]=-firstRho); */
