 ...
 *  $Revision: 1.1.10.2 $  $Date: 2005/12/22 18:35:34 $
 */
#include "vipblockmatch_rt.h"  

EXPORT_FCN void MWVIP_SearchMethod_3Step_MSE_D(const real_T *blkCS, const real_T *blkPB, /* CS = current image (smaller block), PB = previous image (bigger block) */
