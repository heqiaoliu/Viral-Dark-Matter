 ...
 *  $Revision: 1.1.10.2 $  $Date: 2005/12/22 18:35:33 $
 */
#include "vipblockmatch_rt.h"  

EXPORT_FCN void MWVIP_SearchMethod_3Step_MAD_R(const real32_T *blkCS, const real32_T *blkPB, /* CS = current image (smaller block), PB = previous image (bigger block) */
