...
extern "C" {
   ...
   static inline double safeGetScalar(SimStruct * S, mxArray * array);
 ...
 * If array is NULL then an error status and message will be set and 0 
 * will be returned
 *
 * S     - SimStruct
 * array - array
...
static inline double safeGetScalar(SimStruct * S, mxArray * array)
{
  ...
  {
    ssSetErrorStatus(S, "null pointer to mxGetScalar");
    return 0;
  }
}
