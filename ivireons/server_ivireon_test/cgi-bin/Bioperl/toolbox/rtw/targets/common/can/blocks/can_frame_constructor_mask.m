...
%   $Date: 2008/05/01 20:22:44 $
   ...
   case 'callback'
      ...
      if (strcmp(get_param(bdroot(block),'BlockDiagramType'),'library'))
        TargetCommon.ProductInfo.warning('can', 'OpeningCANMsgPackingMask');
        return;
      end; 
      ...
      f = awtcreate('com.mathworks.toolbox.ecoder.canlib.CanDB.FrameBuilderMask', ...
                    ...
                    parentframe, 0, processedMsg , ...
                    pwd, library_block_name,'Packs input data signals into a CAN message');
