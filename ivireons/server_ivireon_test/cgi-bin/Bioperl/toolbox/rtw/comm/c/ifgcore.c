 ...
 *  $Revision: 1.1.6.7 $ $Date: 2009/04/21 03:55:16 $ 
 */
    ...
    )
{
   ...
   if (KI==1) {
       ...
       */
       ...
       for (m=0; m<NC; m++) {
           linearinterpolation(y, ppOutput, m, Nout, NSpp, KI, startIdx, endIdx);
       }
   ...
   /* TODO: Increment number of source samples processed. */
   /* Equivalent M-code:
      NumSamplesProcessed = NumSamplesProcessed + numSourceSamples; */
}
