/*    
 *    File: rqam_opt_approx_llr_d_rt.c
 ...
 *    $Revision: 1.1.6.3 $ $Date: 2009/03/09 19:25:25 $
 */

#include "rqam_opt_approx_llr_d_rt.h"
                           ...
                           real_T         *approxLLR)        /* output values - Approximate LLR */
{
    ...
    for (elementIdx = 0; elementIdx < numElements; elementIdx++)
    {
        ...
        iIndx = (int32_T)(commROUNDnear_D( ((scaleFactor[0] * derotatedRe) + sqrtMminus1 + 0.5) ));
        ...
        qIndx = (int32_T)(commROUNDnear_D( ((scaleFactor[0] * derotatedIm) + sqrtMminus1 + 0.5) ));
