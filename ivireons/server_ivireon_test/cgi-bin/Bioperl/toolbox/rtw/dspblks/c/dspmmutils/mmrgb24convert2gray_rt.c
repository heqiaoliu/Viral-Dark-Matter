 ...
 * $Revision: 1.1.6.3 $  $Date: 2006/12/27 21:20:32 $
 */
...
EXPORT_FCN COPY_RGB24_FUNC MWDSP_GetRGB24ToIntensityCopyFcn(VideoDataType dType)
{
    int_T offset = dType;
...
EXPORT_FCN COPY_RGB24_FUNC MWDSP_GetIntensityEmptyFcn(VideoDataType dType)
{
    int_T offset = dType;
    if(offset >= 0 && offset < NUM_DTYPES)
