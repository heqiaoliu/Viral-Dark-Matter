 ...
 * $Revision: 1.1.6.3 $  $Date: 2006/10/18 03:06:53 $
 */
...
EXPORT_FCN COPY_RGB24_FUNC MWDSP_GetRGB24CopyFcn(VideoDataType dType)
{
    int_T offset = dType;
...
EXPORT_FCN COPY_RGB24_CHANS_FUNC MWDSP_GetRGB24ChannelsCopyFcn(VideoDataType dType)
{
    int_T offset = dType;
    if(offset >= 0 && offset < NUM_DTYPES)
...
EXPORT_FCN COPY_RGB24_FUNC MWDSP_GetRGB24EmptyFcn(VideoDataType dType)
{
    int_T offset = dType;
    if(offset >= 0 && offset < NUM_DTYPES)
...
EXPORT_FCN COPY_RGB24_CHANS_FUNC MWDSP_GetRGB24ChannelsEmptyFcn(VideoDataType dType)
{
    int_T offset = dType;
    if(offset >= 0 && offset < NUM_DTYPES)
