/*
 * SVD_HELPER_RT - Signal Processing Blockset Singular Value Decomposition helper functions
 *
 *  Copyright 1995-2005 The MathWorks, Inc.
 *  $Revision: 1.1.6.2 $  $Date: 2008/11/18 01:45:12 $
 */
...
NONINLINED_EXPORT_FCN int_T svd_IsFinite(double x)
{
	int hx;
...
NONINLINED_EXPORT_FCN int_T svd_IsFinite32(float x)
{
    return (int32_T) ((uint32_T)(((*((int32_T *)&x)) & 0x7fffffff) - 0x7f800000) >> 31 != 0);
}

/* construct Givens plane rotation */
NONINLINED_EXPORT_FCN void svd_rotg(real_T *x, real_T *y, real_T *c, real_T *s)
{
...
/* construct Givens plane rotation */
NONINLINED_EXPORT_FCN void svd_rotg32(real32_T *x, real32_T *y, real32_T *c, real32_T *s)
{
