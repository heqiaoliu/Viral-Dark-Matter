function mouseDown(ntx)
% Capture current location, and record shift-click state

%   Copyright 2010 The MathWorks, Inc.
%   $Revision: 1.1.6.2 $     $Date: 2010/04/21 21:21:43 $
...
if isempty(motionFcn)
    ...
    switch ntx.WhichLineDragged
        ...
        case 4
            ...
            %
            % mouseMove() checks this and WhichLineDragged wouldn't be 4
        ...
        otherwise
            ...
            error(errID,'mouseDown() invoked on unhandled enumeration (%d)', ...
                ntx.WhichLineDragged);
    end
end
set(hfig, ...
    ...
    'WindowButtonUpFcn',@(hco,ev)mouseUp(ntx));
