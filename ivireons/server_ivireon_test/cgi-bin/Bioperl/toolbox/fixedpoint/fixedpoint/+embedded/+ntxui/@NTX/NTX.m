...
%   $Revision: 1.1.6.1.4.1 $     $Date: 2010/07/06 14:39:04 $
    ...
    properties (Access=private)
        ...
        RadixPt = -1  % exponent, N -> value=0.5 
    ...
    methods (Access=private)
        ...
        isFirstUpdate = updateHistData(ntx,data)
        ...
        initHistDisplay(ntx)
        updateNumericTypesAndSigns(ntx,isFirstUpdate)
