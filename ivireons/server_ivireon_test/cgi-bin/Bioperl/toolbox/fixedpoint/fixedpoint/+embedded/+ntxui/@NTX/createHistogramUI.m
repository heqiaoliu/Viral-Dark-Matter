...
%   $Revision: 1.1.6.2.2.1 $     $Date: 2010/07/06 14:39:06 $
...
% Create "Signed" text
tip = DAStudio.message('FixedPoint:fiEmbedded:SignedTextToolTip'); 
...
str = DAStudio.message('FixedPoint:fiEmbedded:NarrowDisplay');
...
%
ntx.RadixPt = -1;  % exponent, N -> value=0.5
