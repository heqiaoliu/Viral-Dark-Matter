%ISSCALEDDOUBLE Determine whether numerictype object has scaled double data type
%   ISSCALEDDOUBLE(T) returns 1 when the DataType property of numerictype 
%   object T is 'ScaledDouble', and 0 otherwise.
%
...
%   $Revision: 1.1.6.2 $  $Date: 2010/04/21 21:22:10 $
