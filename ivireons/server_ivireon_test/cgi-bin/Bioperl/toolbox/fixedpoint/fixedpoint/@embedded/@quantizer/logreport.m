...
%   $Revision: 1.1.6.3 $ $Date: 2006/12/20 07:13:50 $
...
warn_id = {'fixedpoint:fi:maxlog:reset', ...
           'fixedpoint:fi:minlog:reset', ...
           'fixedpoint:fi:noverflows:reset', ...
           'fixedpoint:fi:nunderflows:reset', ...
           'fixedpoint:fi:noperations:reset', ...
           'fixedpoint:fi:maxlog:loggingoff', ...
           'fixedpoint:fi:minlog:loggingoff', ...
           'fixedpoint:fi:noverflows:loggingoff', ...
           'fixedpoint:fi:nunderflows:loggingoff', ...
           'fixedpoint:fi:noperations:loggingoff', ...
           'fixedpoint:fi:maxlog:loggingoffandreset', ...
           'fixedpoint:fi:minlog:loggingoffandreset', ...
           'fixedpoint:fi:noverflows:loggingoffandreset', ...
           'fixedpoint:fi:nunderflows:loggingoffandreset', ...
           'fixedpoint:fi:noperations:loggingoffandreset' ...
          };
