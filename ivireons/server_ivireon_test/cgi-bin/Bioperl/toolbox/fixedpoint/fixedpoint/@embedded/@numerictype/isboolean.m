%ISBOOLEAN Determine whether numerictype object has boolean data type
%   ISBOOLEAN(T) returns 1 when the DataType property of numerictype object
%   T is 'boolean', and 0 otherwise.
%
...
%   $Revision: 1.1.6.2 $  $Date: 2010/04/21 21:22:06 $
