...
%CONVERGENT Round to nearest integer - ties round to nearest even integer
%   Y = CONVERGENT(A) rounds fi object A to the nearest integer or, in case
%   of a tie, to the nearest even integer, then returns the result in fi 
%   object Y.
%
...
%
%   See also EMBEDDED.FI/CEIL, EMBEDDED.FI/FIX, EMBEDDED.FI/FLOOR,
%            EMBEDDED.FI/NEAREST, EMBEDDED.FI/ROUND

%   Copyright 2007 The MathWorks, Inc.
%   $Revision: 1.1.6.1 $  $Date: 2007/10/15 22:49:24 $
