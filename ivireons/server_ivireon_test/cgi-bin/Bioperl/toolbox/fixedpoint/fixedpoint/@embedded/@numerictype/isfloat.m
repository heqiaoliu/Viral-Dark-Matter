%ISFLOAT Determine whether numerictype object has floating-point data type
%   ISFLOAT(T) returns 1 when the DataType property of numerictype object T 
%   is 'single' or 'double', and 0 otherwise.
%
...
%   $Revision: 1.1.6.2 $  $Date: 2010/04/21 21:22:09 $
