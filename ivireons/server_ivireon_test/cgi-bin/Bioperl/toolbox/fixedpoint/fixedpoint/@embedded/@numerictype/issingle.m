%ISSINGLE Determine whether numerictype object has single-precision data type
%   ISSINGLE(T) returns 1 when the DataType property of numerictype object T
...
%   $Revision: 1.1.6.2 $  $Date: 2010/04/21 21:22:15 $
