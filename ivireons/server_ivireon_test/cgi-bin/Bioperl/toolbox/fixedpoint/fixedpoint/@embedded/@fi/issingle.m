%ISSINGLE Determine whether fi object has single-precision data type
%   ISSINGLE(A) returns 1 when the DataType property of fi object A is 'single',
%   and 0 otherwise.
%
...
%   $Revision: 1.1.6.2 $  $Date: 2010/04/21 21:22:05 $
