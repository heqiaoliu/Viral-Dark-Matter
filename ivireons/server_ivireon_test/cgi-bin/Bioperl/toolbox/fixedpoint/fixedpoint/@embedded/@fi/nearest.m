...
%NEAREST Round to nearest integer - ties round towards positive infinity
%   Y = NEAREST(A) rounds fi object A to the nearest integer or, in case of
%   a tie, to the nearest integer in the direction of positive infinity, 
...
%            EMBEDDED.FI/FLOOR, EMBEDDED.FI/ROUND

%   Copyright 2007 The MathWorks, Inc.
%   $Revision: 1.1.6.1 $  $Date: 2007/10/15 22:49:29 $
