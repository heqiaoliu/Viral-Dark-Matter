...
%   the difference between the word length and fraction length of A. If A 
%   is signed, then the minimum word length of Y is 2. If A is unsigned, 
...
%
%   See also EMBEDDED.FI/CEIL, EMBEDDED.FI/CONVERGENT, EMBEDDED.FI/FLOOR,
%            EMBEDDED.FI/NEAREST, EMBEDDED.FI/ROUND

%   Copyright 2007 The MathWorks, Inc.
%   $Revision: 1.1.6.1 $  $Date: 2007/10/15 22:49:27 $

Y = fi_matlab_style_round_helper(A, mfilename, 0);
