...
%----------------------------------------------------------------------- 
rowspan = rowspan + 1;
dataTypeModeLbl.Name = 'Data type mode:';
...
%----------------------------------------------------------------------- 
rowspan = rowspan + 1;
wordLengthLbl.Name = 'Word length:';
...
%----------------------------------------------------------------------- 
rowspan = rowspan + 1;
dataTypeOverrideLbl.Name = 'Data type override: ';
