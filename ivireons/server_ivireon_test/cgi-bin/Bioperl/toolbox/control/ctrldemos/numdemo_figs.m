function numdemo_figs(fignum)
% Creates pictures for Numerical Do's and Don'ts demo. Save resulting
% figure as PNG file to include in demo.

%   Authors: P. Gahinet
%   Revised: A. DiVergilio
%   Copyright 1986-2007 The MathWorks, Inc.
%   $Revision: 1.1.8.1 $  $Date: 2007/06/07 14:35:27 $

figure;
ax = gca;
switch fignum
   case 1
      set(ax,'position',[0 .2 1.1 .75])
      DrawDiagram(ax)
   case 2
      set(ax,'position',[-.1 .2 1.2 .75])
      DrawLoop(ax)
end
