function rlc_gui
%RLC_GUI  RLC Circuit Response GUI.
%
%   RLC_GUI is an interactive demo GUI showing the relationship
...
%   $Revision: 1.1.8.1 $  $Date: 2007/06/07 14:35:34 $

% Figure
pos = get(0,'DefaultFigurePosition');
fg = figure(...
   'Name',xlate('RLC Circuit Analysis'),...
...
function localEndScan(r)
for ct=1:4
   draw(r(ct))  % update plots
end

function localUpdate(eventData,fg,param)
...
% localSelectSystem %
%%%%%%%%%%%%%%%%%%%%%
function localSelectSystem(eventSrc,eventData) %#ok<INUSD>
