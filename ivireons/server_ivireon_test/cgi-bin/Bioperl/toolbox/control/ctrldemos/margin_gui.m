function margin_gui
% Interactive GUI for MARGINDEMO.
%
% This GUI illustrates the concept of stability margins and its relation
% with the closed-loop time response characteristics.

%   Author(s): P. Gahinet
%   Copyright 1986-2007 The MathWorks, Inc.
%   $Revision: 1.1.8.1 $  $Date: 2007/06/07 14:35:19 $

% Data structure
sys = tf([.5 1.3],[1 1.2  1.6 0]);
Gain = 1;
ds = struct(...
	'System',sys,...
	'System_ss',ss(sys),...
...
fig = figure(...
    ...
    'DoubleBuffer','on', ...
    'IntegerHandle','off',...
    'Name',xlate('Gain and Phase Margin Analysis'), ...
    'NumberTitle','off', ...
...
rtslider('Position',[0.765 y0+.08 .97-.765 .05],'Range',[.1 10],'Scale','log',...
    'FontSize',8+isunix,'Parent',fig,'Value',Gain,'Callback',BMF,'ButtonUpFcn',BUF);
...
mag = mag(:); phase = phase(:);
T = feedback(ds.System_ss*Gain,1);
y = step(T,t);
...
equation('Parent',ax,'Name','G(s)',...
    'Num','0.5 s + 1.3','Den','s^3 + 1.2 s^2 + 1.6 s',...
