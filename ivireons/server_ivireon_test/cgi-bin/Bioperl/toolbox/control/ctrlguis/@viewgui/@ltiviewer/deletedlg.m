...
%   $Revision: 1.12.4.9 $  $Date: 2010/03/22 03:40:46 $
...
Frame.setName('LTIViewerDeleteDialog');
...
try
    ...
    errordlg(ltipack.utStripErrorHeader(ME.message),'Delete Error');
end
...
% Table view
Table = MWTable(20,3);
Table.setName('ModelDeleteTable');
