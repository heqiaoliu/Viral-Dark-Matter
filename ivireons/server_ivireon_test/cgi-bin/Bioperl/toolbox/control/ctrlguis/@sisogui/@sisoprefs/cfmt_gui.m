...
%   $Revision: 1.13.4.3 $  $Date: 2010/04/21 21:10:37 $
...
Main.setLayout(com.mathworks.mwt.MWBorderLayout(0,5));
Main.setFont(Prefs.JavaFontB);

% Selection label
s.Label = com.mathworks.mwt.MWLabel(ctrlMsgUtils.message('Controllib:gui:strSelectCompensatorFormatLabel'),...
   com.mathworks.mwt.MWLabel.LEFT);
s.Label.setFont(Prefs.JavaFontP);
Main.add(s.Label,com.mathworks.mwt.MWBorderLayout.NORTH);

%---Main panel
s.M = com.mathworks.mwt.MWPanel(GL_31); 
Main.add(s.M,com.mathworks.mwt.MWBorderLayout.CENTER);
