...
%  $Revision: 1.26.4.6 $ $Date: 2008/09/15 20:36:44 $
...
Xr = Editor.Phase(2:end-1) * pi / 180;   % rad
Yr = Editor.Magnitude(2:end-1) * getZPKGain(Editor.EditedBlock,'mag');  % abs
...
switch MovedGroup.Type
    case 'Real'
        ...
        Yinit = Editor.interpmag(Wo,Yr,abs(r0)); %initial root mag value
