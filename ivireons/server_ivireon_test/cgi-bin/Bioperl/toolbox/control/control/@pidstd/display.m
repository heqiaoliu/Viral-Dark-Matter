...
% $Revision: 1.1.8.3 $ $Date: 2010/04/11 20:29:35 $
...
if nsys==1
    ...
    if any(ArraySizes==0)
        ...
        if Data(1).Ts==0,
            fprintf('%s\n',ctrlMsgUtils.message('Control:ltiobject:pidstdDisplayArray2',ArrayDims(1:end-1)));
        else
            fprintf('%s\n',ctrlMsgUtils.message('Control:ltiobject:pidstdDisplayArray3',ArrayDims(1:end-1)));
        end
    end
end
...
MsgID = ['Control:ltiobject:pidstdDisplayType' PID.getType];
