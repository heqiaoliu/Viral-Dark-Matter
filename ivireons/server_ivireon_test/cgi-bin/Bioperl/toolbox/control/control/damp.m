...
%   $Revision: 1.17.4.4 $  $Date: 2009/11/09 16:17:44 $
if nargin>0 && ~isnumeric(a)
   ctrlMsgUtils.error('Control:general:NotSupportedModelsofClass','damp',class(a))
end
...
if sa(2)>1,
   ...
   elseif sa(1)==1
      ...
      ctrlMsgUtils.error('Control:analysis:damp2');
   end
else
   r = a;
end
...
if nargin==1
   Ts = 0;
elseif ~isscalar(Ts)
   ctrlMsgUtils.error('Control:analysis:damp3');
end
