...
%   $Revision: 1.1.6.2 $  $Date: 2009/10/29 16:08:36 $
...
bZoom = uimgr.uibuttongroup('Zoom', b1, b2, b3);
...
bZoomAuto = uimgr.uibuttongroup('ZoomAndAutoscale', bZoom, bAutoscale);

plugInGUI = uimgr.uiinstaller({ ...
    bZoomAuto, 'Base/Toolbars/Main/Tools'; ...
