...
%   $Revision: 1.1.4.4 $  $Date: 2010/02/08 22:53:42 $
...
if constrflag
    ...
    warnstr = ...
        sprintf(['Constraint gradient function provided but OPTIONS.GradConstr=''off'';', ...
    ...
    warnstr = ...
        sprintf(['Gradient function provided but OPTIONS.GradObj=''off'';', ...
...
elseif isa(funstr, 'cell') && length(funstr)==3 ...
    ...
    if ~hessflag && ~gradflag
        warning('optimlib:optimfcnchk:HessianAndGradientOptionsOff', ...
            ['Hessian and gradient functions provided but OPTIONS.Hessian=''off'' and ', ...
            'OPTIONS.GradObj=''off''; ignoring Hessian and gradient functions. Rerun with ', ...
            'OPTIONS.Hessian=''on'' and OPTIONS.GradObj=''on'' to use derivative functions.'])
        calltype = 'fun';
    elseif hessflag && ~gradflag
        warning('optimlib:optimfcnchk:GradientOptionOff', ...
            ['Hessian and gradient functions provided but OPTIONS.GradObj=''off''; ', ...
            'ignoring Hessian and gradient functions. Rerun with OPTIONS.Hessian=''on'' ', ...
            'and OPTIONS.GradObj=''on'' to use derivative functions.'])
        calltype = 'fun';
    elseif ~hessflag && gradflag
        warning('optimlib:optimfcnchk:HessianOptionOff', ...
            ['Hessian function provided but OPTIONS.Hessian=''off''; ignoring ', ...
            'Hessian function. Rerun with OPTIONS.Hessian=''on'' to use Hessian function.']);
        calltype = 'fun_then_grad';
    end
...
elseif ~isa(funstr, 'cell')  %Not a cell; is a string expression, function name string or inline object
    ...
    if hessflag && ~gradflag
        warning('optimlib:optimfcnchk:GradientOptionOff', ...
            ['OPTIONS.Hessian=''on'' but OPTIONS.GradObj=''off''; ignoring Hessian ', ...
            'and gradient functions. Rerun with OPTIONS.Hessian=''on'' and ', ...
            'OPTIONS.GradObj=''on'' to use derivative functions.']);
    end

else
    error('optimlib:optimfcnchk:MustBeAFunction', ...
        ['FUN must be a function or an inline object; or, FUN ', ...
        'may be a cell array that contains these type of objects.']);
end
