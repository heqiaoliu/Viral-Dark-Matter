...
%   $Revision: 1.1.6.3 $  $Date: 2010/05/10 17:38:01 $
   ...
   if DerivativeCheck
      ...
      if issparse(JACval)
         ...
         for k = 1:numberOfVariables 
            [columnOfFinDiffJac,~,~,numEvals] = ...
                finitedifferences(xstart,funfcn{3},[],l,u,fval,[],[], ...
                   k,finDiffOpts,sizes,columnOfFinDiffJac,[],[], ...
        ...
        [JACfd,~,~,numEvals] = finitedifferences(xstart,funfcn{3}, ...
            [],l,u,fval,[],[],1:numberOfVariables,finDiffOpts,sizes,JACfd, ...
            [],[],finDiffFlags,[],varargin{:});
        %
