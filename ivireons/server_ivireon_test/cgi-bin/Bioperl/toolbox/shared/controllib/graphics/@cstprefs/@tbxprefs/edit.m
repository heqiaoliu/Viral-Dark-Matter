...
%   $Revision: 1.1.8.2 $  $Date: 2010/04/21 21:45:06 $
...
if isempty(Frame)
   ...
   %---Frame
    Frame = com.mathworks.mwt.MWFrame(ctrlMsgUtils.message('Controllib:gui:strControlToolboxPreferences'));
   ...
   %---Open an empty Frame with some status text
    ...
    centerfig(Frame);
    s.Status = com.mathworks.mwt.MWLabel(...
        ctrlMsgUtils.message('Controllib:gui:strLoadingControlToolboxPreferencesLabel'),...
   ...
   %---ButtonPanel
    ...
    s.ButtonPanel.setInsets(java.awt.Insets(2,5,5,-2));
       ...
       %---Help
        ...
        set(hc,'ActionPerformedCallback',@(es,ed) ctrlguihelp('toolbox_preferences'));
   ...
   %---TabPanel
    ...
    s.TabPanel.setFont(Prefs.JavaFontP);
       %---Units
        ...
        s.TabPanel.addPanel(ctrlMsgUtils.message('Controllib:gui:strUnits'),s.UnitsTab);
       %---Style
        ...
        s.TabPanel.addPanel(ctrlMsgUtils.message('Controllib:gui:strStyle'),s.StyleTab);
       %---Characteristics
        ...
        s.TabPanel.addPanel(ctrlMsgUtils.message('Controllib:gui:strOptions'),s.CharacteristicsTab);
       %---Siso Tool
        s.CompensatorFormat = cfmt_gui(s.NewPrefs);
        s.Bode = bode_gui(s.NewPrefs);
        s.SisoToolTab = localMakeTab(s.CompensatorFormat,s.Bode);
        s.TabPanel.addPanel(ctrlMsgUtils.message('Controllib:gui:strSISOTool'),s.SisoToolTab);
