...
%   $Revision: 1.1.8.2 $  $Date: 2010/04/30 00:39:52 $
...
TextBox.TargetListeners = ...
   [handle.listener(this,findprop(this,'Options'),'PropertyPostSet',{@localReadProp TextBox,this});...
    handle.listener(this.AxesGrid,findprop(this.AxesGrid,'XUnits'),'PropertyPreSet',{@LocalFreqUnitsChanged TextBox,this}); ...
    handle.listener(this.AxesGrid,findprop(this.AxesGrid,'YUnits'),'PropertyPreSet',{@LocalMagPhaseUnitsChanged TextBox,this})];
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
set(hc,'ItemStateChangedCallback',{@localWriteUnwrapProp,TextBox});
...
OldUnits = eventData.AffectedObject.XUnits;
...
OldPhaseUnits = eventData.AffectedObject.YUnits{2};
NewPhaseUnits = eventData.NewValue{2};
...
OldMagUnits = eventData.AffectedObject.YUnits{1};
NewMagUnits = eventData.NewValue{1};

% Update phase for comparison
NewMag = unitconv(this.Options.MinGainLimit.MinGain,OldMagUnits,NewMagUnits);
GUI.MinGainEdit.setText(sprintf('%.3f',NewMag))

% Update Options
this.Options.MinGainLimit.MinGain = NewMag;

%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%
% LocalEnableComparePhase %
%%%%%%%%%%%%%%%%%%%%%%%%%%%
