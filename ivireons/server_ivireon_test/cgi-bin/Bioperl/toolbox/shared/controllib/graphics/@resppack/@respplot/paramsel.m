...
%   $Revision: 1.1.8.1 $  $Date: 2009/10/16 06:23:24 $
...
if isempty(figNumber)
  ...
  helpHndl=uicontrol(figNumber, ...
     ...
     'BackgroundColor',StdColor, ...
     'String',xlate('Selection Criteria'), ...
     'Tag', 'criterionlabel');
  helpHndl=uicontrol(figNumber, ...
     'Style','listbox', ...
     'Units',StdUnit, ...
     ...
     'BackgroundColor',[1 1 1], ...
     'String',{xlate('Index into Dimensions'),xlate('Bound on Characteristics')}, ...
     'Tag', 'criterion',...
     'Value', 1,...
  ...
  txtHndl=uicontrol(figNumber, ...
     ...
     'Tag','status', ...
     'String',xlate('Show selected plots'));
  %------------------------------------
  %=========apply======================
  helpHndl=uicontrol(figNumber, ...
     'Style','pushbutton', ...
...
if flag == 0  %called in init, set up frames
   ...
   mainFrmHndl=uicontrol(figNumber, ...
      ...
      'String', xlate('Selection Criterion Setup'), ...
      'Tag', 'criterionlabel', ...
      'BackgroundColor',StdColor);
   helpHndl=uicontrol(figNumber, ...
      'Style','popupmenu', ...
      ...
      'BackgroundColor',[1 1 1], ...
      'String',{xlate('show all'),xlate('show selected'), xlate('hide selected')}, ...
      'Tag', 'showpopup',...
      'Value', 2,...
      'Callback',{@localShow});
end %flag==0
