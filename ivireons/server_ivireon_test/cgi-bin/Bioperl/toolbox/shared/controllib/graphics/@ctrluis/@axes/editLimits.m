...
%   $Revision: 1.1.8.2 $  $Date: 2010/04/21 21:45:24 $
...
set(hc,'ActionPerformedCallback',@(es,ed) localWriteLims(es,ed,XY,LimBox));
set(hc,'FocusLostCallback',@(es,ed) localWriteLims(es,ed,XY,LimBox));
