...
% SETDATA  method to set data properties of gainphaselocation object
%
 
% Author(s): A. Stothert 23-Aug-2005
%   Copyright 2005-2009 The MathWorks, Inc.
% $Revision: 1.1.8.1 $ $Date: 2009/10/16 06:35:00 $

%Map properties
idx = strcmpi('gainmargin',varargin);
if any(idx), varargin{idx} = 'xdata'; end
idx = strcmpi('phasemargin',varargin);
