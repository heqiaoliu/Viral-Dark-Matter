...
%   $Revision: 1.1.8.1 $  $Date: 2009/10/16 06:32:06 $
...
case 'bd'
    ...
    switch SelectionType
        ...
        case 'normal'
            ...
            iMarkers = EventSrc == hChildren(idx);
            if any(iMarkers)
                % Initialize resize
                setptr(HostFig, 'closedhand');
                LocalResize([], [], Constr, 'init', EventSrc, iMarkers);
...
% LocalResize   %
%%%%%%%%%%%%%%%%%
function LocalResize(eventSrc,eventData,Constr,action,marker,iGainPhase)
...
case 'init'
    ...
    Constr.resize('init',markerend,iGainPhase); %#ok<FNDSB>
