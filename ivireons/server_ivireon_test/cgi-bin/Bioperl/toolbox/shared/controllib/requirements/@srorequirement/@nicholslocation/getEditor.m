...
% $Revision: 1.1.8.1 $ $Date: 2009/10/16 06:35:18 $
...
if size(this.Data.getData('xdata'),1) > 0
    ...
    hEditPanel = editconstr.NicholsLocation(this);
    
    %Check to see if we want to show the editor panel at this time. This
    %is sometimes not true, e.g., when prepopulating the editor dialog with 
