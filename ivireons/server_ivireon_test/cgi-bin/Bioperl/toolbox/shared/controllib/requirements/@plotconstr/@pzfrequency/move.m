...
%   $Revision: 1.1.8.1 $  $Date: 2009/10/16 06:33:24 $
...
case 'update'
   ...
   LocStr = sprintf('%s bound on natural frequency: %0.3g %s.',...
      Type,unitconv(Constr.getData('xCoords'),Constr.getData('xUnits'),Constr.getDisplayUnits('xUnits')),Constr.getDisplayUnits('xUnits'));
   X = sprintf('Move requirement to adjust natural frequency bound and release the mouse.\n%s',LocStr); 
