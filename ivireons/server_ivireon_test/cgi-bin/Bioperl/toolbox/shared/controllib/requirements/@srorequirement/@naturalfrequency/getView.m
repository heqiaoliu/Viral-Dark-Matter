...
%
% Inputs:
%     this       - srorequirement.naturalfrequency object
...
%                  only used for MIMO respplot.plot objects. If omitted the
%                  first output channel is assumed.
%
% Outputs:
...
% $Revision: 1.1.8.1 $ $Date: 2009/10/16 06:35:10 $
...
if nargin < 2
    ...
    hAx = getaxes(tmp,'2d');
    hAx = hAx(1);
    h = plotconstr.pzdamping('Parent',hAx);
else
    ...
    h = plotconstr.pzfrequency('Parent',hAx);    
