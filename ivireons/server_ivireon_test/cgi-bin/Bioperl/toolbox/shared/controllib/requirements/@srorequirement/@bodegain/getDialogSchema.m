...
% GETDIALOGSCHEMA  Method to create DDG schema for bode gain requirement
%
 
% Author(s): A. Stothert 22-Jun-2005
%   Copyright 2005-2009 The MathWorks, Inc.
% $Revision: 1.1.8.1 $ $Date: 2009/10/16 06:34:29 $
...
tblSegments.ColHeader            = {'Start frequency','Start magnitude','End frequency','End magnitude','Slope','Weight'};
...
btnInsert.ObjectMethod = 'insertEdge';      %method on parent DDG
...
btnDelete.ObjectMethod = 'deleteEdge';      %method on parent DDG
