...
% GETDATA  Method to retrieve data from dampingratio object
%
 
% Author(s): A. Stothert 31-May-2005
%   Copyright 2005-2009 The MathWorks, Inc.
% $Revision: 1.1.8.1 $ $Date: 2009/10/16 06:34:37 $

out = [];
varargout = cell(numel(varargin)-1,1);

%Map properties
idxN = find(strcmpi(varargin,'dampingratio'));
%Get natural frequency properties
if any(idxN) 
