...
%   $Revision: 1.1.8.1 $  $Date: 2009/10/16 06:33:07 $
...
case 'init'
   ...
   idx = strcmp(Tags,'ConstraintPatch') | strcmp(Tags, 'ConstraintInfeasibleEdge');
   if any(hChildren(idx)==hittest(HostFig))
      if Constr.Ts
...
case 'update'
   ...
   X = sprintf('Move requirement to adjust damping/overshoot bound and release the mouse.\n%s',LocStr); 
