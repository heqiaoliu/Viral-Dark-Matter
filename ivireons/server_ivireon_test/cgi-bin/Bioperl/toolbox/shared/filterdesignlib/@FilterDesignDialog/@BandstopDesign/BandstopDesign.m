...
%BANDSTOPDESIGN   Construct a BANDSTOPDESIGN object.

%   Author(s): J. Schickler
%   Copyright 2005-2009 The MathWorks, Inc.
%   $Revision: 1.1.6.6 $  $Date: 2009/10/16 06:38:30 $

this = FilterDesignDialog.BandstopDesign;

set(this, 'VariableName', uiservices.getVariableName('Hbs'), varargin{:});
