...
%   $Revision: 1.1.6.1 $  $Date: 2009/10/16 06:39:55 $
...
for i=1:length(index1)
    if ~isnumeric(index1{i}) && (~(ischar(index1{i}) && (strcmp(index1{i}, ':'))))
        if ischar(index1{i})
            ...
            throwAsCaller(MException('instrument:subsref:UndefinedFunction', ['Function ''subsindex'' is not defined for values of class ''' class(index1{i}) '''.']));
        end
    end
end
