...
%   $Revision: 1.1.6.1 $  $Date: 2009/10/16 06:39:03 $
...
if ~isempty(errmsg)
    newExc = MException('instrument:binblockwrite:invalidPRECISION', 'Invalid HEADERFORMAT specified. Type ''instrhelp binblockwrite'' for more information.');
