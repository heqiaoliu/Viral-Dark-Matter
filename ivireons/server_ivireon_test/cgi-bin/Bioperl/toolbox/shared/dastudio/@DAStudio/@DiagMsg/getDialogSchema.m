...
fullPathText.Name = this.SourceFullName;
...
if (this.Contents.HyperSearched == 0)
  this.Contents.Details = this.findhtmllinks(this.Contents.Details);
  this.Contents.HyperSearched = 1;
end


msgBrowser.Text = this.Contents.Details;
...
openButton.Enabled = this.enableOpenButton;
