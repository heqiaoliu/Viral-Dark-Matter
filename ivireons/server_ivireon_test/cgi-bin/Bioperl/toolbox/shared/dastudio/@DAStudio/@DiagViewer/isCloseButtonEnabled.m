function status = isCloseButtonEnabled(h)
%  isCloseButtonEnabled
%
%  Checks whether the Diagnostic Viewer's Close button is enabled.
%
%  Copyright 2008 The MathWorks, Inc.
  ...
  if isa(h.Explorer, 'DAStudio.Explorer')
    ...
    status = imd.isCustomButtonEnabled('DiagMsg_CloseButton');
  else
