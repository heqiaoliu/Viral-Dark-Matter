...
%  $Revision: 1.1.6.3 $ 
 ...
 message.summary = regexprep(message.summary, '</a>', ''); % Hide end tag
 message.summary = regexprep(message.summary, '<a.*?".*?">', ''); % Hide start tag
...
%   $Revision: 1.1.6.3 $  $Date: 2008/01/29 15:36:57 $
