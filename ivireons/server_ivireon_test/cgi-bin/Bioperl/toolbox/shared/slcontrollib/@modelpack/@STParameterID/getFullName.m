...
% GETFULLNAME  method to return Parameter full name. The full name is a
% conctenation of the ParameterID path and Parameter name.
%
 
% Author(s): A. Stothert 21-Jul-2005
% Copyright 2005 The MathWorks, Inc.
% $Revision: 1.1.8.1 $ $Date: 2005/11/15 01:41:00 $
