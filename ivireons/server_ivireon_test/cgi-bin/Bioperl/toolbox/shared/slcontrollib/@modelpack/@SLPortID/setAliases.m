...
% SETALIASES Sets the aliases for the individual elements of the port
% identified by THIS.
%
% A single string can be used to assign the same alias to each element (signal).

% Author(s): Bora Eryilmaz
% Revised:
% Copyright 2000-2006 The MathWorks, Inc.
% $Revision: 1.1.8.4 $ $Date: 2007/11/09 21:01:20 $
