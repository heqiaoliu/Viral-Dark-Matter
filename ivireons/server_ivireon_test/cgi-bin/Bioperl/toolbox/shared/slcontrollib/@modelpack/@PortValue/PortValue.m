function this = PortValue(portID, subsName)
% PORTVALUE Constructor
%
% This constructor takes a port identifier object and an optional subscripted
% name to create a PORTVALUE object.
%
% h = modelpack.PortValue(portID, [subsName]);
%
...
% $Revision: 1.1.8.3 $ $Date: 2006/09/30 00:23:55 $

% Create object
this = modelpack.PortValue;
