function this = ParameterValue(parameterID, subsName)
...
%
% h = modelpack.ParameterValue(parameterID, [subsName]);
%
...
% $Revision: 1.1.8.4 $ $Date: 2007/12/14 15:01:31 $

% Create object
this = modelpack.ParameterValue;
