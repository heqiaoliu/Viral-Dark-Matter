...
% $Revision: 1.1.6.4 $ $Date: 2007/02/06 20:00:30 $
...
% Recursive call to insert child's sub-hierarchy.
...
% Remove all private listeners
removeListeners(this);

% Delegate futher clean up to subclasses.
cleanup(this);
