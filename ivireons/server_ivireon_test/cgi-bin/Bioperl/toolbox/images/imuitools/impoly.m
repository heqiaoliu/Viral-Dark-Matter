...
%   $Revision: 1.1.6.14 $ $Date: 2008/12/22 23:47:27 $
...
function [h_group,draw_api] = impolyAPI(varargin)
  ...
  updateView(getPosition());
    ...
    %------------------------------------------
    function aClickInsert(h_fig,varargin)
    ...
    function cleanUpPolygon(varargin)
        ...
        %management. There is no listener to for key press to enable
        %automatic cleanup on deletion.
        draw_api.pointerManagePolygon(false);
