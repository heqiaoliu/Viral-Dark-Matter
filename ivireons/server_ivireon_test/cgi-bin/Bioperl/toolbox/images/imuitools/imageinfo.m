...
%   $Revision: 1.1.8.17 $  $Date: 2009/02/06 14:20:07 $

% parse inputs
[h,metadata,metadataName] = parseInputs(varargin{:});

% create tool figure
tool_name = 'Image Info';
...
if ishghandle(h_image,'image')
    ...
    iptwindowalign(target_fig,'left',h_fig,'left','nodrawnow');
...
if nargout > 0
    ...
    function createDetailsTable
        ...
        details_label_text = sprintf('Image details %s',target_fig_name);
    ...
    function positionDetailsTable
        ...
        % put label at the top of the figure
        set(details_label,'Position',...
            [1 ...
            fig_height - label_height + 1 ...
            label_width ...
            label_height]);
    ...
    function positionMetadataTable
        ...
        % place label as high as possible
        set(metadata_label,'Position',...
            [1 ...
            upper_bound - label_height + 1 ...
            label_width ...
            label_height]);
...
switch nargin
    case 0
        ...
        if isempty(h)
            eid = sprintf('Images:%s:noImageInFigure',mfilename);
            error(eid,...
                '%s expects a current figure containing an image.', ...
                upper(mfilename));
        end
...
table_height = 1.8 * max_height * font_size;
