...
%   $Revision: 1.1.8.27 $  $Date: 2010/05/13 17:36:46 $
...
hScrollable = get(hPixelRegionAx, 'Parent');
scrollable_listener = iptui.iptaddlistener(hScrollable,'Position',...
...
setappdata(hPixelRegionIm, 'Listeners', [scrollable_listener ...
    cdatamapping_listener colormap_listener clim_listener]);

% clear unused references to listeners
clear scrollable_listener cdatamapping_listener clim_listener;
...
registerModularToolWithManager(sp_h,hImage);
    ...
    function reactRefreshFcn(obj,evt) %#ok<INUSD>
        ...
        tool_listeners.setEnabledProperty(true);
