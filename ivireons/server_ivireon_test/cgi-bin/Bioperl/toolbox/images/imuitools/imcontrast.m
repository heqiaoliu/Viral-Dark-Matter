...
%   $Revision: 1.1.8.32 $  $Date: 2010/02/08 22:35:28 $
...
linkToolName(hFig,hImageFig,'Adjust Contrast');
    ...
    function hStatusLabel = createBottomPanel(parent)
        ...
        if isCallerIMTOOL
            defaultMessage = sprintf('%s\n%s', ...
                'Adjust the histogram above.',...
                'Click ''Adjust Data'' to apply the changes to image data.');
        else
