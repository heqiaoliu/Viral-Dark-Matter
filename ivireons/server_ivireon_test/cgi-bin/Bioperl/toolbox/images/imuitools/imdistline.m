    ...
    methods
        ...
        function setLabelVisible(obj,val)
            ...
            if islogical(val) || isnumeric(val)
                ...
                error('Images:imdistline:setLabelVisible:invalidInput', ...
...
if ~ishghandle(h_parent)
    error('Images:imdistline:invalidHandle', ...
        'HPARENT must be a valid graphics handle.');
end

if (nargin == 2)
    error('Images:imdistline:invalidPosition', ...
        'End point positions must be specified as X and Y position vectors.');
end

if (nargin > 3)
    error('Images:imdistline:invalidSyntax',...
...
if invalid_three_arg_syntax
    error('Images:imdistline:invalidType',...
...
if nargin == 3
    iptcheckinput(varargin{2},{'numeric'},{'vector','real','nonempty','nonnan'},'imdistline','X',2);
    iptcheckinput(varargin{3},{'numeric'},{'vector','real','nonempty','nonnan'},'imdistline','Y',3);
    x_pos = varargin{2};
    y_pos = varargin{3};
else
