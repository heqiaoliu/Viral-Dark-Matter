classdef imcropRect < imrect
    ...
    %   $Revision: 1.1.6.4 $ $Date: 2008/05/14 21:58:30 $
    ...
    methods
        ...
        function setupContextMenu(obj)
            ...
            uimenu(rect_cmenu,'Label','Crop Image','Tag','crop image cmenu item',...
                'Callback', @(varargin) obj.completeCrop());

            % setup 'Delete' context menu item and 'ESC' key callback
            uimenu(rect_cmenu,'Label','Cancel','Tag','cancel cmenu item',...
