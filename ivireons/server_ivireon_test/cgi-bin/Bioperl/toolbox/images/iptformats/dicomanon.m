...
metadata = insertAttr(metadata, '0012', '0062', 'YES', args); 
metadata = insertAttr(metadata, '0012', '0063', getDeidentificationString(args), args);
...
function metadata = insertAttr(metadata, group, element, newValue, args)
