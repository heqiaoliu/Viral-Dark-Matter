...
%   $Revision: 1.1.6.2 $  $Date: 2008/11/24 14:58:53 $
...
if (islogical(X))
    ...
    warning('Images:dicom_encode_pixel_cells:scalingLogicalData','Logical data will be scaled to fit the range [0, 255].');    
