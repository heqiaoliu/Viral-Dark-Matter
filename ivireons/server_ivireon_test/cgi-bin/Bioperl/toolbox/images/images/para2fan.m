...
%   $Revision: 1.1.6.9 $  $Date: 2008/11/24 14:58:12 $
...
iptchecknargin(2,16,nargin,mfilename);

P = varargin{1};
d = varargin{2};

iptcheckinput(P, {'double','single'}, ...
              {'real', '2d', 'nonsparse'}, ...
              mfilename, 'P', 1);
...
if d < maxPloc 
    msg1 = 'Inconsistency detected among the parameters D, PARALLEL_SENSOR_SPACING,';
    msg2 = 'and FAN_SENSOR_GEOMETRY. Check your input parameters.';
    msg3 = sprintf('Try increasing D to be at least %d.',ceil(maxPloc));
