...
%   $Revision: 5.22.4.5 $  $Date: 2009/04/15 23:10:29 $
...
iptcheckinput(b,{'numeric' 'logical'},{'nonsparse'},mfilename,'B',1);
iptcheckinput(block,{'double'},{'integer' 'real' 'positive'},...
    mfilename,'[M N]',2);
iptcheckinput(mat,{'double'},{'integer' 'real' 'positive'},...
    mfilename,'[MM NN]',3);
