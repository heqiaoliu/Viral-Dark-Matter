...
%   logical, uint8 and single to run faster.  Hardware optimization
...
%   $Revision: 1.9.4.8 $  $Date: 2009/08/11 15:40:56 $
...
validateattributes(varargin{1},{'numeric','logical'},{'real','nonsparse'},...
              mfilename, 'MARKER', 1);
validateattributes(varargin{2},{'numeric','logical'},{'real','nonsparse'},...
              mfilename, 'MASK', 2);
