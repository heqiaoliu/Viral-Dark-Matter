...
%
%   J = WIENER2(I,[M N],[MBLOCK NBLOCK],NOISE) or [J,NOISE] = WIENER2(I,[M
%   N],[MBLOCK NBLOCK]) processes the intensity image I as above but in blocks
%   of size MBLOCK-by-NBLOCK.  Use J = WIENER2(I,[M N],SIZE(I),NOISE) to
%   process the matrix all at once.

%   Copyright 1993-2005 The MathWorks, Inc.
%   $Revision: 5.18.4.8 $  $Date: 2006/06/15 20:09:39 $
