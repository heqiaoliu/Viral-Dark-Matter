...
%   $Revision: 5.20.4.8 $  $Date: 2006/10/04 22:38:30 $

iptchecknargin(1,2,nargin,mfilename);
b = varargin{1};

iptcheckinput(b, {'logical' 'numeric'}, {'nonsparse'}, ...
              mfilename, 'BW', 1);
if ~islogical(b)
    b = b ~= 0;
end
...
if nargout == 0 && num_dims > 2
    ...
    error(eid, ...
          'If BW1 is an N-D (N > 2) array, then you must \n%s', ...
          'specify an output argument to BWPERIM.');
end
