...
%   $Revision: 1.1.6.1 $  $Date: 2009/10/16 04:57:26 $
    ...
    methods
        ...
        function obj = ImreadAdapter(input_filename)
            ...
            if ~strcmpi(obj.Info.Format, 'jp2') && ...
                ...
                error('Images:ImreadAdapter:invalidFormat', ...
                    'The ImreadAdapter class expects a valid JPEG2000 or TIFF file extension.');
            end
