...
%  
%   See also STDFILT, ENTROPYFILT, STREL, GETNHOOD. 

%   Copyright 1993-2005 The MathWorks, Inc.
%   $Revision.1 $  $Date: 2006/06/15 20:09:33 $
...
iptcheckinput(varargin{1},{'numeric' 'logical'},...
              {'real','nonsparse','nonnan'}, ...
              mfilename,'I',1);
I = varargin{1};

if nargin == 2
  iptcheckinput(varargin{2},{'logical','numeric'},{'nonempty','nonsparse'}, ...
                mfilename,'NHOOD',2);
  H = varargin{2};
  ...
  if any(floor(sizeH/2) == (sizeH/2) )
    msg = 'NHOOD''s size must be odd in each dimension.';
    error(eid,'%s',msg);
  end
