...
%   $Revision: 1.18.4.8 $  $Date: 2010/05/13 17:36:13 $
...
if nargout==1 && args.pure_translation
    warning('Images:imtransform:warnForPureTranslation',...
            ['You just called IMTRANSFORM with a pure translation. The\n',...
             ...
             '\n\n',...
             'For more information about this topic, see the example\n',...
             '<a href="matlab:helpview(fullfile(docroot,''toolbox'',''images'',''images.map''),''translation_example'')">Performing a Translation</a> ',...
             'in the User''s Guide, especially\n',...
             'the section in Step 5 on "Understanding the Coordinates of the\n',...
             'Transformed Image."\n']);
end
...
if xscale > minscale && yscale > minscale
  ...
  warning('Images:imtransform:warnForAutomaticScaleChange',...
          ['IMTRANSFORM has increased the scale of your output pixels in\n',...
           'X-Y space to keep the dimensions of the output image from\n',...
           'getting too large. This automatic scale change will be removed\n',...
           'in a future release.\n',...
           'To ensure that output pixel scale matches input pixel scale\n',...
           'specify the ''XYScale'' parameter. For example, call\n',...
           'IMTRANSFORM  like this:\n\n',...
