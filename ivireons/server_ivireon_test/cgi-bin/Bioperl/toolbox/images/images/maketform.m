...
%   $Revision: 1.10.4.11 $ $Date: 2009/03/09 19:15:20 $
...
msgstruct = nargchk(1,Inf,nargin,'struct'); %#ok<NCHK>
...
msgstruct = nargchk(1,2,nargin,'struct'); %#ok<NCHK>
if ~isempty(msgstruct)
...
msgstruct = nargchk(5,5,nargin,'struct'); %#ok<NCHK>
if ~isempty(msgstruct)
...
msgstruct = nargchk(2,3,nargin,'struct'); %#ok<NCHK>
if ~isempty(msgstruct)
