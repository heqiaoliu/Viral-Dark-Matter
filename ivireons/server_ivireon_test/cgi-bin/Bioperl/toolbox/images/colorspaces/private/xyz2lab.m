...
%   $Revision: 1.1.6.2 $  $Date: 2009/04/15 23:09:50 $
%   Author:  Scott Gregory, 10/18/02
%   Revised: Toshia McCabe, 12/02/02 

%Check input arguments
iptchecknargin(1,2,nargin,'xyz2lab');
iptcheckinput(xyz,{'double'},{'real','2d','nonsparse','finite'},...
              'xyz2lab','XYZ',1);
if size(xyz,2) ~= 3
...
if nargin < 2
    ...
    iptcheckinput(wp,{'double'},{'real','2d','nonsparse','finite','row',...
