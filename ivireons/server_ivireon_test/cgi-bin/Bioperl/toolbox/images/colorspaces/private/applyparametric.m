...
%   $Revision: 1.1.6.1 $  $Date: 2008/04/03 03:10:15 $
%   Author:  Robert Poe 10/15/05

% Check input arguments
iptchecknargin(4, 4, nargin, 'applyparametric');
iptcheckinput(in, {'double'}, ...
              {'real', 'vector', 'nonsparse', 'nonnegative', 'finite'}, ...
              'applyparametric', 'IN', 1);
iptcheckinput(funtype, {'double'}, {'real', 'scalar', 'nonnegative'}, ...
              'applyparametric', 'FUNTYPE', 2);
iptcheckinput(isfwd, {'logical'}, {'scalar'}, ...
              'applyparametric', 'ISFWD', 3);
iptcheckinput(funparams, {'double'}, {'real', 'vector', 'finite'}, ...
              'applyparametric', 'FUNPARAMS', 4);
          
if isempty(funparams)
    eid = 'Images:applyparametric:invalidInputData';
