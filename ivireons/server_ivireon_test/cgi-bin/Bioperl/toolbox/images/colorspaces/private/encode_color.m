...
%   $Revision: 1.1.6.1 $  $Date: 2008/04/03 03:10:20 $ 
...
warning(wid, ...
    'Encoding for output colorspace will not match that of input data.');
...
cspace = iptcheckstrs(cspace, valid_cspaces, 'encode_color', ...
                   'COLORSPACE', 2);
switch cspace
  case 'lab'
...
encoding = iptcheckstrs(encode_in, valid_encodings, ...
