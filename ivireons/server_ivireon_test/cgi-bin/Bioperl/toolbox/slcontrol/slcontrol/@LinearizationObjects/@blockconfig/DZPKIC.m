function S = DZPKIC(this,blockname,TunableParameters)
% DZPKIC  This is the configuration function for the discrete
% zero pole block with initial states.
%

% Author(s): Erman Korkut 22-Apr-2008
%   Copyright 2005-2008 The MathWorks, Inc.
% $Revision: 1.1.8.1 $ $Date: 2008/10/31 07:34:17 $
...
FilteredTunableParameters(5) = struct('Name','X0',...
