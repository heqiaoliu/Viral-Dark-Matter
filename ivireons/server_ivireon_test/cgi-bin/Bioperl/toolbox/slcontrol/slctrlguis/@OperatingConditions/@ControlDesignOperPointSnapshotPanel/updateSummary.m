...
% $Revision: 1.1.8.2 $ $Date: 2006/12/27 21:31:13 $
...
%% Label
data = {sprintf('<B><FONT FACE=sans-serif SIZE=4 COLOR=#800000>Operating Point Snapshot Summary</FONT></B><BR>')};
data{end+1} = '<BR>';
...
data{end+1} = '<BR>';
data{end+1} = sprintf('&nbsp;-&nbsp; To select a new operating point snapshot click the <B>Import a New Operating Point</B> button below.<BR>');              
