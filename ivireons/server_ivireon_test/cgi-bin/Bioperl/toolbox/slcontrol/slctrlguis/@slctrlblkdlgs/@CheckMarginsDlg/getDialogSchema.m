...
% $Revision: 1.1.8.2 $ $Date: 2010/03/31 18:59:26 $
...
txtDescription.Name = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:txtMarginsDescription');
...
grpDescription.Name = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:grpMarginsDescription');
...
dlgStruct.DialogTag   = 'CheckMarginsDlg';
...
dlgStruct.PreApplyMethod = 'preApplyMarginsCallback';
dlgStruct.PreApplyArgs   = {'%dialog'};
dlgStruct.PreApplyArgsDT = {'handle'};
% Required for dlg->block sync
dlgStruct.PostApplyMethod   =  'postApplyMarginsCallback';
