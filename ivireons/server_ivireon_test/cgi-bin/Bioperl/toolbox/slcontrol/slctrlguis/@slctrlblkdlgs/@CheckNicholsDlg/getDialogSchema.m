...
% $Revision: 1.1.8.2 $ $Date: 2010/03/31 18:59:30 $
...
txtDescription.Name     = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:txtNicholsDescription');
...
grpDescription.Name       = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:grpNicholsDescription');
...
dlgStruct.DialogTag   = 'CheckNicholsDlg';
dlgStruct.HelpMethod  = 'slhelp';
dlgStruct.HelpArgs    = {this.getBlock.Handle};
dlgStruct.Items       = {grpDescription, grpView, tabList};
dlgStruct.LayoutGrid  = [3 1];
dlgStruct.ShowGrid    = false;
% Required for widget->dlg->block sync
dlgStruct.PreApplyMethod = 'preApplyNicholsCallback';
dlgStruct.PreApplyArgs   = {'%dialog'};
dlgStruct.PreApplyArgsDT = {'handle'};
% Required for dlg->block sync
dlgStruct.PostApplyMethod   =  'postApplyNicholsCallback';
