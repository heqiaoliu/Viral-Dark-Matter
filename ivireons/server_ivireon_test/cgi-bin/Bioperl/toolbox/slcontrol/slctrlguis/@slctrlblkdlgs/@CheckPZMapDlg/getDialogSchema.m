...
% $Revision: 1.1.8.2 $ $Date: 2010/03/31 18:59:32 $
...
txtDescription.Name = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:txtPZMapDescription');
...
grpDescription.Name = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:grpPZMapDescription');
...
dlgStruct.DialogTag   = 'CheckPZMapDlg';
...
dlgStruct.PreApplyMethod = 'preApplyPZMapCallback';
dlgStruct.PreApplyArgs   = {'%dialog'};
dlgStruct.PreApplyArgsDT = {'handle'};
% Required for dlg->block sync
dlgStruct.PostApplyMethod   =  'postApplyPZMapCallback';
