...
% $Revision: 1.1.8.3 $ $Date: 2010/04/11 20:41:26 $
...
chkUpper.Name           = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:txtEnableUpperBodeBound');
...
chkLower.Name           = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:txtEnableLowerBodeBound');
