...
% $Revision: 1.1.8.1 $ $Date: 2010/03/26 17:56:25 $

ReqDB = {...
       'UpperGainLimit', sprintf('Upper gain limit'), 'editconstr.BodeGain', 'srorequirement.svdgain' ;...
       'LowerGainLimit', sprintf('Lower gain limit'), 'editconstr.BodeGain', 'srorequirement.svdgain'};
