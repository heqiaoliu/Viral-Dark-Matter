function [status, errmsg] = postApplyLinStepCallback(this,dlg) 
 
% Author(s): A. Stothert 12-Oct-2009
% Copyright 2009-2010 The MathWorks, Inc.
% $Revision: 1.1.8.1 $ $Date: 2010/03/26 17:54:54 $

% POSTAPPLYLINSTEPCALLBACK manage post apply actions for the linear step response
% dialog
%
