...
% $Revision: 1.1.8.2 $ $Date: 2010/03/31 18:59:19 $
...
txtDescription.Name = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:txtBodeDescription');
...
grpDescription.Name = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:grpBodeDescription');
...
dlgStruct.DialogTag   = 'CheckBodeDlg';
...
dlgStruct.PreApplyMethod = 'preApplyBodeCallback';
dlgStruct.PreApplyArgs   = {'%dialog'};
dlgStruct.PreApplyArgsDT = {'handle'};
% Required for dlg->block sync
dlgStruct.PostApplyMethod   =  'postApplyBodeCallback';
