...
% $Revision: 1.1.8.2 $ $Date: 2010/03/31 18:59:22 $
...
txtDescription.Name = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:txtLinStepDescription');
...
grpDescription.Name = ctrlMsgUtils.message('Slcontrol:slctrlblkdlgs:grpLinStepDescription');
...
dlgStruct.DialogTag   = 'CheckLinStepDlg';
...
dlgStruct.PreApplyMethod = 'preApplyLinStepCallback';
dlgStruct.PreApplyArgs   = {'%dialog'};
dlgStruct.PreApplyArgsDT = {'handle'};
% Required for dlg->block sync
dlgStruct.PostApplyMethod   =  'postApplyLinStepCallback';
