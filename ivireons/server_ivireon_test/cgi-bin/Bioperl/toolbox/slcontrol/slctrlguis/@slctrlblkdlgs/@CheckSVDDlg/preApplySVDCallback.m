function [status, errmsg] = preApplySVDCallback(this,dlg) 
 
% Author(s): A. Stothert
% Copyright 2010 The MathWorks, Inc.
% $Revision: 1.1.8.1 $ $Date: 2010/03/26 17:55:49 $

% PREAPPLYSVDCALLBACK manage preapply actions for the Bode dialog
%
