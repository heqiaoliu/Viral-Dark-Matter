...
%   $Revision: 1.41.4.4 $  $Date: 2008/05/31 23:28:52 $ 
...
% to get undo working when going back to the static response.
...
if isa(ca, 'sigresp.analysisaxis'),
    set(ca, 'Title', 'On'); % this fixes tworesps title reappearing.
    set(ca, 'Title', 'Off');
end
