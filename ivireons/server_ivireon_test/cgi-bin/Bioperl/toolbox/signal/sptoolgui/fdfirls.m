...
case 'apply'
    ...
    if ((type==2)|(type==4)) & rem(n,2)
        error(generatemsgid('MustBeEven'),'For highpass and bandstop filters, order must be even.')
    end
...
%     
%     error(generatemsgid('GUIErr'),'For FIRLS, you can''t select "Minimum Order".')
