...
%   $Revision: 1.12.4.5 $  $Date: 2009/10/16 06:42:57 $
...
case 'init'
    ...
    while ~done
        ...
        case 'workspace'           
            ...
            if overwrite
                str2display = sprintf('At least one of the items you are exporting to the workspace already \nexists in the workspace as a variable. By exporting you are replacing any existing variables that have conflicting names. \n\nAre you sure you want to export?');
                switch questdlg(...
                        str2display,...
