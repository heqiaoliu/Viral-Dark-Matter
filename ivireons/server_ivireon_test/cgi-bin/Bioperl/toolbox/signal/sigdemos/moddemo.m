...
%        spectrogram - spectrogram (time AND frequency domain)
%                                                             
...
%   $Revision: 1.12.4.3 $  $Date: 2009/03/09 19:35:14 $
...
if strcmp(action,'initialize'),
    ...
    %slightly inflate the figure size to accommodate labels
...
elseif strcmp(action,'modulate'), % modulate, demodulate, and update display
    ...
    elseif get(dispHndl,'value')==2,   % psd
      h = spectrum.welch('Hann',500,0);   
      Pyy = psd(h,y,'Fs',Fs,'NFFT',1024); 
      Pyy1 = psd(h,y1,'Fs',Fs,'NFFT',1024); 
      Pyy2 = psd(h,y2,'Fs',Fs,'NFFT',1024); 
      f = Pyy.Frequencies;
      Y = 10*log10(Pyy.Data);
      Y1 = 10*log10(Pyy1.Data);
      Y2 = 10*log10(Pyy2.Data);
      ...
      [b,f,t] = spectrogram(y,wind,noverlap,128,Fs);
      [b1,f,t] = spectrogram(y1,wind,noverlap,256,Fs);
      [b2,f,t] = spectrogram(y2,wind,noverlap,128,Fs);
