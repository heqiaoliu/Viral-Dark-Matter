...
%   $Revision: 1.7.4.11 $  $Date: 2009/09/03 05:27:47 $
...
elseif strcmp(action,'axesredraw'), % redraw axes
    ...
    if all(isfinite([ymin ymax]))
        ...
        warning(generatemsgid('BadResponse'),'Response is Inf or NaN');
...
elseif strcmp(action,'getfilt')
    ...
    warning(generatemsgid('InvalidString'),...
        'action string ''%s'' not recognized, no action taken.',action);
