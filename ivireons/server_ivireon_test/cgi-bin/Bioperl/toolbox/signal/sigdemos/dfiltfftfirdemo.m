...
% This demonstrates illustrates the DFILT.FFTFIR filter.
%  
...
% $Revision: 1.1.4.6 $ $Date: 2005/11/18 14:22:41 $
...
x2 = x(501:1000);
y1 = filter(Hd,x1);
Hd.PersistentMemory = true; % Same as set(Hd,'PersistentMemory',true);
