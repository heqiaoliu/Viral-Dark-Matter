...
%   $Revision: 1.1.6.7 $  $Date: 2008/08/22 20:32:12 $
...
%% 
% Like the previous example, the theoretical average power of each complex
% sinusoid is A^2/4.  The signal's DC average power is equal to its peak
% power since it's constant and therefore is given by Ao^2.  Accounting for
% the power in the positive and negative frequencies results in a signal's
% total average power (sum of the average power of each harmonic component)
