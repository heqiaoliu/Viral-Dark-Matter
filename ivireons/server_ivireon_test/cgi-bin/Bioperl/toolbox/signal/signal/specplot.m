...
%   SPECPLOT is obsolete.  SPECPLOT still works but may be removed in the
%   future.  Use DSPDATA objects instead.
%
%   See also DSPDATA/PSD, DSPDATA/PLOT.
...
%   $Revision: 1.6.4.3 $  $Date: 2009/08/11 15:47:55 $

warnStr = ['SPECPLOT is obsolete and will be removed in future versions. ', ...
    'Use DSPDATA objects instead, type "help DSPDATA".'];
