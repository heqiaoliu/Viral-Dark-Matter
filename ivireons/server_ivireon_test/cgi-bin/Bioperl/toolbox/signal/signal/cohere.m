...
%   $Revision: 1.6.4.7 $  $Date: 2008/08/01 12:25:25 $

error(nargchk(2,7,nargin,'struct'))

warning(generatemsgid('COHEREisObsolete'),['COHERE has been replaced by ',...
    'MSCOHERE. COHERE still works but may be removed in the future. ',...
    'Use MSCOHERE instead.']);
