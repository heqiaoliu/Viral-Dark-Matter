...
%   $Revision: 1.1.6.3 $  $Date: 2007/12/14 15:08:05 $
...
if ~(isempty(zi) | any(size(zi.Numerator,2) == [ndata,1])),
	error(generatemsgid('InvalidDimensions'),'The number of channels of the numerator states must equal the number of channels of the input.');
end
