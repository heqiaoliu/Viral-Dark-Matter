...
%   $Revision: 1.1.6.7 $  $Date: 2009/03/30 23:59:51 $
    ...
    elseif strcmpi(class(S), 'filtstates.dfiir'),
        ...
        if lenofs ~= numstates,
            error(generatemsgid('InvalidDimensions'),...
                ['The length of the numerator and denominator states must be a vector \n', ...
            'or matrix with %d rows and one column per channel.'],numstates);
        end
    end
