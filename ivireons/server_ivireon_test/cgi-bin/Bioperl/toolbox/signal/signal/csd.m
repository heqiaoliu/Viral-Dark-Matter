...
%   $Revision: 1.8.4.6 $  $Date: 2008/08/01 12:25:26 $

error(nargchk(2,8,nargin,'struct'))

warning(generatemsgid('CSDisObsolete'),['CSD has been replaced by CPSD. '...
    'CSD still works but may be removed in future. Use CPSD instead']);
