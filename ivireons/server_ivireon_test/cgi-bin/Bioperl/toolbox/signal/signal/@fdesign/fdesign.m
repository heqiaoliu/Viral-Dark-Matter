...
%
%   For more information, see the <a href="matlab:web([matlabroot,'\toolbox\signal\sigdemos\html\fdesigngettingstarteddemo.html'])">Getting Started Demo</a> or enter "doc fdesign" 
...
%   $Revision: 1.1.6.14 $  $Date: 2008/12/04 23:21:07 $

msg = sprintf(['Use FDESIGN.* to create a digital filter designer.\n',...
               'For example,\n   h = fdesign.lowpass\n',...
               'Type <a href="matlab:help fdesign/responses">help fdesign/responses</a> to get a list of valid responses.']);
