...
%   $Revision: 1.1.6.7 $  $Date: 2007/12/14 15:10:06 $
...
if ~any(strcmpi(freqrange,validStrs)),
    errmsg = sprintf('Invalid frequency range string. Valid strings are %s and %s.',validStrs{1},validStrs{2});
    error(generatemsgid('invalidFrequencyRangeStr'),errmsg); %#ok<SPERR>
end
