...
%   $Revision: 1.7.4.6 $  $Date: 2008/08/01 12:25:30 $

error(nargchk(2,7,nargin,'struct'))

warning(generatemsgid('TFEisObsolete'),['TFE has been replaced by ', ...
    'TFESTIMATE. TFE still works but may be removed in the future. ',...
    'Use TFESTIMATE instead.']);
