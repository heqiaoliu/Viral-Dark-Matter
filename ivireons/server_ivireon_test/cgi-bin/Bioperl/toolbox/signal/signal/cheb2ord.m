...
%   order digital Chebyshev Type II filter that loses no more than Rp dB in
%   the passband and has at least Rs dB of attenuation in the stopband. Wp
%   and Ws are the passband and stopband edge frequencies, normalized from
...
%   $Revision: 1.12.4.5 $  $Date: 2007/12/14 15:04:01 $
