...
%   $Revision: 1.1.6.12 $  $Date: 2009/07/14 04:03:19 $
...
if(canOpt)
    ...
    warning(generatemsgid('unoptimizedNegativeOneGain'),...
        ['Cannot optimize for negative 1 gain block at node index ', num2str(curblk.nodeIndex)]);
end
