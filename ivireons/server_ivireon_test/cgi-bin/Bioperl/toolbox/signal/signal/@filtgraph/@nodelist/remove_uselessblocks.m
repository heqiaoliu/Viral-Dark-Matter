...
%whos purpose is purely for the interstage expansion of the dg_dfilt. Once
%finished, it needs to be removed from the nodelist.  The algorithm is
%exactly the same as removing a gain 1 block.
%It also removes the caststage blocks and following scalevalue 1 block in
%df2sos and df1tsos structure.
%   DELNODES is the vector of node indices that are disconnected & unused

%   Author(s): Honglei Chen
%   Copyright 1988-2008 The MathWorks, Inc.
%   $Revision: 1.1.6.8 $  $Date: 2009/06/11 16:08:23 $
