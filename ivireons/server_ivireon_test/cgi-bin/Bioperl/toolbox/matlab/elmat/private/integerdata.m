...
%     $Revision: 1.1.6.1 $  $Date: 2009/04/21 03:23:54 $

if nargin < 3
    error('MATLAB:integerdata:NotEnoughInputs','Not enough input arguments.');
end
outputClass = 'double';
offset = 0;
if ischar(varargin{end})
    if nargin < 4
        error('MATLAB:integerdata:NoJValue','Need a value for J.');
    end
