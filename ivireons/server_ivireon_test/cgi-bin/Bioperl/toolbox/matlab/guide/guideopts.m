...
%   $Revision: 1.1.6.5 $  $Date: 2006/12/20 07:16:48 $
    ...
    switch nargin
        ...
        case 2
            ...
            elseif isequal(varargin{2}, 'edit')
                ...
                error('MATLAB:guideopts:InvalidSecondArgument', 'second input argument must be an options structure or ''edit''');
            end
        otherwise
            error('MATLAB:guideopts:TooManyInputs', 'too many input arguments');
    end
else
    error('MATLAB:guideopts:UnknownInput', 'Unrecognized input to GUIDEOPTS');
end
...
switch r
    ...
    otherwise
        error('MATLAB:guideopts:UnknownResize', 'unknown resize policy: %s',r)
end
