...
%   $Revision: 5.40.4.17.6.2 $  $Date: 2010/06/24 19:34:34 $
...
% When str2rng is removed, its functionality will be moved here
function m=local_str2rng(str)
    state = warning;
    oc = onCleanup(@()warning(state));
    warning('off', 'MATLAB:str2rng:FunctionToBeRemoved');
    m = str2rng(str); %#ok<REMFX1>
