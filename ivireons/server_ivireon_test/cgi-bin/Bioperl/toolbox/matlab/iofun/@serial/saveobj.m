...
%   $Revision: 1.11.4.9 $  $Date: 2009/10/16 05:01:56 $
% 
...
if isa(java(currentObj), 'com.mathworks.toolbox.instrument.device.icdevice.IC.ICDevice')
    settable = localFindSettablePropertiesDevice(currentObj);
elseif isa(java(currentObj), 'com.mathworks.toolbox.instrument.device.icdevice.IC.ICDeviceChild')
