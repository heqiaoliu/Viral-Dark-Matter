...
%
%   STR2RNG will be removed in a future release. 
%
%   See also XLSWRITE, XLSREAD, WK1WRITE, WK1READ.

%   Brian M. Bourgault 10/22/93
%   Copyright 1984-2009 The MathWorks, Inc.
%   $Revision: 5.10.4.5 $  $Date: 2009/12/31 18:51:29 $

warning('MATLAB:str2rng:FunctionToBeRemoved', ...
    'STR2RNG will be removed in a future release.'); 

if ~isstr(str), error('MATLAB:str2rng:RangeMustBeString', 'RNG must be a string.'); end
