...
%   $Revision: 1.6.4.6 $  $Date: 2010/03/08 21:41:10 $
...
if length(varargin)==1
    ...
    elseif ~isa(result, 'java.io.Writer') && ~isa(result, 'java.io.OutputStream')
            error('MATLAB:xmlwrite:IncorrectFilenameType', ...
                'The filename input to XMLWRITE must be a string or a subclass of java.io.Writer or a subclass of java.io.OutputStream.');
    end
