...
%   $Revision: 1.6.4.8 $ $Date: 2010/04/21 21:33:08 $
            ...
            if moresteps >= maxmsteps
                if ~warned
                    warning('MATLAB:minres:tooSmallTolerance', ...
                        ...
                        ' eps*cond(A) and may not be achieved by MINRES\n',...
                        '         Try to use a bigger tolerance'));
                end
                flag = 3;
                iter = ii;
