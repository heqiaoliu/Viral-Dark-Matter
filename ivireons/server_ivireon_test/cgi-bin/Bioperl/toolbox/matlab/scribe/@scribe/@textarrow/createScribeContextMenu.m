...
res = findall(hMenu,'Type','uimenu','Tag','scribe.textarrow.uicontextmenu');
if ~isempty(res)
    res = res(end:-1:1);
    return;
end
...
res(end+1) = graph2dhelper('createScribeUIMenuEntry',hFig,'Color','Text Background Color ...','TextBackgroundColor','Text Background Color');
% Font:
...
set(res,'Tag','scribe.textarrow.uicontextmenu','Visible','off','Parent',hMenu);
