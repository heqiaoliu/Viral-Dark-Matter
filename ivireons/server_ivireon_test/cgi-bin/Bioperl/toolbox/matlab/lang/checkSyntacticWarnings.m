...
%checkSyntacticWarnings Check M-files for compile errors.
%   Check all M-files in the directories specified by the argument list for 
%   all errors which MATLAB generates when reading the M-file into memory. 
...
%   $Revision: 1.1.6.7 $ $Date: 2008/03/17 22:18:00 $

for i=1:nargin,
  if ~ischar(varargin{i}),
    error('MATLAB:checkSyntacticWarnings:InputsMustBeStrings', ...
...
try
    ...
    disp(sprintf('***  %s failed to compile.\n', filename)); 
end
