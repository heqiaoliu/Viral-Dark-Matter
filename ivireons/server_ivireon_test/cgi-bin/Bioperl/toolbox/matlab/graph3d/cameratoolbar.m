...
%   $Revision: 1.26.4.26 $  $Date: 2010/05/20 02:25:46 $


persistent walk_flag

% First argument might be figure handle
% Test hg.figure for HG1, GBT1
% Test matlab.ui.Figure for HG2, GBT2
% Test ui.figure for HG2, GBT1.5
if nargin>0 && isscalar(varargin{1}) && (isa(handle(varargin{1}),'hg.figure') || isa(handle(varargin{1}),'matlab.ui.Figure') || isa(handle(varargin{1}),'ui.figure'))
...
switch arg
    ...
    case 'keymotion'
        ...
        if isstruct(Udata) && isfield(Udata,'figLastPoint')
            ...
            newPoint = Udata.figLastLastPoint + multFact*vargin{2};
            % Make sure the new point is in figure units:
            tempVar = hgconvertunits(hfig,[newPoint 0 0],'pixels',get(hfig,'Units'),0);
    ...
    otherwise
        error('MATLAB:cameratoolbar:unrecognizedinput','Unknown action string.');
end
...
if isempty(h)
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'setmodegui','orbit'},hfig};
    oC = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'setmodegui','orbitscenelight'},hfig};
    oSL = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'setmodegui','pan'},hfig};
    oP = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'setmodegui','dollyhv'},hfig};
    oDH = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'setmodegui','dollyfb'},hfig};
    oDF = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'setmodegui','zoom'},hfig};
    oZ = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'setmodegui','roll'},hfig};
    oR = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'setcoordsys','x'},hfig};
    aX = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'setcoordsys','y'},hfig};
    aY = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'setcoordsys','z'},hfig};
    aZ = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'setcoordsys','none'},hfig};
    aN = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'resetcameraandscenelight'},hfig};
    rCS = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'resettarget'},hfig};
    rT = uimenu(props);
    ...
    props.Callback = {@localUICallback,@cameratoolbar,{'resetscenelight'},hfig};
    rS = uimenu(props);
    ...
    props.Separator = 'off';
    props.Tag = 'CameraReset_targetpoint';
    props.Callback = {@localUICallback,@cameratoolbar,{'setprojection','orthographic'},hfig};
    pO = uimenu(props);
    ...
    props.Separator = 'off';
    props.Tag = 'CameraReset_targetpoint';
    props.Callback = {@localUICallback,@cameratoolbar,{'setprojection','perspective'},hfig};
    pP = uimenu(props);
...
if strcmp(get(haxes,'warptofill'),'off')
    check='off';
    cbk={@localUICallback,@cameratoolbar,{'setaspectratio','normal'},hfig};
else
    check='on';
    cbk={@localUICallback,@cameratoolbar,{'setaspectratio','vis3d'},hfig};
end
