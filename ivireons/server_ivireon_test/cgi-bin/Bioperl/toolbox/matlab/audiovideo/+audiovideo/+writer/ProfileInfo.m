classdef (Hidden) ProfileInfo < dynamicprops
    ...
    %   $Revision: 1.1.6.1.2.1 $  $Date: 2010/06/17 14:12:23 $
    ...
    methods(Hidden=true, Sealed=true)
        ...
        function disp(obj)
            if numel(obj) == 1
                ...
                fprintf('  ProfileInfo Properties:\n');
                ...
                table = DispTable;
                table.Indent = 4;
                table.addColumn(xlate('Name'));
                table.addColumn(xlate('Description'));
                
                fprintf('  Summary of installed VideoWriter profiles:\n\n');
                for ii = 1:length(obj)
                    
                    table.addRow(...
                        DispTable.matlabLink(obj(ii).Name, ...
                        sprintf('%s(%s)', class(obj(ii)),obj(ii).ProfileClass)), ...
                        obj(ii).Description);
                end
