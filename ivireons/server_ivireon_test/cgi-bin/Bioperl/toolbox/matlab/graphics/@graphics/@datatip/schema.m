...
set(p,'FactoryValue',round(get(0,'DefaultTextFontSize')*(4/5)));
if ismac
    set(p,'FactoryValue',round(get(0,'DefaultTextFontSize')*(9/10)));
end
...
p = schema.prop(cls,'Serializable','MATLAB array'); % on/off
p.Visible = 'off';
p.FactoryValue = 'off';
