...
pj.UseOriginalHGPrinting = useOriginalHGPrinting();
if ~pj.UseOriginalHGPrinting 
  pj.PaperType  = get(0, 'DefaultFigurePaperType');
  pj.PaperUnits = get(0, 'DefaultFigurePaperUnits');

  defPaperPos             = get(0, 'DefaultFigurePaperPosition');
  pj.PaperPosition_X      = defPaperPos(1);
  pj.PaperPosition_Y      = defPaperPos(2);
  pj.PaperPosition_Width  = defPaperPos(3);
  pj.PaperPosition_Height = defPaperPos(4);

  defPos             = get(0, 'DefaultFigurePosition');
  pj.Original_Width  = defPos(3);
  pj.Original_Height = defPos(4);
end
