...
%   $Revision: 1.1.6.5 $  $Date: 2010/03/31 18:26:38 $
...
if isequal(warn.state, 'on')
    warning('MATLAB:uitable:DeprecatedFunction', ...
        'This implementation of uitable has been deprecated and is no longer supported.');
end
