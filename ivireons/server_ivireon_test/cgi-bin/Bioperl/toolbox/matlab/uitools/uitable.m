...
%   $Revision: 1.1.8.26 $  $Date: 2009/12/11 20:36:49 $
%   Built-in function.
...
if (usev0dialog(varargin{:}))
    ...
    if (nargout == 2) ||(uitable_parseold(varargin{:}))
        ...
        warning('MATLAB:uitable:OldTableUsage', [...
            'It appears you are using an obsolete version of uitable.\n', ...
            'See the documentation for correct uitable usage:\n', ...
            '  <a href="%s">help uitable</a> and <a href="%s">doc uitable</a>\n\n', ...
            'For more information, click <a href="%s">here</a>\n'], ...
            urlHelpUitable, urlDocUitable, urlCSHelpWindow)
