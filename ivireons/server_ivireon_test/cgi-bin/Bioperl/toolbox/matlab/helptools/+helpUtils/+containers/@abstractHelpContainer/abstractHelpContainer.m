classdef abstractHelpContainer < handle
    ...
    % help container associated with a specific M-file.

    % Copyright 2009 The MathWorks, Inc.

    properties (SetAccess = protected)
        % mFileName - stores package and/or class qualified name of M-file.
        mFileName;
        
        mFilePath; % stores the full path to the source M-file.
        mainHelpContainer; % container stores the main help information.
    end

    properties (Access = private)
        copyrightText = ''; % stores the M-file's copyright text, if any.
    ...
    methods
        ...
        function copyrightText = getCopyrightText(this)
            ...
            if ~this.copyrightExtracted
                fileContents = fileread(this.mFilePath);
