classdef atomicHelpPart < handle
    ...
    methods
        function this = atomicHelpPart(title, helpStr, enumType)
            ...
            otherwise,
                error('MATLAB:helpUtils:atomicHelpPart:InvalidNargin', ...
                    'atomicHelpPart constructor accepts either 0 or 3 input arguments');
            end
        end
        ...
        function replaceText(this, newStr)
            ...
            if ~ischar(newStr)
                error('MATLAB:helpUtils:atomicHelpPart:InvalidInput', ...
