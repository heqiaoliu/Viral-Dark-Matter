...
%   $Revision: 1.7.4.7 $  $Date: 2008/05/23 15:34:35 $
...
ddeitems = {    
    ...
    'ddex3 - DDEs with state-dependent delays'};
ddedemos = daeitems;
...
bvpitems = {
    ...
    'emdenbvp(''bvp5c'') - Emden''s equation solved with BVP5C'
    'fsbvp    - Falkner-Skan BVP on an infinite interval'
    'fsbvp(''bvp5c'') - Falkner-Skan BVP solved with BVP5C'
    'mat4bvp  - Fourth eigenfunction of Mathieu''s equation'
    'mat4bvp(''bvp5c'') - Mathieu''s equation solved with BVP5C'
    'rcbvp - Example that compares BVP4C and BVP5C'
    'shockbvp - Solution has a shock layer near x = 0'
    'shockbvp(''bvp5c'') - Shock layer computed with BVP5C'
    'threebvp - Three-point boundary value problem'
    'threebvp(''bvp5c'') - Three-point BVP solved with BVP5C'
