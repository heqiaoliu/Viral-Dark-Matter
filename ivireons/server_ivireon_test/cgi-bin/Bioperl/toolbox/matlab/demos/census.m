...
% This example is older than MATLAB(R).  It started as an exercise in "Computer
% Methods for Mathematical Computations", by Forsythe, Malcolm and Moler,
% published by Prentice-Hall in 1977.
%
% Now, MATLAB and Handle Graphics(R) make it much easier to vary the parameters and
...
% $Revision: 5.11.4.2 $  $Date: 2007/12/14 14:51:00 $
