...
%   $Revision: 1.1.6.2 $ $Date: 2010/05/13 17:40:33 $

if ischar(dtype)
    switch(lower(dtype))
        case { 'cdf_byte', 'cdf_char', 'cdf_int1', 'cdf_uchar', ...
        ...
        otherwise
            error('MATLAB:cdflib:createVar:unrecognizedDatatypeString', ...
                '%s is not a recognized CDF datatype string.', dtype );
    end
end
