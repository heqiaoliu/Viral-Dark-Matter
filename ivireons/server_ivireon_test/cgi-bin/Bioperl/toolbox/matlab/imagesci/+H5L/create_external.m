...
%       fid1 = H5F.create('myfile1.h5','H5F_ACC_TRUNC',plist_id,plist_id);
%       g1 = H5G.create(fid1,'g1',plist_id,plist_id,plist_id);
%       H5G.close(g1);
%       H5F.close(fid1);
%       fid2 = H5F.create('myfile2.h5','H5F_ACC_TRUNC',plist_id,plist_id);
%       H5L.create_external('myfile1.h5','g1',fid2,'g2',plist_id,plist_id);
%
%   See also H5L.

%   Copyright 2009-2010 The MathWorks, Inc.
%   $Revision: 1.1.6.4 $ $Date: 2010/04/15 15:21:03 $
