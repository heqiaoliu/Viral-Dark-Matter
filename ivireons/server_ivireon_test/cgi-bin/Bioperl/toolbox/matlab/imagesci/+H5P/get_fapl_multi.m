...
%   $Revision: 1.1.8.5 $ $Date: 2010/04/15 15:22:04 $

id = H5ML.unwrap_ids(fapl_id);
[memb_map, memb_fap, memb_name, memb_addr, relax] = H5ML.hdf5lib2('H5Pget_fapl_multi', id);            
for i = 1 : H5ML.get_constant_value('H5FD_MEM_NTYPES')
   memb_fapl(i) = H5ML.id(memb_fap(i),'H5Pclose');
end
