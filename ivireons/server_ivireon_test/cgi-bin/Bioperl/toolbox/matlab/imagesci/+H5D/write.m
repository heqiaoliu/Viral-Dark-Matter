...
%
%   Example:  write to the entire 36-by-19 /g4/world example dataset.
...
%       H5F.close(fid);
%
%   Example:  write a 10-by-5 block of data to the location starting at
%   row index 15 and column index 5 of the same dataset.  Recall that
...
%   $Revision: 1.1.8.8.2.1 $ $Date: 2010/06/21 18:00:09 $
