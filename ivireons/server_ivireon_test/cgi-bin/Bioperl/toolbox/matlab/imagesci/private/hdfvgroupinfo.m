...
%   $Revision: 1.1.6.5.2.1 $  $Date: 2010/07/06 14:40:35 $
...
if vgID == -1
  warning('MATLAB:hdfvgroupinfo:vgroupAttach', msg);
  return;
end
...
for i=1:length(childTags)
    switch childTags(i)
        ...
        case {hdfml('tagnum','DFTAG_VS'),hdfml('tagnum','DFTAG_VH')}
            vdata = [vdata hdfvdatainfo(filename,fileID,anID,childRefs(i))]; %#ok<AGROW>
