...
%  $Revision: 1.1.6.7 $  $Date: 2009/04/15 23:19:43 $
      ...
      switch param
         ...
         case 'type'
            ...
            if ~ismember(type, {'standard', 'rgb', 'rle'})
               error('MATLAB:writeras:invalidRasType', ...
...
%                           ' not "%s".'], class(data)));
   ...
   %
      ...
      switch class(data)
         ...
         case 'uint8'
            % Nothing to do.
         case 'uint16'
            warning('MATLAB:writeras:reducedTo8Bits', ...
                    ['RAS images does not allow 16 bits pr' ...
                      ' component.  Reducing to 8 bits pr component.']);
   ...
   if fid < 0
      error('MATLAB:writeras:fileOpen', ...
            '%s: can''t open file for writing.',filename);
   end
