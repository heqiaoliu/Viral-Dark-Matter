...
%   $Revision: 1.1.6.7 $  $Date: 2009/07/06 20:38:07 $
    ...
    c = sz(2);
    if r~=1
        error('MATLAB:hdftool:createEntryFieldGroup:tooManyRows', ...
              'Creating entryFieldPanels with more than one row is not implemented.');
    end
