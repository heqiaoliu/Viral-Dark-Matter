...
%       Retrieves the interlace format before reading the next raster
...
%
%   See also HDF, HDFAN, HDFDFR8, HDFH, HDFHD, 
%            HDFHE, HDFHX, HDFML, HDFSD, HDFV, HDFVF, HDFVH, HDFVS

%   Copyright 1984-2010 The MathWorks, Inc.
%   $Revision: 1.1.6.8.2.1 $  $Date: 2010/06/24 19:34:14 $
