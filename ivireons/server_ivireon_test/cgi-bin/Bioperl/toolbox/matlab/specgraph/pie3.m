function hh = pie3(varargin)
    ...
    %   $Revision: 1.19.4.8 $  $Date: 2009/08/14 04:01:33 $
    ...
    if nargs==0, error(id('NotEnoughInputs'),'Not enough input arguments.'); end
    ...
    elseif nargs==3 && iscell(args{2}),
        ...
        error(id('TooManyArguments'),'Too many arguments or invalid string cell array.');
    end
