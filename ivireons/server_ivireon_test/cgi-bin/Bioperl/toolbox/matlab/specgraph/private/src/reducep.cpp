		 ...
		 )
{
    ...
    if (nrhs != 4) 
      mexErrMsgIdAndTxt("MATLAB:reducep:WrongNumberOfInputs",
                        "reducep requires 4 input arguments. [v f] = reducep(v, f, targetFaces, verbose)");
    else if (nlhs != 2) 
      mexErrMsgIdAndTxt("MATLAB:reducep:WrongNumberOfOutputs",
    ...
    if (ndims != 2) 
      mexErrMsgIdAndTxt("MATLAB:reducep:WrongNumberOfDimensions",
                        "reducep requires 2 dimensional data");
