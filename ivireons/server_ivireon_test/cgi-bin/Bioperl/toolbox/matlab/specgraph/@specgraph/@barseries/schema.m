...
schema.event(hClass,'BarColorChanged');
...
hProp.FactoryValue = {'EdgeColor','BarLayout','BarWidth',...
		    'LineWidth','LineStyle','BaseValue',...
                    'ShowBaseLine','DisplayName','Visible',...
                    'FaceColor','YDataSource','XDataSource'};
hProp.Visible = 'off';
...
hProp = schema.prop(hClass, 'StemDestroyedListener', 'handle');
hProp.Visible = 'off';
hProp.AccessFlags.Serialize = 'off';
hProp.AccessFlags.PublicSet = 'off';
hProp.AccessFlags.PublicGet = 'off';

hProp = schema.prop(hClass, 'barcolorlistener', 'handle vector');
hProp.Visible = 'off';
hProp.AccessFlags.Serialize = 'off';
hProp.AccessFlags.PublicSet = 'off';
hProp.AccessFlags.PublicGet = 'off';

hProp = schema.prop(hClass, 'SiblingUpdateFcn', 'MATLAB callback');
hProp.FactoryValue = @LdoUpdateSiblingAction;
hProp.Visible = 'off';
hProp.AccessFlags.PublicSet = 'off';
hProp.AccessFlags.PublicGet = 'off';
hProp.AccessFlags.Serialize = 'off';
...
function LdoUpdateBaselineAction(hSrc,eventData) %#ok
h = eventData.affectedObject;
if h.initialized
