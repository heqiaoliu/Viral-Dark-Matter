...
%   $Revision: 1.9.4.1 $  $Date: 2005/04/28 19:57:04 $
...
[msg x y] = xyuvcheck(x,y,u,v);  error(msg) %#ok

if ~isequal(size(sx), size(sy)) 
  error(id('StartSizeMismatch'),'STARTX,STARTY must all be the same size.');
end
