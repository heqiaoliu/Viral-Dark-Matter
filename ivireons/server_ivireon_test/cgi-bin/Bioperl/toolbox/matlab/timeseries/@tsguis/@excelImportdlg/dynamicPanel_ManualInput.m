...
%  $Revision: 1.1.6.9 $ $Date: 2006/12/20 07:18:51 $
...
uimenu(huicTXTuseUnitFormat,'Label','What''s This','Callback','tsDispatchHelp(''time_units_select'',''modal'')')
...
if get(h.Handles.COMBuseFormat,'Value')==1
    ...
    uimenu(huicTXTuseUnitFormat,'Label','What''s This','Callback','tsDispatchHelp(''time_display_format'',''modal'')')
