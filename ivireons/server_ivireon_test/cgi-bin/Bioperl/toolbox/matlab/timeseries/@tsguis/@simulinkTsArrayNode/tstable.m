...
%   $Revision: 1.1.6.4 $ $Date: 2008/12/29 02:11:24 $
...
%% Now create and render the table
...
[simTables, h.Handles.PNLModelTables] = javacomponent(h.Handles.SimTable,[0 0 1 1],...
    ancestor(h.Handles.utabRegular,'figure'));
%set(h.Handles.PNLModelTables,'parent',h.Handles.PNLTsOuter);
set(h.Handles.PNLModelTables,'Units','Characters','Parent',h.Handles.utabRegular);
