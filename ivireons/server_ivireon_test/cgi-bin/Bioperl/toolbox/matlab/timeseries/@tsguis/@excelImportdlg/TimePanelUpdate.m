...
%  $Revision: 1.1.6.4 $ $Date: 2005/07/14 15:24:19 $

if strcmp(option,'column')
    % populate the index combo
    huicTXTtimeIndex = uicontextmenu('Parent',h.Figure);
    uimenu(huicTXTtimeIndex,'Label','What''s This','Callback','tsDispatchHelp(''its_wiz_time_column_xls'',''modal'')')
    ...
    huicTXTtimeIndex = uicontextmenu('Parent',h.Figure);
    uimenu(huicTXTtimeIndex,'Label','What''s This','Callback','tsDispatchHelp(''its_wiz_time_row_xls'',''modal'')')
