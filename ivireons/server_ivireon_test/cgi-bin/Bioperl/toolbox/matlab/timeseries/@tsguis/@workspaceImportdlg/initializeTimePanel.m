...
%  $Revision: 1.1.6.7 $ $Date: 2008/12/29 02:12:06 $
...
uimenu(huicTXTtimeSheet,'Label','What''s This','Callback','tsDispatchHelp(''its_wiz_time_src_for_mat'',''modal'')')

h.Handles.COMBtimeSource = uicontrol('Parent',h.Handles.PNLtime,...
    'style','popupmenu',...
    'Units', 'Pixels',...
    'String',[{xlate('current variable')},{xlate('define it now')},{xlate('another variable')}], ...
    'Value',2,...
    'TooltipString',xlate('The time vector can be obtained from different sources.  Use this drop-down list the select the type of source and configure the source below'),...
