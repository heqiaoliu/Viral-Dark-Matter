function this = stateflowDataLogsNode(varargin)
% stateflowDataLogsNode (for Simulink.StateflowDataLogs objects) constructor
%
...
%   $Revision: 1.1.6.5 $ $Date: 2008/08/20 23:00:05 $

this = tsguis.stateflowDataLogsNode;
...
elseif nargin == 2
  ...
  error('stateflowDataLogsNode:stateflowDataLogsNode:noNode',...
