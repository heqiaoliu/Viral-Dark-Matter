function this = scopeDataLogsNode(varargin)
% scopeDataLogsNode (for Simulink.ScopeDataLogs objects) constructor
%
% VARARGIN{1}: Node name
% VARARGIN{2}: Parent handle used for creating a unique node name

%   Copyright 2005-2008 The MathWorks, Inc.
%   $Revision: 1.1.6.5 $ $Date: 2008/08/20 22:59:57 $
%

% Create class instance
this = tsguis.scopeDataLogsNode;
...
elseif nargin == 2
  ...
  error('scopeDataLogsNode:scopeDataLogsNode:noNode',...
