...
if numel(this)~=1
    error('timeseries:gettsbetweenevents:noarray',...
        'The gettsbetweenevents method can only be used for a single timeseries object');
end
if nargin == 3
...
elseif nargin == 5 && ischar(event1) && ischar(event2)
    ...
    error('timeseries:gettsbetweenevents:invArgNum',...
