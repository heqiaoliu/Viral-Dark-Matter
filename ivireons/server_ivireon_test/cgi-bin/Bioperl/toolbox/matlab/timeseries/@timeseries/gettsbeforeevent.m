...
if numel(this)~=1
    error('timeseries:gettsbeforeevent:noarray',...
        'The gettsbeforeevent method can only be used for a single timeseries object');
end
if nargin == 2
...
elseif nargin == 3 && ischar(event)
    ...
    error('timeseries:gettsbeforeevent:invArgNum',...
