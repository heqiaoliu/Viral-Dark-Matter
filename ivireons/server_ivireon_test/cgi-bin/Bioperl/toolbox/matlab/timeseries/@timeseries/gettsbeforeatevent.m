...
if numel(this)~=1
    error('timeseries:gettsbeforeatevent:noarray',...
        'The gettsbeforeatevent method can only be used for a single timeseries object');
end
if nargin == 2
...
elseif nargin == 3 && ischar(event)
    ...
    error('timeseries:gettsbeforeatevent:invArgNum',...
