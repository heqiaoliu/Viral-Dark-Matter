...
%   $Revision: 1.25.4.12 $  $Date: 2008/01/10 21:10:44 $
...
if nonNegative  
  if Mtype == 0
    ...
    nl = '\n         ';
    warning('MATLAB:ode23tb:NonNegativeIgnoredForLinearlyImplicitSystems',...
            ['For linearly implicit systems, ODE23TB does not constrain the solution.' ...
