...
%   $Revision: 1.30.4.17 $  $Date: 2009/04/21 03:24:13 $
...
if nonNegative  
  if Mtype == 0
    ...
    nl = '\n         ';
    warning('MATLAB:ode23t:NonNegativeIgnoredForLinearlyImplicitSystems',...
            ['For linearly implicit systems, ODE23T does not constrain the solution.' ...
