...
%   $Revision: 1.18.4.22 $  $Date: 2010/02/25 08:09:13 $
...
if length(varargin{1}(:))==2 && ...
        ...
        any(findall(varargin{1}(2),'tag','PlotyyDeleteProxy')) %#ok<VCAT>
...
if ~caxspecified
    ...
    try
        ...
        try
            ...
            warning('MATLAB:plotyy:InvalidAxesHandleSyntax', ...
                ['Function ''%s'' might not allow the common syntax ' ...
                'for parent\n         axes specification.  The axes ' ...
                'handle either must be the first\n         input argument, ' ...
                'or must be specified as a property/value pair.\n         ' ...
