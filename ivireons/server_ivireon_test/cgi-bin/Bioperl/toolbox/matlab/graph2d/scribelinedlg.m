...
%   $Revision: 1.21.4.4 $  $Date: 2009/06/22 14:31:51 $
...
case 1
   arg1 = varargin{1};
   if isempty(arg1) || ishghandle(arg1(1)) || isa(arg1(1),'scribehandle')
...
errordlg(sprintf('%s field requires a single positive numeric input',fieldName),...
           'Error',...
           'modal');
