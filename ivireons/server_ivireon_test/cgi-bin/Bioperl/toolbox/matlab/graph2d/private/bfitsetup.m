...
%   $Revision: 1.19.4.10 $  $Date: 2009/05/18 20:48:29 $
...
setappdata(double(datahandle),'Basic_Fit_Fits_Axes_Handle', axesH); 
setappdata(double(datahandle),'Basic_Fit_Fits_Axes_Position',get(axesH,'position'));
