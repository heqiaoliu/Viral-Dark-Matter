...
%   $Revision: 1.1.6.8 $  $Date: 2010/05/20 03:29:20 $
...
h = cv('new','formatter', '.keyNum', ...
  ...
  h = cv('new','formatter', '.keyNum', ...
		'MSG_SL_TESTOBJECTIVE_SCAL', ...
        '.abbreviation',        'TO', ...
        '.summary.formatStr',   '%s', ...
        '.detail.formatStr',    '%s' ...
        );
  h = cv('new','formatter', '.keyNum', ...
		'MSG_SL_TESTOBJECTIVE_VECT', ...
        '.abbreviation',        'U[%d]', ...
        '.summary.formatStr',   'U[%d]', ...
...
h = cv('new','formatter', '.keyNum', ...
        ...
        '.detail.formatStr',    'trigger(%d) edge occurred' ...
        );
...
h = cv('new','formatter', '.keyNum', ...
        ...
        '.abbreviation',        'Case i', ...
        '.summary.formatStr',   'Case %s (out = in%d)', ...
        '.detail.formatStr',    '= %s (output is from input port %d)' ...
        );
...
h = cv('new','formatter', '.keyNum', ...
        ...
        '.abbreviation',        'Case i', ...
        '.summary.formatStr',   'Case %s (out = in[%d])', ...
        '.detail.formatStr',    '= %s (output is from input(%d))' ...
        );
