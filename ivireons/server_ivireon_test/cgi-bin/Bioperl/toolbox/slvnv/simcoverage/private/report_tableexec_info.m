function cvstruct = report_tableexec_info(cvstruct,tables, options)
...
% Copyright 2003-2008 The MathWorks, Inc.
    ...
    for i=1:tableCnt
        ...
        for testIdx = 1:coumnCnt
            [notUsed,execCnt,brkEq] = tableinfo(gtableExec.dataObjs{testIdx}, cv('get', cv('get',tableId,'.slsfobj'), '.handle'));
