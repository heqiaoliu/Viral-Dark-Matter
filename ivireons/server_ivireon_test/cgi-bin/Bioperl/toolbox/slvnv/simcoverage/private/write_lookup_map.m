...
%   $Revision: 1.1.6.3 $  $Date: 2007/12/10 23:00:23 $
...
otherwise,
    error('SLVNV:simcoverage:write_lookup_map:Only1DAnd2D','Table map generation currently only supports 1D and 2D tables');
