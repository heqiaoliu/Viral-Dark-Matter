...
%   $Revision: 1.1.6.3 $  $Date: 2007/12/10 23:00:00 $


switch(nargin),
case 1
	error('SLVNV:simcoverage:cv_create_hierarchy:InvalidArgumentNumber','cv_create_hierarchy needs at least 2 arguments');
...
case 2
    ...
    if firstChild~=0, 
        error('SLVNV:simcoverage:cv_create_hierarchy:NonemptyModelTree','The model tree should be empty before building hierarchy');
    end
