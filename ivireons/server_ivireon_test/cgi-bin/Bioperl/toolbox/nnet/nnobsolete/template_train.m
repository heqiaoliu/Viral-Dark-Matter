...
if (doValidation)
  VV.net = net;
  vperf = nnsim.perf(net,X,VV.Pd,VV.Tl,VV.Ai,VV.Q,VV.TS);
  VV.perf = vperf;
  VV.numFail = 0;
end
...
for epoch=0:epochs
  ...
  % Performance
  [Ac,N,Zl,Zi,Zb] = nnsim.a(net,Pd,Ai,Q,TS);
  ...
  if (doTest)
    tr.tperf(epochPlus1) = nnsim.perf(net,X,TV.Pd,TV.Tl,TV.Ai,TV.Q,TV.TS);
  end
  ...
  if (needGradient)
    ...
    [gB,gIW,gLW,gA] = nnprop.grad(net,Q,Pd,Zb,Zi,Zl,N,Ac,gE,TS);
  end
