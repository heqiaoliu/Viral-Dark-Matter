function out1 = purelin(varargin)
...
%
% <a href="matlab:doc purelin">purelin</a>('da_dn',N,A) returns the derivative of layer outputs A with
% respect to net inputs N. derivatives for this function are always one.
%
...
% $Revision: 1.1.6.4.2.1 $  $Date: 2010/07/14 23:40:44 $
...
function name = function_name, name = 'Linear'; end
function range = output_range, range = [-inf inf]; end
