...
% negative.
%
% <a href="matlab:doc poslin">poslin</a>('da_dn',N,A) returns the derivative of layer outputs A with
...
function name = function_name, name = 'Linear Positive'; end
function range = output_range, range = [0 inf]; end
function range = active_input_range, range = [0 inf]; end
