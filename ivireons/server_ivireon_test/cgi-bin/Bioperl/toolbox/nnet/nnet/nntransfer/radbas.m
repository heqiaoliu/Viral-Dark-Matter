...
%
% <a href="matlab:doc radbas">radbas</a>('da_dn',N,A) returns the derivative of layer outputs A with
...
% $Revision: 1.1.6.4.2.1 $  $Date: 2010/07/14 23:40:45 $
...
function name = function_name, name = 'Radial Basis'; end
