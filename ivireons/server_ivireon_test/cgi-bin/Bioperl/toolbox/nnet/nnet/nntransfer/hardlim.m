function out1 = hardlim(varargin)
...
% and 0 elsewhere.
%
% <a href="matlab:doc hardlim">hardlim</a>('da_dn',N,A) returns the derivative of layer outputs A with
...
% $Revision: 1.1.6.5.2.1 $  $Date: 2010/07/14 23:40:39 $
...
function name = function_name, name = 'Hard Limit Positive'; end
