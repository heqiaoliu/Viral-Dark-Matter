function out1 = hardlims(varargin)
...
% and -1 elsewhere.
%
% <a href="matlab:doc hardlims">hardlims</a>('da_dn',N,A) returns the derivative of layer outputs A with
...
% $Revision: 1.1.6.5.2.1 $  $Date: 2010/07/14 23:40:40 $
...
function name = function_name, name = 'Hard Limit Symmetric'; end
function range = output_range, range = [-1 1]; end
function range = active_input_range, range = [0 0]; end
