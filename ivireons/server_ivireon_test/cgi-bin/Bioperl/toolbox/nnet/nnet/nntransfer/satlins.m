function out1 = satlins(varargin)
...
%
% <a href="matlab:doc satlins">satlins</a>('da_dn',N,A) returns the derivative of layer outputs A with
...
% $Revision: 1.1.6.5.2.1 $  $Date: 2010/07/14 23:40:48 $
...
function name = function_name, name = 'Linear Saturating Symmetric'; end
