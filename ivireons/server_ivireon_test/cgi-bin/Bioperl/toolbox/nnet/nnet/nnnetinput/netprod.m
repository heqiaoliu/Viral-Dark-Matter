...
%
% <a href="matlab:doc netprod">netprod</a>('dn_dzj',j,{Z1,...Zn}) returns the derivative of net input
% with respect to the jth weighted input Zj.
%
%   dz1 = <a href="matlab:doc netprod">netprod</a>('dn_dzj',1,{z1,z2},n)
%
...
function name = function_name, name = 'Product'; end
