  ...
  methods
    ...
    function [s,err] = parameterStructure(x,values)
      if length(values) > x.numParameters
        nnerr.throw('NNET:Arguments','Too many parameter arguments.');
      end
