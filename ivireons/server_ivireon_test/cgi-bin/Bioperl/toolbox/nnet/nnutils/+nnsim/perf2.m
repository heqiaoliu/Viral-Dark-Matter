function [perf,Y,Ac,N,BZ,IWZ,LWZ]=perf2(net,P,PD,T,Ai,EW,Q,TS,fcns)
%PERF2 Calculate network outputs, signals, and performance.

% Mark Beale, 11-31-97
% Mark Beale, Updated help, 5-25-98
% Orlando De Jesús, Martin Hagan, Updated for parameters 7-20-05
% Copyright 1992-2010 The MathWorks, Inc.
% $Revision: 1.1.8.1.2.1 $ $Date: 2010/07/14 23:42:38 $
...
for ts=1:TS
  for i=net.hint.simLayerOrder
    ...
    for j=inputInds
      pd = nnsim.delayed_inputs(net,P,PD,i,j,ts);
...
% Process Outputs
% ===============
Yp = Ac(net.hint.outputInd,(numLayerDelays+1):end);
Y = nnproc.post_outputs(fcns,Yp);
