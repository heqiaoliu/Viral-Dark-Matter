%Mu Decrease Ratio (mu_dec) function parameter
%
%  <a href="matlab:doc nnparam.mu_dec">mu_dec</a> is a <a href="matlab:doc nntrain">training function</a> parameter.
%  It must be a strictly positive scalar.
%
%  <a href="matlab:doc nnparam.mu_dec">mu_dec</a> is the amount to decrease mu after an unsuccessful step
%  in training with the Levenberg- Marquardt training function.
%
