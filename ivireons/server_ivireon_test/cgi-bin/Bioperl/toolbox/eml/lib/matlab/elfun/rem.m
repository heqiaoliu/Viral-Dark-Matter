...
eml_assert(isa(x,'numeric') || ischar(x), ['Function ''rem'' is not defined for values of class ''' class(x) '''.']);
eml_assert(isa(y,'numeric') || ischar(y), ['Function ''rem'' is not defined for values of class ''' class(y) '''.']);
