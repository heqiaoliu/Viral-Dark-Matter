function c = gt(a0,b0)
% Embedded MATLAB function the @fi/gt (>) operation

% $INCLUDE(DOC) toolbox/eml/lib/fixedpoint/@embedded/@fi/gt.m $
% Copyright 2002-2009 The MathWorks, Inc.
%#eml
% $Revision: 1.1.6.9 $  $Date: 2010/01/25 21:35:44 $
...
if ( (isfi(a0) && (isfixed(a0)) ) || ...
     (isfi(b0) && isfixed(b0)) )
    % One of the inputs (or both) are FI objects with Fixed datatype
...
elseif ( isfi(a0) && isfloat(a0) ) || ...
    ...
    eml_fi_assert_dataTypeNotSupported('GT','fixed-point,double, or single');
end
