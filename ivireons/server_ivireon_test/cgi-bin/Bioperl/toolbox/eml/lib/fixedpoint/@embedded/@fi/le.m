function c = le(a0,b0)
% Embedded MATLAB function the @fi/le (<=) operation

% $INCLUDE(DOC) toolbox/eml/lib/fixedpoint/@embedded/@fi/le.m $
% Copyright 2002-2009 The MathWorks, Inc.
%#eml
% $Revision: 1.1.6.8 $  $Date: 2010/01/25 21:35:45 $
...
elseif ( isfi(a0) && isfloat(a0) ) || ...
    ...
    eml_fi_assert_dataTypeNotSupported('LE','fixed-point,double, or single');
end
