function c = eq(a0,b0)
% Embedded MATLAB function the @fi/eq (==) operation
%
% Limitations:
% 1) Does not support fixed-point numbers with unequal bias.

% $INCLUDE(DOC) toolbox/eml/lib/fixedpoint/@embedded/@fi/eq.m $
% Copyright 2002-2009 The MathWorks, Inc.
%#eml
% $Revision: 1.1.6.8 $  $Date: 2010/01/25 21:35:41 $
...
if ( (isfi(a0) && isfixed(a0)) || ...
        (isfi(b0) && isfixed(b0)) )
    % One of the inputs (or both) are FI objects with either Fixed datatype
...
elseif ( isfi(a0) && isfloat(a0) ) || ...
    ...
    eml_fi_assert_dataTypeNotSupported('EQ','fixed-point,double, or single');
end
