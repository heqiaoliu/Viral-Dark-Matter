function c = ne(a0,b0)
% Embedded MATLAB function the @fi/ne (~=) operation

% $INCLUDE(DOC) toolbox/eml/lib/fixedpoint/@embedded/@fi/ne.m $
% Copyright 2002-2009 The MathWorks, Inc.
%#eml
% $Revision: 1.1.6.8 $  $Date: 2010/01/25 21:35:48 $
...
if ( (isfi(a0) && isfixed(a0)) || ...
     (isfi(b0) && isfixed(b0)) )
    % One of the inputs (or both) is FI objects with Fixed datatype
...
elseif ( isfi(a0) && isfloat(a0) ) || ...
    ...
    eml_fi_assert_dataTypeNotSupported('NE','fixed-point,double, or single');
