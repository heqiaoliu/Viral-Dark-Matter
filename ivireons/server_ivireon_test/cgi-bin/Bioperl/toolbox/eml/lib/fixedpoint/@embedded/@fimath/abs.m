...
%ABS    Overloaded abs for fimath that passes on to floating point abs
...
eml_assert(((nargin ~= 3)||(isnumerictype(var2))),'This syntax is not supported by the abs function.');
