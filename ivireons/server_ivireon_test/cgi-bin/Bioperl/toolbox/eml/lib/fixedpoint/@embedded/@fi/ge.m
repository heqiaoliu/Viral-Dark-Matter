function c = ge(a0,b0)
% Embedded MATLAB function the @fi/ge (>=) operation

% $INCLUDE(DOC) toolbox/eml/lib/fixedpoint/@embedded/@fi/ge.m $
% Copyright 2002-2009 The MathWorks, Inc.
%#eml
% $Revision: 1.1.6.8 $  $Date: 2010/01/25 21:35:43 $
...
elseif ( isfi(a0) && isfloat(a0) ) || ...
    ...
    eml_fi_assert_dataTypeNotSupported('GE','fixed-point,double, or single');
end
