...
%   $Revision: 1.3.2.3 $  $Date: 2008/12/01 08:07:06 $
%
	...
	case 0, 
		error('Stateflow:UnexpectedError','could not default sf editor to add menu');
	case 1, 
	otherwise, 
		warning('Stateflow:UnexpectedError','more than one default editor found!');
