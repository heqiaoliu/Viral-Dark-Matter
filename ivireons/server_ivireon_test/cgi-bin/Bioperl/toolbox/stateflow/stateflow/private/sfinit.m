...
if nargin==0
    ...
    try
        ...
        %disp(ME.getReport());
	disp('Stateflow initialization failed. Most likely cause is a bad build.');
    end

    sf('new', 'machine', '.name', '$$Clipboard$$');
    sf('feature', 'SLSFUnifiedCopyBuffer', sfpref('SLSFUnifiedCopyBuffer'));
...
sf('flag'...
    ...
    ,'machine.diagSettings:all','nosave/show/write' ...
    );
...
sf('flag'...
    ...
    ,'chart.codeGeneratedNow','show/write'...
    ,'chart.isInstantiated','show'...
    ,'chart.cgStats','show/write'...
    ...
    ,'chart.enableNonTerminalStates','save/show/write'...
    ,'chart.nonTerminalMaxCounts','save/show/write'...
    ,'chart.nonTerminalUnstableBehavior','save/show/write'...
    ,'chart.initializeOutput','save/show/write'...
    ,'chart.userSpecifiedStateTransitionExecutionOrder','save/show/write'...
    ,'chart.dontShowTransitionExecutionOrder','save/show/write'...
    );
    % break it up into two calls so that we dont run afoul of 
    % MAX_NUMBER_OF_PROP_VALUE_PAIRS =80 assertion
sf('flag'...
    ,'chart.stateMachineType','save/show/write'...
    ...
    ,'chart.eml.noDebugging','save/show/write'...
    ,'chart.plantModelingInfo.derivativesFormatString','save/show/write'...
    ,'chart.enableZeroCrossings','save/show/write'...
    ,'chart.altStyle','write'...
    ,'chart.ssIdHighWaterMark','save/write'...
    ,'chart.hdlInfo.HDLTraceability','write'...
    ,'chart.hdlInfo.rtwSubsystemId','write'...
    ,'chart.hdlInfo.emitRequirementComments','write'...
    ,'chart.supportVariableSizing','save/show/write'...
    ,'chart.isComponent','save/show/write'...
    ,'chart.useTLFeature','save/show/write'...
    );
...
sf('flag'...
    ...
    ,'state.eml.isDESVariant','save/show/write'...
    ...
    ,'state.eml.fimathString','save/show/write'...
    ,'state.eml.treatAsFi','save/show/write'...
    ,'state.eml.fimathForFiConstructors','save/show/write'...
    ,'state.eml.emlDefaultFimath','save/show/write'...
    ,'state.eml.saturateOnIntegerOverflow','save/show/write'...
    ,'state.eml.constantFoldingTimeOut','save/show/write'...
    ,'state.truthTable.isTruthTable','save/show/write'...
    ,'state.truthTable.useEML','save/show/write'...
    ...
    ,'state.executionOrder','save/show/write'...
    ,'state.useDisplayTextAsClickCallback','save/show/write'...
    ,'state.loadFcn','save/show/write'...
    ,'state.clickFcn','save/show/write'...
    ,'state.deleteFcn','save/show/write'...
    ,'state.ssIdNumber','save/write'...
    ,'state.simulink.isSimulinkFcn', 'save/show/write'...
    ,'state.simulink.isComponent', 'save/show/write'...
    ,'state.simulink.blockHandle', 'write'...
    ,'state.simulink.blockName', 'save/show/write'...
    ,'state.simulink.binding', 'save/show/write'...
    );
...
sf('flag'...
    ...
    ,'junction.ssIdNumber','save/write'...
    );
...
sf('flag'...
    ...
    ,'transition.executionOrder','save/show/write'...
    ,'transition.ssIdNumber','save/write'...
    );
...
sf('flag'...
    ...
    ,'data.props.resolveToSignalObject','save/show/write'...
    ...
    ,'data.props.array.isDynamic','save/show/write'...
    ,'data.props.type.method','save/show/write'...
    ,'data.props.type.primitive','save/show/write'...
    ,'data.props.type.expression','save/show/write'...
    ,'data.props.type.busObject','save/show/write'...
    ,'data.props.type.enumType','save/show/write'...
    ,'data.props.type.isSigned','save/show/write'...
    ,'data.props.type.wordLength','save/show/write'...
    ,'data.props.type.fixpt.scalingMode','save/show/write'...
    ,'data.props.type.fixpt.fractionLength','save/show/write'...
    ,'data.props.type.fixpt.slope','save/show/write'...
    ,'data.props.type.fixpt.bias','save/show/write'...
    ,'data.props.type.fixpt.dataTypeOverride','save/show/write'...
    ,'data.props.type.fixpt.lock','save/show/write'...
    ,'data.props.type.units','save/show/write'...
    ,'data.props.complexity','save/show/write'...
    ,'data.props.frame','save/show/write'...
    ,'data.dataType','save/show/write'...
    ,'data.fixptType.bias','nosave/hide/write'...
    ,'data.fixptType.slope','nosave/hide/write'...
    ,'data.fixptType.exponent','nosave/hide/write'...
    ,'data.fixptType.baseType','nosave/hide/write'...
    ...
    ,'data.isNonTunable','save/show/write'...
    ...
    ,'data.props.updateMethod','save/show/write'...
    ,'data.ssIdNumber','save/write'...
    ,'data.simulink.blockHandle','write'...
    ,'data.isChartLocalDsm','save/show/write'...
    ,'data.subchart.isMappedToSubchart','show/write'...
    );
...
sf('flag'...
    ...
    ,'target.eml.path','save/show/write'...
    ...
    ,'target.useLocalCustomCodeSettings','save/show/write'...
...
sf('set','default'...
    ...
    ,'machine.diagSettings', [1 1 1 1 1 1] ...
    );
...
sf('set','default'...
    ...
    ,'chart.nonTerminalMaxCounts', 1000 ...
    ,'chart.plantModelingInfo.derivativesFormatString', '$N_dot' ...
    ,'chart.hdlInfo.HDLTraceability', 0 ...
    ,'chart.hdlInfo.rtwSubsystemId', 0 ...
    ,'chart.hdlInfo.emitRequirementComments', 1 ...
    ,'chart.supportVariableSizing', 1 ...
    );


sf('set', 'default', 'chart.enableZeroCrossings', 1);

% STATE FACTORY DEFAULTS

%defaultFimath = ['fimath(...' 10 ...
%    '''RoundMode'', ''floor'',...' 10 ...
...
sf('set','default'...
    ...
    ,'state.eml.fimathString',defaultFimath...
    ,'state.eml.fimathForFiConstructors',1 ...
    ,'state.eml.emlDefaultFimath',0 ... 
    ,'state.eml.saturateOnIntegerOverflow',true...
    ,'state.eml.constantFoldingTimeOut',10000 ...
    ,'state.simulink.blockHandle',-1 ...
);
...
try
    ...
    if status==1,
        ...
        error('Stateflow:UnexpectedError','failed to copy the new defaults file.');
    end
catch ME
    disp(ME.message);
    fprintf(1,'Error saving Stateflow defaults in %s.\nPrevious default file is restored',defaultsFile);
end
