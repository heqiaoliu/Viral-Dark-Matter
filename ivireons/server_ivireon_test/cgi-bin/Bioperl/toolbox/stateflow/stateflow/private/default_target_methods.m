...
%   $Revision: 1.13.4.12 $  $Date: 2008/12/29 02:22:36 $
...
output = {...
    'Generate Code Only (non-incremental)', xlatesafe('Generate'), 'sf_nonincremental_code';
    'Rebuild All (including libraries)',    'Rebuild All', 'sf_nonincremental_build';
    'Make without generating code',         xlatesafe('Make'), 'sf_make';
...
if(isempty(flags))
    ...
    flag.description = 'I/O data format: ';
    flag.values = {'Use global input/output data',...
