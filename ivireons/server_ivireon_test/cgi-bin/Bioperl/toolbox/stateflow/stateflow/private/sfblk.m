...
%	$Revision: 1.36.2.3 $ $Date: 2008/12/01 08:07:32 $

out = 0;

switch(length(varargin)),
	case 0, 
		error('Stateflow:UnexpectedError','sfblk() called with NO ARGS');
	case 1,
		method = varargin{1};
		switch (method)
			case 'xIcon',
	...
	otherwise,
		if (nargout ~= 1) error('Stateflow:UnexpectedError','bad num of output args for call to sfblk()'); end;
