...
%   $Revision: 1.3.2.4 $  $Date: 2008/12/01 08:05:55 $
%
if(nargin<2)
   silent = 0;
end
global SF_LOAD_ALL_CHARTS_CLOSED; %#ok<NUSED>
...
sfBlocks = find_system(modelH,'LookUnderMasks','all','LookUnderReadProtectedSubsystems','on','MaskType','Stateflow');
