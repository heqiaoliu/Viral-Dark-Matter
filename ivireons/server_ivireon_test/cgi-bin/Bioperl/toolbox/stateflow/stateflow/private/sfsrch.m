...
%   $Revision: 1.4.2.8 $  $Date: 2008/12/01 08:07:58 $
...
switch(Action),
    ...
    otherwise,
        ...
        % Bogus action.
        %================================================================
        error('Stateflow:UnexpectedError','Invalid action');
...
if length(ISA) ~= 1, error('Stateflow:UnexpectedError','Mixed types passed to sfsrch()'); end;
...
switch ISA,
    ...
    otherwise,error('Stateflow:UnexpectedError','Bad object type passed to sfsrch()');
end;

switch length(machine)
    case 0,error('Stateflow:UnexpectedError','why?');
    case 1,
    otherwise,
        warning('Stateflow:UnexpectedError','Ambiguous machine');
        machine = machine(1);
end
...
switch(action),
    ...
    otherwise,
        error('Stateflow:UnexpectedError','Bad action type');
end
...
switch(mouseActionType),
    ...
    otherwise,			error('Stateflow:UnexpectedError','Invalid mouse action type');
end
