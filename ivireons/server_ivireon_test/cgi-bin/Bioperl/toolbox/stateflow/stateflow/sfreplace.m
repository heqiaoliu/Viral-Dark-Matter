...
%       SFREPLACE( OBJECT_HANDLE, 'SEARCH_EXPR', 'REPLACE_STR' )  replaces all occurrences 
%           in the specified object
%       SFREPLACE( OBJECT_HANDLE, 'SEARCH_EXPR', 'REPLACE_STR', 'all' )  replaces all 
%           occurrences in the object hierarchy parented by the specified object
%       IDS = SFREPLACE( OBJECT_HANDLE, 'SEARCH_EXPR', 'REPLACE_STR' )  replaces all occurrences 
...
%           occurrences in the object hierarchy parented by the specified object and returns
%           a vector of all the ids changed
%       SFREPLACE  with no arguments opens the interactive Search & Replace tool

%	J Breslau
%   Copyright 1995-2008 The MathWorks, Inc.
%   $Revision: 1.9.2.2 $  $Date: 2008/11/13 18:41:20 $
