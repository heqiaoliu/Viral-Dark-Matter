...
%   $Revision: 1.12.6.22.6.1 $  $Date: 2010/06/28 13:27:27 $
...
fprintf(file,'	sf_debug_set_instance_data_value_ptr(%s,CHARTINSTANCE_CHARTNUMBER,CHARTINSTANCE_INSTANCENUMBER,v1,(void *)(v2),NULL);\n',gMachineInfo.machineNumberVariableName);
...
fprintf(file,'#define _SFD_SET_DATA_VALUE_PTR_VAR_DIM(v1,v2,v3)\\\n');
fprintf(file,'	sf_debug_set_instance_data_value_ptr(%s,CHARTINSTANCE_CHARTNUMBER,CHARTINSTANCE_INSTANCENUMBER,v1,(void *)(v2),(void *)(v3));\n',gMachineInfo.machineNumberVariableName);
...
fprintf(file,'#define _SFD_ARRAY_BOUNDS_CHECK(v1,v2,v3,v4,v5,v6) \\\n');
fprintf(file,'                      sf_debug_data_array_bounds_error_check(%s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'                                             (v1),(int)(v2),(int)(v3),(int)(v4),(int)(v5),(int)(v6))\n');

fprintf(file,'#define _SFD_RUNTIME_SIZE_MISMATCH_CHECK(v1,v2,v3,v4,v5) \\\n');
fprintf(file,'                      sf_debug_data_runtime_size_mismatch_error_check(%s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'                                             (v1),(v2),(unsigned int)(v3),(int)(v4),(int)(v5))\n');

fprintf(file,'#define _SFD_EML_ARRAY_BOUNDS_CHECK(v1,v2,v3,v4,v5,v6) \\\n');
...
fprintf(file,'#define _SFD_NOT_NAN_CHECK(v1,v2) \\\n');
fprintf(file,'                      sf_debug_not_nan_check(%s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'                                             (v1),(double)(v2))\n');
fprintf(file,'#define _SFD_NON_NEGATIVE_CHECK(v1,v2) \\\n');
fprintf(file,'                      sf_debug_non_negative_check(%s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'                                             (v1),(double)(v2))\n');
...
fprintf(file,'#define _SFD_ANIMATE() sf_debug_animate(%s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'CHARTINSTANCE_INSTANCENUMBER)\n');
...
fprintf(file,'#define _SFD_EML_CALL(v1,v2) eml_debug_line_call(%s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'v1,(unsigned int)%s,\\\n',gMachineInfo.eventVariableName);
fprintf(file,'v2,%s,0)\n',tString);

fprintf(file,'#define _SFD_SCRIPT_TRANSLATION(v1,v2,v3) sf_debug_set_script_translation(%s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'v1,v2,v3)\n');

fprintf(file,'#define _SFD_SCRIPT_CALL(v1,v2) eml_debug_line_call(%s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'v1,(unsigned int)%s,\\\n',gMachineInfo.eventVariableName);
fprintf(file,'v2,%s,1)\n',tString);
...
fprintf(file,'#define CV_EML_TESTOBJECTIVE(v2,v3,v4) CV_EML_EVAL(CV_EML_TESTOBJECTIVE_CHECK,(v2),(v3),((v4) != 0))\n');
fprintf(file,'#define CV_EML_IF(v2,v3,v4) CV_EML_EVAL(CV_EML_IF_CHECK,(v2),(v3),((v4) != 0))\n');
fprintf(file,'#define CV_EML_FOR(v2,v3,v4) CV_EML_EVAL(CV_EML_FOR_CHECK,(v2),(v3),(v4))\n');
fprintf(file,'#define CV_EML_WHILE(v2,v3,v4) CV_EML_EVAL(CV_EML_WHILE_CHECK,(v2),(v3),((v4) != 0))\n');
fprintf(file,'#define CV_EML_SWITCH(v2,v3,v4) CV_EML_EVAL(CV_EML_SWITCH_CHECK,(v2),(v3),(v4))\n');
fprintf(file,'#define CV_EML_COND(v2,v3,v4) CV_EML_EVAL(CV_EML_COND_CHECK,(v2),(v3),((v4) != 0))\n');
fprintf(file,'#define CV_EML_MCDC(v2,v3,v4) CV_EML_EVAL(CV_EML_MCDC_CHECK,(v2),(v3),(v4))\n');
fprintf(file,'#define CV_SCRIPT_EVAL(v1,v2,v3,v4) cv_script_eval(%s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'		  CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'		  CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'		  (v1),(v2),(v3),(int)(v4))\n');
fprintf(file,'#define CV_SCRIPT_FCN(v2,v3) CV_SCRIPT_EVAL(CV_SCRIPT_FCN_CHECK,(v2),(v3),0)\n');
fprintf(file,'#define CV_SCRIPT_TESTOBJECTIVE(v2,v3,v4) CV_SCRIPT_EVAL(CV_SCRIPT_TESTOBJECTIVE_CHECK,(v2),(v3),((v4) != 0))\n');
fprintf(file,'#define CV_SCRIPT_IF(v2,v3,v4) CV_SCRIPT_EVAL(CV_SCRIPT_IF_CHECK,(v2),(v3),((v4) != 0))\n');
fprintf(file,'#define CV_SCRIPT_FOR(v2,v3,v4) CV_SCRIPT_EVAL(CV_SCRIPT_FOR_CHECK,(v2),(v3),(v4))\n');
fprintf(file,'#define CV_SCRIPT_WHILE(v2,v3,v4) CV_SCRIPT_EVAL(CV_SCRIPT_WHILE_CHECK,(v2),(v3),((v4) != 0))\n');
fprintf(file,'#define CV_SCRIPT_SWITCH(v2,v3,v4) CV_SCRIPT_EVAL(CV_SCRIPT_SWITCH_CHECK,(v2),(v3),(v4))\n');
fprintf(file,'#define CV_SCRIPT_COND(v2,v3,v4) CV_SCRIPT_EVAL(CV_SCRIPT_COND_CHECK,(v2),(v3),((v4) != 0))\n');
fprintf(file,'#define CV_SCRIPT_MCDC(v2,v3,v4) CV_SCRIPT_EVAL(CV_SCRIPT_MCDC_CHECK,(v2),(v3),(v4))\n');
fprintf(file,'\n');
fprintf(file,'#define _SFD_CV_INIT_EML(v1,v2,v3,v4,v5,v6,v7,v8,v9) cv_eml_init_script(\\\n');
fprintf(file,'       %s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'		  CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'		  CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'		  (v1),(v2),(v3),(v4),(v5),(v6),(v7),(v8),(v9))\n');
fprintf(file,'\n');
...
fprintf(file,'\n');
fprintf(file,'#define _SFD_CV_INIT_EML_TESTOBJECTIVE(v1,v2,v3,v4,v5,v6) cv_eml_init_testobjective(\\\n');
fprintf(file,'       %s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'       CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'       CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'       (v1),(v2),(v3),(v4),(v5),(v6))\n');
...
fprintf(file,'\n');
fprintf(file,'#define _SFD_CV_INIT_SCRIPT(v1,v2,v3,v4,v5,v6,v7,v8,v9) cv_script_init_script(\\\n');
fprintf(file,'       %s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'		  CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'		  CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'		  (v1),(v2),(v3),(v4),(v5),(v6),(v7),(v8),(v9))\n');
fprintf(file,'\n');
fprintf(file,'#define _SFD_CV_INIT_SCRIPT_FCN(v1,v2,v3,v4,v5,v6) cv_script_init_fcn(\\\n');
fprintf(file,'       %s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'		  CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'		  CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'		  (v1),(v2),(v3),(v4),(v5),(v6))\n');
fprintf(file,'\n');
fprintf(file,'#define _SFD_CV_INIT_SCRIPT_TESTOBJECTIVE(v1,v2,v3,v4,v5,v6) cv_script_init_testobjective(\\\n');
fprintf(file,'       %s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'		  CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'		  CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'		  (v1),(v2),(v3),(v4),(v5),(v6))\n');
fprintf(file,'\n');
fprintf(file,'#define _SFD_CV_INIT_SCRIPT_IF(v1,v2,v3,v4,v5,v6) cv_script_init_if(\\\n');
fprintf(file,'       %s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'		  CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'		  CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'		  (v1),(v2),(v3),(v4),(v5),(v6))\n');
fprintf(file,'\n');
fprintf(file,'#define _SFD_CV_INIT_SCRIPT_FOR(v1,v2,v3,v4,v5) cv_script_init_for(\\\n');
fprintf(file,'       %s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'		  CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'		  CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'		  (v1),(v2),(v3),(v4),(v5))\n');
fprintf(file,'\n');
fprintf(file,'#define _SFD_CV_INIT_SCRIPT_WHILE(v1,v2,v3,v4,v5) cv_script_init_while(\\\n');
fprintf(file,'       %s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'		  CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'		  CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'		  (v1),(v2),(v3),(v4),(v5))\n');
fprintf(file,'\n');
fprintf(file,'#define _SFD_CV_INIT_SCRIPT_MCDC(v1,v2,v3,v4,v5,v6,v7,v8,v9,v10) cv_script_init_mcdc(\\\n');
fprintf(file,'       %s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'		  CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'		  CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'		  (v1),(v2),(v3),(v4),(v5),(v6),(v7),(v8),(v9),(v10))\n');
fprintf(file,'\n');
fprintf(file,'#define _SFD_CV_INIT_SCRIPT_SWITCH(v1,v2,v3,v4,v5,v6,v7,v8) cv_script_init_switch(\\\n');
fprintf(file,'       %s,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'		  CHARTINSTANCE_CHARTNUMBER,\\\n');
fprintf(file,'		  CHARTINSTANCE_INSTANCENUMBER,\\\n');
fprintf(file,'		  (v1),(v2),(v3),(v4),(v5),(v6),(v7),(v8))\n');
fprintf(file,'\n');
fprintf(file,'\n');
fprintf(file,'#define _SFD_SET_DATA_PROPS(dataNumber,dataScope,isInputData,isOutputData,dataName)\\\n');
fprintf(file,' sf_debug_set_chart_data_props(%s,CHARTINSTANCE_CHARTNUMBER,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'	(dataNumber),(dataScope),(isInputData),(isOutputData),(dataName))\n');
fprintf(file,'#define _SFD_SET_DATA_COMPILED_PROPS(dataNumber,dataType,numDims,dimArray,isFixedPoint,isSigned,wordLength,bias,slope,exponent,complexity,mexFcn)\\\n');
fprintf(file,' sf_debug_set_chart_data_compiled_props(%s,CHARTINSTANCE_CHARTNUMBER,CHARTINSTANCE_INSTANCENUMBER,\\\n',gMachineInfo.machineNumberVariableName);
fprintf(file,'	(dataNumber),(dataType),(numDims),(dimArray),(isFixedPoint),(isSigned),(wordLength),(bias),(slope),(exponent),(complexity),(mexFcn))\n');
