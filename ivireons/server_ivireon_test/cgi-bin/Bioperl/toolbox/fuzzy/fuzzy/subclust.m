...
%
%   SUBCLUST finds the optimal data point to define a cluster
...
%
%   [C,S] = SUBCLUST(X,RADII,XBOUNDS,OPTIONS) returns the cluster centers in the matrix C;
...
%   $Revision: 1.19.2.3 $  $Date: 2006/11/17 13:27:57 $
