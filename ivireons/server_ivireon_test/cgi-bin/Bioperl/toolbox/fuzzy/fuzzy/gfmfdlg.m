...
%   $Revision: 1.13.2.7 $  $Date: 2007/08/20 16:32:54 $
...
if strcmp(action,'#init'),
    ...
    %   Restrictions: 'sigmf', 'smf', and 'zmf' MF types are not supported
    %   since they are either open-left or open-right.
...
elseif strcmp(action,'#okay'),
    ...
    inmfType=strtrim(mfTypeList(mfTypeVal,:)); 
