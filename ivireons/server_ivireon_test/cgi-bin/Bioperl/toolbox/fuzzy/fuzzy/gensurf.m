function [xOut,yOut,zOut]=gensurf(fis,inputs,output,grids,refInput,numofpoints)
...
%
%   gensurf(fis,inputs,output,grids,refinput,numofpoints) further specifies
%   number of sample points on which to evaluate the membership functions
%   over the input or output range. If this argument is not used, the
%   default value is 101 points. 
%
...
%   $Revision: 1.18.2.1 $  $Date: 2008/06/13 15:21:02 $
