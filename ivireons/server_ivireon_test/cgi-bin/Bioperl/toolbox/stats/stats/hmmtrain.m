...
%   $Revision: 1.1.8.1 $  $Date: 2010/03/16 00:14:41 $
            ...
            switch(k)
                case 1  % symbols
                    ...
                    if ~iscell(seqs) || ischar(seqs{1})
                        ...
                        if any(seqs(:)==0)
                            error('stats:hmmtrain:MissingSymbol',...
                                  'At least one entry in SEQ does not appear in SYMBOLS.');
                        end
