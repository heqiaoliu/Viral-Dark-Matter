...
%   $Revision: 1.1.8.2 $  $Date: 2010/04/24 18:31:36 $
...
hStepwise = uimenu(F, 'Label','&Stepwise','Tag','stepwiseMenuStepwise','Position',6);
...
uimenu(helpMenu, 'Label','&Stepwise Help', 'Position', 1, ...
