...
% MATLAB(R) is an ideal tool for running simulations that incorporate random
% inputs or noise.  The Statistics Toolbox(TM) provides functions to create
...
%   $Revision: 1.1.8.1 $  $Date: 2010/03/16 00:30:54 $
