...
% This demo uses some features available in the Statistics Toolbox(TM)
% to analyze time series data.

%   Copyright 2005-2008 The MathWorks, Inc.
%   $Revision: 1.1.8.1 $  $Date: 2010/03/16 00:31:45 $
...
%% Summary
% This demo provides an illustration of how to use the MATLAB(R) timeseries
