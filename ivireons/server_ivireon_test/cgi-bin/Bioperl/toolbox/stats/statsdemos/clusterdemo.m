...
%
% This demo illustrates how to perform cluster analysis using the Statistics Toolbox(TM).

%   Copyright 2002-2007 The MathWorks, Inc.
%   $Revision: 1.1.8.1 $  $Date: 2010/03/16 00:30:52 $
...
%%
% Some of the functions used in the example call MATLAB(R) built-in random
