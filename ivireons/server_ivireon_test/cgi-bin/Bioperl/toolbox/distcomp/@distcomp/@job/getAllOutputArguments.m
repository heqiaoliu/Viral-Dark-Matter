...
%    arrays containing the output arguments from that task. If a task has less
%    than N output arguments, the excess arrays in the row for that task are
%    empty. The order of the rows in data will be the same as the order of the
%    tasks contained in the job.
%    
...
%  $Revision $    $Date: 2008/02/02 12:59:52 $
