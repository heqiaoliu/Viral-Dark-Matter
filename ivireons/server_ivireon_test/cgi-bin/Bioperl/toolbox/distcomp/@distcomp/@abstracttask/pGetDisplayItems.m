...
; %#ok Undocumented
% gets the common display structure for third party Tasks

% Copyright 2006-2007 The MathWorks, Inc.

% $Revision: 1.1.6.4 $  $Date: 2008/02/02 12:59:39 $
...
% get running duration from Java using static shared method
...
%stores the Error Structure in err
...
% specific properties
% no specific properties for third party tasks
...
% string - 46 because we want the total line to wrap at 75 char limit.
% We have 26 char for properties 3 char for ' : ' for a total of 26+3+46
% characters per error message line.
