...
try
    ...
    ex = MException('distcompexamples:SGE:FailedToRetrieveRemoteParameters', ...
...
if ~isBeingMirrored && ~isJobFinished
    ...
    try
        ...
        warning('distcompexamples:SGE:FailedToResumeMirrorForJob', ...
...
elseif isJobFinished
    ...
    try
        ...
        warning('distcompexamples:SGE:FailedToDoFinalMirrorForJob', ...
