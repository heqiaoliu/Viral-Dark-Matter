function runprop = lsfNonSharedParallelDecodeFcn( runprop )
%LSFNONSHAREDPARALLELDECODEFCN Prepares a worker to run a MATLAB task.
% This function is referenced by lsfNonSharedParallelSubmitFcn.
