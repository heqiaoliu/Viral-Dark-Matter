function parallelSubmitFcn(scheduler, job, props, clusterHost)
...
% command:
%     set(sched, 'ParallelSubmitFcn', {@parallelSubmitFcn, clusterHost});
%
...
% Create a script to submit a SGE job - this will be created in the job directory
...
if cmdFailed
    error('distcompexamples:SGE:FailedToSubmitJob', ...
        'Failed to submit job to SGE using command:\n\t%s.\nReason: %s', ...
        commandToRun, cmdOut);
end
