function runprop = lsfNonSharedSimpleDecodeFcn( runprop )
%LSFNONSHAREDSIMPLEDECODEFCN Prepares a worker to run a MATLAB task.
% This function is referenced by lsfNonSharedSimpleSubmitFcn.
