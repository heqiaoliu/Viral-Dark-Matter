function runprop = sgeNonSharedParallelDecodeFcn( runprop )
%SGENONSHAREDPARALLELDECODEFCN Prepares a worker to run a MATLAB task.
% This function is referenced by sgeNonSharedParallelSubmitFcn.
