function [A, rCond] = scalaLUsolve(A, B)
% SCALALUSOLVE  SCALAPACK LU solver

%   Copyright 2006-2010 The MathWorks, Inc.
%   $Revision: 1.1.6.9 $  $Date: 2010/03/22 03:42:53 $
...
numOfCol = gop(@max, size(getLocalPart(A), 2));
...
[localA, rCond] = scalaLUsolvemex(localA, descA, localB, descB,...
                         lbgrid(1), lbgrid(2), distA.Orientation, ... 
                         numOfCol, isrealA, isrealB);
...
if use1DForResult
    if ~distributedB
        warning('distcomp:codistributed:scalaLUsolve:changeOutputCodistr', ...
