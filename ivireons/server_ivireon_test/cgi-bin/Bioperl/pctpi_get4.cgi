...
system "./run_MCP_and_Tail_nets.sh " . $mcrpath . " data descriptions ";
system "perl /Applications/MAMP/cgi-bin/Bioperl/ANNs/StructuralANNs/predict_structural.pl " . $fastapath . " " . $mcrpath;


print "<br><br>perl put_struct_ANNs_into_CSV_and_make_pos-neg_CSVs.pl ANN_prediction_averages_and_sds.csv descriptions " . $dir_path_string . "/DATA_ann.out";
system "perl put_struct_ANNs_into_CSV_and_make_pos-neg_CSVs.pl ANN_prediction_averages_and_sds.csv descriptions " . $dir_path_string . "/DATA_ann.out";
system "cp All_hits_for_ANNs.csv $dir_path_string";
system "cp positive_hits_for_Structural_OnetoOne_ANN.csv $dir_path_string";

system "cp negative_hits_for_Structural_OnetoOne_ANN.csv $dir_path_string";
