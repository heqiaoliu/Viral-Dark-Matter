...
$fasta_data = $fastafilename . "_data";
$fasta_descriptions = $fastafilename . "_descriptions";
open (OUTFILE, ">" . $fasta_data);
open (DESCRIBE, ">" . $fasta_descriptions);
...
#######################################################################
system $matlabpath . " -r 'clc; clear all; testnets($fasta_data, $fasta_descriptions)'";
...
#system "rm $fasta_data";
#system "rm $fasta_descriptions";
