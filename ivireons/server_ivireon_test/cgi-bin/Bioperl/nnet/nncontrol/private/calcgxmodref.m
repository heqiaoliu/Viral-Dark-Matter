function [gX,normgX] = calcgxmodref(net,X,PD,BZ,IWZ,LWZ,N,Ac,Y,T,perf,Q,TS);
...
% $Revision: 1.4.2.3 $ $Date: 2010/03/22 03:58:35 $

%mth 7/29/05  dPerformFcn = feval(net.performFcn,'deriv');
gE = cell(net.numLayers,TS);  %mth 7/29/05
gE(net.outputConnect,:) = feval(net.performFcn,'dperf_de',net,T,Y,{1},perf,net.performParam);  %mth 7/29/05
