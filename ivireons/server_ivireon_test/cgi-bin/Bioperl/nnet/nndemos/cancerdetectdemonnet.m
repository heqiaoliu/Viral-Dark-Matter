...
%   $Revision: 1.1.8.9 $  $Date: 2010/03/22 03:58:46 $
...
% results after training the network vary slightly everytime the demo is
% run. To avoid this randomness, the random seed is set to reproduce the
% same results everytime. However this is not neccessary for your own
% applications.
...
out = round(net(testInputs));           % Get response of trained network
