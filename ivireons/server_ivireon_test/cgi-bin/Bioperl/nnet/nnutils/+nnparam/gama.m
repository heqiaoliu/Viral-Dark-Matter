%Gamma (gama) function parameter
%
%  <a href="matlab:doc nnparam.gama">gama</a> is a <a href="matlab:doc nntrain">training function</a> parameter.
%  It must be a positive scalar.
%
%  <a href="matlab:doc nnparam.gama">gama</a> defines is a value used to avoid small reductions in
%  performance for a step by the line search algorithms used for training.
%
