%Delta (delta) function parameter
%
%  <a href="matlab:doc nnparam.delta">delta</a> is a <a href="matlab:doc nntrain">training function</a> parameter.
%  It must be a positive scalar.
%
%  <a href="matlab:doc nnparam.delta">delta</a> defines the initial step size for line search algorithms
%  used for training.
%
