function out1 = negdist(varargin)
...
%
%  <a href="matlab:doc negdist">negdist</a>('size',S,R,FP) takes the layer dimension S, input dimension R,
%  and function parameters, and returns the weight size [SxR].
%
%  <a href="matlab:doc negdist">negdist</a>('dp',W,P,Z,FP) returns the derivative of Z with respect to P.
%  <a href="matlab:doc negdist">negdist</a>('size',S,R,FP) returns the derivative of Z with respect to W.
%
...
function name = function_name, name = 'Negative Distance'; end
