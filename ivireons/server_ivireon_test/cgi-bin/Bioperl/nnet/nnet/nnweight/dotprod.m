function out1 = dotprod(varargin)
...
%  an input P.
%
%  <a href="matlab:doc dotprod">dotprod</a>('size',S,R) returns the size of a weight matrix required by
%  this function to weight an input vector with R elements for a layer
%  with R neurons.
%
%	 <a href="matlab:doc dotprod">dotprod</a>('dp',W,P,Z,FP) returns the derivative of Z with respect to P.
%	 <a href="matlab:doc dotprod">dotprod</a>('dw',W,P,Z,FP) returns the derivative of Z with respect to W.
%
...
function name = function_name, name = 'Dot Product'; end
