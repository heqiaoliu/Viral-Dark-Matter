...
% $Revision: 1.1.6.15.2.1 $ $Date: 2010/07/14 23:40:24 $
...
function info = get_info()
  info = nnfcnTraining(mfilename,'Conjugate Gradient Backpropagation with Fletcher-Reeves Restarts',7.0,true,true,...
    [ ...
