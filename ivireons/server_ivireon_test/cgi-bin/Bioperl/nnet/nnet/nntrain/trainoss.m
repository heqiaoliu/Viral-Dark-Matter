...
% $Revision: 1.1.6.13.2.1 $ $Date: 2010/07/14 23:40:31 $
...
function info = get_info()
  info = nnfcnTraining(mfilename,'One Step Secant',7.0,true,true,...
    [ ...
...
function [net,tr] = train_network(net,tr,data,fcns,param)
  ...
  startTime = clock;
  original_net = net;
  [perf,vperf,tperf,gX] = nntraining.perfs_grad(net,data,fcns);
  gX = -gX;
