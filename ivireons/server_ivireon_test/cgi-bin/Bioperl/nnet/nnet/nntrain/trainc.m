...
% $Revision: 1.1.6.11.2.1 $  $Date: 2010/07/14 23:40:22 $
...
function info = get_info
  info = nnfcnTraining(mfilename,'Cyclical Weight/Bias Rule',7.0,true,true,...
    [ ...
...
function [net,tr] = train_network(net,tr,data,fcns,param)
  ...
  for epoch=0:param.epochs
    ...
    for qq=1:trainQ
      ...
      [dperf,divData,gB,gIW,gLW,gA] = nntraining.perf_sig_grad(net,divData,needGradient,fcns);
