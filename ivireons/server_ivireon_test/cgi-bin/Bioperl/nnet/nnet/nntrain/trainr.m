...
% $Revision: 1.1.6.11.2.1 $  $Date: 2010/07/14 23:40:32 $
...
function info = get_info
  info = nnfcnTraining(mfilename,'Random Weight/Bias Rule',7.0,true,true,...
    [ ...
...
function [net,tr] = train_network(net,tr,data,fcns,param)
  ...
  if isempty(net.performFcn)
    warning('nnet:trainr:Performance',nnwarn_empty_performfcn_corrected);
    net.performFcn = 'mse';
  end
  % TODO - enforce sample data division mode
          ...
          for j=find(net.inputConnect(i,:))
            ...
            if learnFcn.exist
              ...
              [dw,IWLS{i,j}] = learnFcn.apply(net.IW{i,j}, ...
                ...
                divData.Tl{i,ts},divData.El{i,ts},gIW{i,j,ts},...
          ...
          for j=find(net.layerConnect(i,:))
            ...
            if learnFcn.exist
              ...
              [dw,LWLS{i,j}] = learnFcn.apply(net.LW{i,j}, ...
                ...
                divData.Tl{i,ts},divData.El{i,ts},gLW{i,j,ts},...
          ...
          if net.biasConnect(i)
            ...
            if learnFcn.exist
             [db,BLS{i}] = learnFcn.apply(net.b{i}, ...
                ...
                divData.Tl{i,ts},divData.El{i,ts},gB{i,ts},...
