...
%
% <a href="matlab:doc tribas">tribas</a>('da_dn',N,A) returns the derivative of layer outputs A with
...
function name = function_name, name = 'Triangular Basis'; end
function range = output_range, range = [0 1]; end
function range = active_input_range, range = [-1 1]; end
function flag = is_continuous, flag = true; end
function flag = is_smooth, flag = false; end
function flag = is_monotonic, flag = false; end
function flag = is_scalar, flag = true; end
function flag = is_basis, flag = true; end
...
function da_dn = da_dn(n,a,parameters)
  da_dn = ((n >= -1) & (n <= 1)) .* sign(-n);
end
