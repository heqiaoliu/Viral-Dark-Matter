...
% $Revision: 1.1.6.8.2.1 $  $Date: 2010/07/14 23:40:41 $
...
function name = function_name, name = 'Sigmoid Positive'; end
function range = output_range, range = [0 1]; end
function range = active_input_range, range = [-4 4]; end
