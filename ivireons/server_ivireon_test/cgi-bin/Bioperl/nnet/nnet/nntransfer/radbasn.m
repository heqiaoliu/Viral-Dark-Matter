function out1 = radbasn(varargin)
...
%
% <a href="matlab:doc radbasn">radbasn</a>('da_dn',N,A) returns the derivative of layer outputs A with
...
% $Revision: 1.1.8.2.2.1 $  $Date: 2010/07/14 23:40:46 $
...
function name = function_name, name = 'Radial Basis Competitive'; end
