...
================================
-mcpt 
-run_mcpt.sh (shell script run to temporarily set environment variables and execute the 
              application)
   -to run the shell script, type
   
       ./run_mcpt.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/R2010a/v715, run the shell script as:
       ...
       ./run_mcpt.sh /mathworks/home/application/R2010a/v715
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_mcpt.sh /mathworks/devel/application/matlab
-MCRInstaller.bin
...
A. On the target machine, add the MCR directory to the environment variable LD_LIBRARY_PATH.
        ...
        NOTE: When deploying standalone applications, it is possible 
              to run the shell script file run_mcpt.sh 
