...
<FORM action="/cgi-bin/Bioperl/pctpi_get3.cgi" method="GET">
...
Replace the "htdocs" and "cgi-bin" directories with those found in the iVIREON packet (drag those folders from the packet to the MAMP folder, and click "Replace".<br><br>
...
The iVIREON software needs to use the fasta file and Matlab program on your machine.<br>
