...
<link rel="stylesheet" href="<?php echo $tmpTools->templateurl(); ?>/styles/header/blue/style.css" type="text/css" />
<link rel="stylesheet" href="<?php echo $tmpTools->templateurl(); ?>/styles/background/lighter/style.css" type="text/css" />
<link rel="stylesheet" href="<?php echo $tmpTools->templateurl(); ?>/styles/elements/blue/style.css" type="text/css" />
